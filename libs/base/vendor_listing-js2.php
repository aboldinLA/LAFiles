     ...
     ************************************************************************/
     function search_list($find, $xlist="", $filter="") {
        ...
        if($count = count($children)) {
            if($filter != "") {
            ?>
            <table cellspacing='2' cellpadding='0' align='center' width='700'>
            <?
            ...
            ?>
            <table cellspacing='2' cellpadding='0' width='700'><tr><td><table cellspacing='2' cellpadding='0'>
            <?
                $i = $c = 0;
                $ot = (int) $count/3;
                foreach($children as $idx => $obj) {
                    ...
                    </tr></table><p>&nbsp;</p><table cellspacing='2' cellpadding='0'>
                    <?
                }
            ?>
            </table></td></tr></table>
