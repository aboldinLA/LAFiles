...
function validateForm() {
    var x = document.forms["refine2"]["searchby"].value;
    if (x == null || x == "") {
        alert("Area Code must be Chosen");
        return false;
    }
}
</script>
...
<div style="position:absolute; left:545px; top:258px; z-index:20000; padding:0px; width:200px; font-size:14px; color:#000">
		...
		<?php if($_GET["searchby"] == "ac"){
               $areacodes = $_GET['areacodes'];
                ...
                <input onFocus="this.form.searchby[2].checked = true;" size="6" type="text" name="areacodes" value="<?php echo $areacodes;  ?>" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; border:1px solid; border-color:#000; box-shadow: 5px 5px 5px #888888" />
 </div> 
...
<? if($searchby == 'ac' || $searchby == '') { ?>
    document.refine2.areacodes.focus();
<? } ?>
</script>
