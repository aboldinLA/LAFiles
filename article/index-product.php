...
if ($firefox) {?>            
            <li> 
            <a href="#view3">Product Category Search</a>
            </li>
<? } else { ?>
            <li> 
            <a href="#view3"><button style="font-family:Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:12px; background: #F0F0F0 url(tabbg.gif) 0 0 repeat-x; height:25px; width:150px; margin-bottom:-20px" onclick="myFunction()">Product Category Search</button></a>
            </li>
<? } ?>            
...
//Firefox
if ($firefox) {?>                      
            <li><a href="#view4">Wholesale Plants & Supply</a></li>
<? } else { ?>
...
if ($firefox) {?>
<a href="https://landscapearchitect.com/products/product-comments.php" target="_blank"><br>
<div align="center" style="position:absolute; left:565px; top:180px; z-index:50000; font-size:14px; width:200px; color:#2781E1">
Let us know what you think<br>
of our new product search</a>
</div>
<? } else { ?>
