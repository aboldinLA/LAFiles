		...
		<tr> 
            <td colspan="2" valign='top' style="font-family:Arial, Helvetica, sans-serif; font-size:16px">
            	...
            	<input type="hidden" name="action" value="true" />
					...
					<center><h4 style="position: relative; left: 100px; top: -20px">Click on the <img src="https://landscapearchitect.com/imgz/vendor/pencil.gif"> under a specific Graphic to edit that individual Product Profile.&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<br><br>
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;*** Requires that you re-enter your Password - <br><br>You will need to navigate back to this page once to add products.<br>You will see that a blank image has been added.<br>Edit that image and add any more that you wish.</h4></center>
