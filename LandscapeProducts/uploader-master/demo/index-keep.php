...
<html lang="en">
  ...
  <body>
									...
									<?
                                        ...
                                        $sql = "UPDATE vendor_product SET marked_for_deletion = 'no' WHERE id = '" . $proNum3 . "';
                                ";
                                        if(mysqli_query($link, $sql)){
                                            echo "<br><center><h3>Product is marked for keep</h3><br></center>";
                                        } else{
...
// Email Notification Start
    ...
    $subject = 'Product marked as Keep';
    $message = 'Vendor Web ID: ' . $venNum3 . ' has marked keep for product: ' . $prodNum3 . ' ';
