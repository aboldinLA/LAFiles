...
<div style="position: absolute; left: 600px; top: 325px; z-index:10000">
...
<span style="font-size:12px">Begin New Search</span>
                ...
                if($this->errors()) { ?>
                    ...
                    switch($vars['searchType']) {
                        ...
                        case 'advanced':
                            echo "<div style='position:relative; left:0px; z-index:5000'><font size='2'><strong><a href='https://landscapearchitect.com/research/index.php'><br></a></strong></font><div style='position:relative; left:0px; top:-50px'>";					
                            break;
                    }
                    print("</form>");
    ...
    function action($action = 'default', $vars = NULL) {
        ...
        switch($action) {
            ...
            case 'find':
                ...
                $this->top('Editorial &amp; Article Search');
                ?>
                <div id='pageBody' style="position:relative; left:0px; top:-75px; width:763px">
                <h1 id='pageTitle'>Editorial &amp; Article Search Results</h1><br>
                
<div style="position: absolute; left: 600px; top: 119px; z-index:10000">
<a href='https://landscapearchitect.com/research/index.php' onmouseover='' style='cursor: pointer;'><div class="tb2" style="width:120px; z-index:2000; padding-left:5px; box-shadow: 5px 5px 5px #888888">
<span style="font-size:12px">Begin New Search</span>
</div></a>
</div>                
            ...
            default:
                ...
                $this->top('Editorial &amp; Article Search');
                ?>
                <div style="position:relative; left:-320px; top:-275px">
					...
					<div style="position:absolute; left:323px; top:595px; padding:0px; width:750px; height:2px; background-color:#605b51;"> </div>
					<!-- Horizontal Bar End -->                    
