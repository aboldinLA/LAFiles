     ...
     class lead_generator {
        ...
        function approvalPage($hash) {
            ...
            <div id="content">
                ...
                <p>
                Please review the content of this lead generator below, then read the agreement and sign the form to approve.  If you have any questions or modifications that need to be made, contact your editor in order to make the appropriate changes.
                </p>
                </div>
                <?php $this->listErrors(); ?>
        ...
        function approvalForm($hash) {
            ...
            <form method="POST" action="<?= $this->appUrl(); ?>/saveApproval">
                ...
                <table cellpadding="5" cellspacing="0" border="0">
                    <tr>
                        <td><strong>If you do NOT approve this lead generator and would like to make any changes to it, click here to email the editorial department.  Include the name of your company and any changes you want to be made. An editor will make those changes and then send you a new approval request.
<a href="mailto:editorial@landscapeonline.com?subject=Request Changes">send us a message</a></strong></td> 
                    </tr>
                </table>
                <br />
           <?php
            ...
            ?>
                ...
                <div>
                    <table width="100%" border="0" cellpadding="5" cellspacing="5">
                        <tr>
                            <td width="50%">
                    <p> This lead generator will be a <strong><?= $this->size(); ?></strong>, and will appear in <strong><?= strtoupper(implode(',',$this->magazines())); ?></strong>.
                    </p>
                    <p>
                        This lead generator will use the following information about your company:
                    </p>
                    <div class="indent">
                        ...
                        Phone: <strong><?= $this->current->phoneNumber(); ?></strong>
                            ...
                            <td valign="top">
                                <div id="promo">
                                    ...
                                    <strong>
                                       Interested in increasing your exposure in the guides, or getting an second listing in another category?  <br /> <br /> <a href="mailto:editorial@landscapeonline.com?subject=LG Upgrade for <?= $this->current->companyName(); ?>&body=Please contact me about upgrading my lead generator!">Have one of our sales team contact you today!</a>
                                    </strong>
                                </div>
                            </td>
                    </table>
...
EOHTML3;
    ...
    You have been designated as the person responsible for approving the content of {$companyName}'s lead generators.  If you are not the proper recipient for this material, please notify us <strong>immediately</strong> so that we may contact the appropriate person.
            ...
            <p>
            A proof of your lead generator has been created, and is pending your approval.  To review and approve the content, please visit the following link. (NOTE: If the link does not appear clickable, please copy and paste the address into your browser.)
            </p>
...
A proof of the material that was submitted for your lead generator has been created, and is pending your approval.  To review and approve the content, please visit the following link. (NOTEs: If the link does not appear clickable, please copy and paste the address into your browser window.)
