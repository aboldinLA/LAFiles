...
<html lang="en">
  ...
  <body>
    ...
    <main role="main" class="container">
     ...
     <h3>Add a Product for this Vendor</h3>
    ...
    <?
										...
										// start for the banner add counting and getting from table
											...
											$sql = "SELECT * FROM new_vendor WHERE id='" . $vendNum2 . "'";
											$result = $conn->query($sql);									
									
										// banner rotating section
											while($row = mysqli_fetch_array($result)) {  
                                                
                                                echo '<img width="20%" src="https://landscapearchitect.com/products/images/' . $row['logo'] . '">';
...
<script>
    ...
    <script src="demo-config2-add.js"></script>
