...
<html lang="en">
  ...
  <body>
   ...
   <h3>Edit the CAD SKP File for this product</h3>
    ...
    ?>
      ...
      <p class="lead mb-4">
       Edit CAD SKP for this Product.<br>
       To change this image, drag your new image to the window below and click on the Submit Button.<br>
        (Due to the file size this may take a few minutes. Please wait for the Upload Complete prompt)
      </p>
...
<script>
    ...
    <script src="demo-config7.js"></script>
