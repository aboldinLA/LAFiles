...
<!-- Old Code Start -->
	...
	<? include $include_path . "/base/research_search_application2-js2.php" ?>
...
<? } else { ?>
	...
	<?
	include $include_path . "/base/research_search_application2-js3-new.php";
	?>                
                
                
<div class="tb2" style="position:absolute; left:0px; top:-40px; width:750px; z-index:2000; box-shadow: 5px 5px 5px #888888">
<span style="font-size:16px">Editorial &amp; Article Searches&nbsp;&nbsp;</span>
</div><br />
