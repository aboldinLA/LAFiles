...
// Write to vendor_product Start
		...
		$sql = "UPDATE vendor_product SET cadd='" . $pString2 . "' WHERE id='" . $prodNum3 . "'";
...
// Email Notification Start
    ...
    $subject = 'Details Uploaded - CAD DWG ' . $venNum3 . '';
    $message = 'Vendor Web ID: ' . $venNum3 . ' has uploaded a CAD DWG for product: ' . $prodNum3 . ' ';
