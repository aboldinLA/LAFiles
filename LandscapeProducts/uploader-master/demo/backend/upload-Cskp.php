...
// Write to vendor_product Start
		...
		$sql = "UPDATE vendor_product SET skup='" . $pString2 . "' WHERE id='" . $prodNum3 . "'";
...
// Email Notification Start
    ...
    $subject = 'Details Uploaded - CAD SKP ' . $venNum3 . '';
    $message = 'Vendor Web ID: ' . $venNum3 . ' has uploaded a CAD SKP for product: ' . $prodNum3 . ' ';

    mail($email, $subject, $message);


    $email='jvictor@landscapeonline.com';
    $subject = 'Details Uploaded - CAD SKP';
    $message = 'Vendor Web ID: ' . $venNum3 . ' has uploaded a CAD SKP for product: ' . $prodNum3 . ' ';
