...
<strong>Search By FASLA:</strong><br />
	...
	&nbsp;&nbsp;&nbsp;<strong>Find:</strong> 
    <input type='text' id="searchFor" name='searchFor' size='70' value='"FASLA' style="height:20px; font-family:Arial, Helvetica, sans-serif; font-size:12px; font-weight:bold; color:#000; background-color:#CCC; padding-left:10px; box-shadow: 5px 5px 5px #888888" onkeydown="return ValidateInput(this);" />
