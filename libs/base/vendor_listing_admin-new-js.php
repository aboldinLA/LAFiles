    ...
    */
    ...
    function editNavigation() {
        ...
        <div class='formInfo' style="width:750px">
            ...
            <h2 style="; font-family:Arial, Helvetica, sans-serif; color:#F00"><center>Thousands of Product Searches Every Week!</center></h2><br />
...
<!-- Category Section -->        
<div class="tb4" style="width:750px; box-shadow: 5px 5px 5px #888888">
  &nbsp;&nbsp;Company Search Categories [ <a href='<?= $_SERVER['PHP_SELF'] ?>?action=categories&id=<?= $this->id ?>'><span style="font-size: 18px; font-weight: bold">Edit The Search Categories For Your Company</span></a> ]&nbsp;&nbsp;
</div><br /><br />
