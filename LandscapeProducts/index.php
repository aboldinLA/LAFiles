									...
									<? 
                                        ...
                                        if ($ad == 28) {
                                           echo '<title>Business Services | Landscape Architect</title>';
                                            echo '<h1 style="font-size: 24px; font-weight: bold">Business Services</h1>';
                                        } elseif ($ad == 30) {
                                            echo '<title>Landscape Erosion Control Products | Landscape Architect</title>';
                                            echo '<h1 style="font-size: 24px; font-weight: bold">Landscape Erosion Control Products</h1>';                                            
                                        }elseif ($ad == 1300) {
                                            echo '<title>Commercial / Wholesale Fencing | Landscape Architect</title>';
                                            echo '<h1 style="font-size: 24px; font-weight: bold">Commercial / Wholesale Fencing</h1>';
                                        } elseif ($ad == 1139) {
                                            echo '<title>Landscape Erosion Control Products | Landscape Architect</title>';
                                            echo '<h1 style="font-size: 24px; font-weight: bold">Landscape Erosion Control Products</h1>';    
                                        } elseif ($ad == '32') {
                                            echo '<title>Commercial Exterior Lighting / Electrical | Landscape Architect</title>';
                                            echo '<h1 style="font-size: 24px; font-weight: bold">Commercial Exterior Lighting / Electrical</h1>';
                                        } elseif ($ad == '1214') {
                                            echo '<title>Outdoor Living / Residential Landscape | Landscape Architect</title>';
                                            echo '<h1 style="font-size: 24px; font-weight: bold">Outdoor Living / Residential Landscape</h1>';
                                        } elseif ($ad == '33') {
                                            echo '<title>Parks / Playground Products | Landscape Architect</title>';
                                            echo '<h1 style="font-size: 24px; font-weight: bold">Parks / Playground Products</h1>';
                                        } elseif ($ad == '38') {
                                            echo '<title>Commercial Pavers, Masonry, Blocks, Rocks | Landscape Architect</title>';
                                            echo '<h1 style="font-size: 24px; font-weight: bold">Commercial Pavers, Masonry, Blocks, Rocks</h1>';
                                        } elseif ($ad == '1212') {
                                            echo '<title>Wildlife / Commercial Landscape Pest Control | Landscape Architect</title>';
                                            echo '<h1 style="font-size: 24px; font-weight: bold">Wildlife / Commercial Landscape Pest Control</h1>';
                                        } elseif ($ad == '1002') {
                                            echo '<title>Wholesale Plant Accessories & Soil Amendments | Landscape Architect</title>';
                                            echo '<h1 style="font-size: 24px; font-weight: bold">Wholesale Plant Accessories & Soil Amendments</h1>';
                                        } elseif ($ad == '1394') {
                                            echo '<title>Pool and Spa | Landscape Architect</title>';
                                            echo '<h1 style="font-size: 24px; font-weight: bold">Pool and Spa</h1>';
                                        } elseif ($ad == '29') {
                                            echo '<title>Commercial Site Amenities | Landscape Architect</title>';
                                            echo '<h1 style="font-size: 24px; font-weight: bold">Commercial Site Amenities</h1>';
                                        } elseif ($ad == '1215') {
                                            echo '<title>Site Furnishings / Receptacles | Landscape Architect</title>';
                                            echo '<h1 style="font-size: 24px; font-weight: bold">Site Furnishings / Receptacles</h1>';
                                        } elseif ($ad == '1301') {
                                            echo '<title>Landscape Art, Sculpture, Metal / Stone Garden Ornaments | Landscape Architect</title>';
                                            echo '<h1 style="font-size: 24px; font-weight: bold">Landscape Art, Sculpture, Metal / Stone Garden Ornaments</h1>';
                                        } elseif ($ad == '41') {
                                            echo '<title>Water Features, Fountains, Ponds / Equipment | Landscape Architect</title>';
                                            echo '<h1 style="font-size: 24px; font-weight: bold">Water Features, Fountains, Ponds / Equipment</h1>';
                                        } elseif ($ad == '1213') {
                                            echo '<title>Landscape Irrigation & Water Management | Landscape Architect</title>';
                                            echo '<h1 style="font-size: 24px; font-weight: bold">Landscape Irrigation & Water Management</h1>';
                                        }
