...
class vendor_listing_admin extends vendor {
    ...
    <br /><hr />
        ...
        <? 
            ...
            $sql    = 'SELECT * FROM leads WHERE vendor_id = '.$company_id.'';
 ...
 function validateForm() {
    ...
    if (x == null || x == "") {
        ...
        return false;
                    ...
                    <tr>
                        <td colspan="2" align="center">
                            <form name="leadsform" method="post" action="index-vendor-js.php?action=categories2&id=<?= $this->id ?>" onsubmit="return validateForm()">
