    	...
    	<TD align=center colspan=2>
			<TABLE WIDTH="70%" cellpadding="0" cellspacing="0"> 
				...
				<TR> 
					...
					<TD></TD> 
					<TD>
						<INPUT NAME="phone" SIZE="54" VALUE="<? echo $phone ?>"  MAXLENGTH="12" STYLE="font-size: 14px; height:20px; width:205px; padding-left:5px; background-color:#CCC; box-shadow: 5px 5px 5px #888888" placeholder="Phone Number" ><span style="font-size:10px; font-style:italic">&nbsp;&nbsp;&nbsp;(Please include Area Code)</span>
					</TD> 
				</TR>
    			<!-- <tr>
        			<td colspan="3"><p></p></td>
...
<table>
          ...
          <tr>
          	<td colspan="2"><center><br /><INPUT type="submit" value="Submit Advertising Request" style="height:20px; width:250px; font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; color:#000; background-color:#b58e4f; padding-left:10px; box-shadow: 5px 5px 5px #888888; cursor:pointer" ></center><br /> </td>
          </tr>
             <tr>
...
<center><INPUT TYPE="CHECKBOX" style="width:16px;height:16px" name="request1" VALUE="LA Media Kit/Rates Package" ><font size="3"><b>&nbsp;Yes!</b></font></b> <br /><font size="2">Send me the LASN Media Kit and Rates Packet!</font></center>
             ...
             <TD VALIGN="top"> <center>                                                                     
                ...
                <center><font size="2">Reaching 47,500 Landscape Installation and <br />Maintenance Business Owners & Superintendents</font></center><br /><br />                                                                    
	...
	<br></br>
              ...
              <center>
                <font size="2">Reaching 46,000 Commercial Landscape <br />Professionals Every Week</font></center><br /><br />
...
Long Beach and San Mateo, California</font></center><br /><br />
            ...
            <td align="top">
            <br />
          <center><a href="https://landscapearchitect.com/research/LASN-Expo/index-LAX-2015.php" target="_blank"><IMG SRC="/lol-logos/LD-Expo-blank.jpg" width="175" ALT="LAX" BORDER="0" /></a></center><br /><br />
          <center>
            <font size="2">T</font><font size="2">he WesternTrade 
Show and Educational <br />Conference 
for Landscape Architects, <br />
Specifiers and Design 
Professionals</font>
          </center><br /><br />
  ...
  <tr>
  	<td colspan="2"><br /><center><INPUT type="submit" value="Submit Advertising Request" style="height:20px; width:250px; font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; color:#000; background-color:#b58e4f; padding-left:10px; box-shadow: 5px 5px 5px #888888" ></center>
    </td>
  </tr>
</table>
