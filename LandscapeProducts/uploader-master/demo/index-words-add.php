...
<html lang="en">
  ...
  <body>
									...
									<?
                                        ...
                                        $sql = "INSERT INTO vendor_product (vendor_id, product_name, imported, xlist, company_name, cadd, cadd_2, cadd_3, pdff, skup, vwxx, mediap, zipp, series_product)
                                        VALUES ('" . $coId . "', '" . $prodName2 . "', '" . $import . "', '', '" . $coName . "', 'none', 'none', 'none', 'none', 'none', 'none', 'none', 'none', '" . $seriesProd . "')";
                                  ...
                                  <script type='text/javascript'>
                                    ...
                                    /* javascript:self.close();window.opener.location.reload(true); */
                                      ...
                                      window.location.href = 'https://landscapearchitect.com/LandscapeProducts/index-vendor-detail-edit-js.php?number='+x+'&prodNum='+y+'';
