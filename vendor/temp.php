...
<div class="tab">
  ...
  <button class="tablinks" onclick="openCity(event, 'Paris')">List View</button>
	...
	<option value="https://landscapearchitect.com/vendor/index-vendor-js2.php?action=edit&tview=allp" selected ><?  if (($sName == "allp") || ($sName == "")) { echo "Refine Search"; } elseif ($sName == "other") { echo $xChoice; } ?></option>
	<option value="https://landscapearchitect.com/vendor/index-vendor-js2.php?action=edit&tview=allp#defpro" >All Products</option>  
					 ...
					 $sql33 = "select * from vendor_product LEFT JOIN xlist ON vendor_product.xlist = xlist.id WHERE vendor_id='" . $key2 . "' ORDER BY name ASC";
						...
						while($row = mysqli_fetch_array($result33)) { 
							...
							if ($xname != $row['name']) {
										...
										echo '<option value="https://landscapearchitect.com/vendor/index-vendor-js2.php?action=edit&tview=other&xlist=' . $row['xlist'] . '#defpro" >' . $row['name'] . '</option>';
	 ...
	 <img width="15%" src="https://landscapearchitect.com/vendor/images/add-button.png" class="viewBarAddProductsBtn">
</div>	
...
<div id="London" class="tabcontent">
  <p>
      ...
      ?>
                              ...
                              <h3 style="margin-bottom: 15px;">Product View<? echo $xChoice; ?></h3>
                    ...
                    $result22 = $conn->query($sql22); 
                        ...
                        while($row = mysqli_fetch_array($result22)) {
                            ...
                            if ($xname != $row['name']) {
                                ...
                                echo '<h3><span style="font-family: Helvetica, Arial, sans-serif; font-size:18px; font-weight:bold; padding-top: 10px">Category:</span> ' . $row['name'] . "</h3>";
...
<div id="Paris" class="tabcontent">
  ...
  <p>
      ...
      ?>
                              ...
                              <h3 style="margin-bottom: 5px;">Product View <? echo $xChoice; ?></h3>
                    ...
                    $result22 = $conn->query($sql22); 
                        ...
                        while($row = mysqli_fetch_array($result22)) {
                            ...
                            if ($xname != $row['name']) {
                                ...
                                echo '<h3>Category: <span style="font-family: Helvetica, Arial, sans-serif; font-size:18px; font-weight:bold; padding-top: 10px">' . $row['name'] . "</span></h3><br><br>";
                    ...
                    include("connect3.inc"); 
                                    ...
                                    $result = $conn->query($sql); 
                                        ...
                                        while($row = mysqli_fetch_array($result)) {
                                                ...
                                                echo '<br><br><div class="container"><div class="row"><div class="col-md-2" id="prodBox" style="width:30%"><figure><div class="limage" style="background-image: url(\'https://landscapearchitect.com/products/images/' . $row['photo'] . '\'); background-size: cover; background-position: center;" title="' . $string . '"></div></div><div class="col-md-2" style="width:70%"><span style="font-family: Helvetica, Arial, sans-serif; font-size:18px; font-weight:bold; padding-top: 10px">' . iconv('CP1252', 'UTF-8//TRANSLIT', (stripslashes($row['product_name']))) . '</span><br><span style="font-family: Helvetica, Arial, sans-serif; font-size:16px; font-weight:bold">Product Description:</span><br>' . iconv('CP1252', 'UTF-8//TRANSLIT', (stripslashes($row['description']))) . '<br><span style="font-family: Helvetica, Arial, sans-serif; font-size:16px; font-weight:bold">Product Link: </span>' . $row['web_photo'] . '</span><br><span style="font-family: Helvetica, Arial, sans-serif; font-size:16px; font-weight:bold">Available Detail Files:</span><br>' . $pdfImg . $dwgImg . $dwgImg2 . $dwgImg3 . $dwgImg4 . $dwgImg5 . $dwgImg6 . $dwgImg7 . $noDwg . '</figure><br></div></div></div><!-- <div style="position:relative; left:15px; top:10px"><img width="10%" src="https://landscapearchitect.com/vendor/images/edit-button.jpg">&nbsp;' . $topButton . '&nbsp;<img width="10%" src="https://landscapearchitect.com/vendor/images/' . $actButton . '"></div> --><br><hr><br>';
