...
A proof of for your Lead Generator has been created and is pending your
...
$results2 = mysqli_query($connecDB,"select * from vendor_product LEFT JOIN vendor_product_lg_approvals ON vendor_product_lg_approvals.vendor_product_id=vendor_product.id WHERE " . $row['id'] . "");

while($row = mysqli_fetch_array($results2)) {
	$company_namevp= $row["vendor_product.company_name"];
	$phonevp= $row["phone"];
}
...
?>
      ...
      <div><span style="font-size:16px; font-family:\'Times New Roman\', Times, serif; line-height:1.1em">
        Company Name: <strong><?php echo $company_namevp ?></strong><br />
...
?>
        ...
        <div>
          ...
          plus add the second photo or the new product profile to the &nbsp; <img width="20%" src="https://landscapearchitect.com/lol-logos/LO_600-brown.jpg"> &nbsp; Product Search Engine for only $195.00 !!!</span></center><br>
                    ...
                    <table cellspacing="10">
                      <tr>
                        ...
                        <tr>
                          ...
                          <td style="font-size:16px; font-family:\'Times New Roman\', Times, serif"><a href="mailto:vchavira@landscapeonline.com?subject=Lead Generator Upgrade Information Request&body=Please send me Lead Generator Upgrade Information">George Schmok - (714) 979-5276 x 110</a></center></td>
                        </tr>                        
                        <tr>
