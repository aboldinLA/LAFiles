...
function checkCount(field){
    ...
    <table width='100%' cellpadding='0' cellspacing='0' border='0'>
        ...
        <form method="POST" name="RContact" action="photo_edit_categories_do.php">
            ...
            <tr><td><a href='photo_edit.php?company_id=<?= $company_id ?>'><img src='/imgz/vendor/cancel_contact.gif' border='0' /></a></td><td align='right'><input type="image" src="/imgz/vendor/continue.gif" border="0" /></td></tr>
            
            <?php echo get_children_html($product_id); ?>
            
            
            <tr><td><a href='photo_edit.php?company_id=<?= $company_id ?>'><img src='/imgz/vendor/cancel_contact.gif' border='0' /></a></td><td align='right'><input type="image" src="/imgz/vendor/continue.gif" border="0" /></td></tr></table>
        </form>
                        </td>
            </tr>
