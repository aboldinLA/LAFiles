...
require_once("vendor_listing-test.php");
    ...
    */
    ...
    function editNavigation() {
        ...
        <div style='float: right;'>
            <a href='exit.php'><img src='/imgz/vendor/exit.gif' border='0' /></a>
        </div>
        <div class='formInfo'>
            When completed, you can exit back to the LandscapeOnline.com Home Page by using the exit button on the right.
        </div>
...
ENDH;
    ...
    function contactSummary() {
        ...
        <table width='100%' class='searchOptions' cellpadding='0' cellspacing='0' border='0'>
            <tr class='cellhead'>
                <td colspan='3' class='cellhead'>Contact Information [ <a href='<?= $_SERVER['PHP_SELF'] ?>?action=contact&id=<?= $this->id ?>'>edit</a> ]</td>
            </tr>
            <tr>
                <td height='15' width='15%' valign='top' align='right'><strong>Name</strong></td>
                <td width='2%'>&nbsp;</td>
                <td> <?= $this->getPrimaryFullName(); ?> </td>
            </tr>
            <tr>
                <td height='15' width='15%' valign='top' align='right'><strong>Address</strong></td>
                <td width='2%'>&nbsp;</td>
            ...
            <tr>
                <td height='15' width='15%' valign='top' align='right'><strong>Phone</strong></td>
                <td width='2%'>&nbsp;</td>
                <td> <?= $this->getPrimaryPhoneNumber(); ?> </td>
            </tr>
            <? if(!is_null($c->fax_number) && strlen($c->fax_number) > 0) { ?>
            <tr>
                <td height='15' width='15%' valign='top' align='right'><strong>Fax</strong></td>
                <td width='2%'>&nbsp;</td>
                <td> <?= $this->getPrimaryFaxNumber(); ?> </td>
            </tr>
            <? } ?>
            <tr>
                <td height='15' width='15%' valign='top' align='right'><strong>Email</strong></td>
                <td width='2%'>&nbsp;</td>
                <td>
                    <a href='mailto:<?= $this->getPrimaryEmail(); ?>'><?= $this->getPrimaryEmail(); ?></a>
                </td>
            </tr>
        </table>
        <?
    ...
    function slurpRegionalForm($cid=NULL) {
        ...
        // pbool of 0 => use primary
        // pbool of 1 => use local
