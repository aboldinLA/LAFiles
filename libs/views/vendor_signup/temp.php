...
<form method='POST' name='RContact' runat='vdaemon' action='<?= $_SERVER['PHP_SELF'] ?>'>
    ...
    <div style="position:relative; top:25px">
		...
		HOWEVER be careful not to select categories from which you don't provide the product or service<br>
		as <u><strong>you will get calls from those search results!</strong></u><br /><br />
