...
<div>
   ...
   Welcome to</p>
	...
	<p style="font-family:Gotham, 'Helvetica Neue', Helvetica, Arial, sans-serif; font-size:16px; line-height:20px">Simply click on the the link to view the online Vendor Profile Center.<br>
    - or - <br />
...
<span style="font-size:16px">Featured Vendors&nbsp;&nbsp;</span>
                                ...
                                <form method="post" action="prod-request-mail-vendor.php">
								...
								$('input[type="checkbox"]', $(this).parent('li')).attr('checked', status);
                                    	...
                                    	<div>
                                        	<h3 id="numralh3">Featured Vendors for September &nbsp; &nbsp;
                                            <input  type="submit" value="Submit for Vendor Info" style="height:20px; width:200px; font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; color:#000; background-color:#b58e4f; padding-left:10px; box-shadow: 5px 5px 5px #888888"></h3><br />
...
<!-- Horizontal Bar End -->                                            
                                            ...
                                            <input type="checkbox" name="selected8" id="box_8" value="4441" /> <label for="box_7">&nbsp;&nbsp;&nbsp;<a href="https://landscapearchitect.com/vendor-pages/otterbine/otterbine.php?id=<? echo $_GET[id] ?>&coid=4441" target="_blank"><img width="15%" src="https://landscapearchitect.com/products/images/logo_ba08bc2a8cdbf773281749fc3128dde1.jpg"></a><br>
...
<!-- Horizontal Bar End -->                                            
                                            ...
                                            <input type="checkbox" name="selected9" id="box_9" value="42448" /> <label for="box_7">&nbsp;&nbsp;&nbsp;<a href="https://landscapearchitect.com/vendor-pages/brave/brave.php?id=<? echo $_GET[id] ?>&coid=42448" target="_blank"><img width="20%" src="https://landscapearchitect.com/products/images/logo_2ade3a44552a3a70a57f506b2ed84831.jpg"></a><br>
...
<!-- Horizontal Bar End -->                                            
                                            ...
                                            <input type="checkbox" name="selected10" id="box_10" value="12092" /> <label for="box_7">&nbsp;&nbsp;&nbsp;<a href="https://landscapearchitect.com/vendor-pages/earthway/earthway.php?id=<? echo $_GET[id] ?>&coid=12092" target="_blank"><img width="20%" src="https://landscapearchitect.com/products/images/logo_8f3bcdbbd47bfb2221c0a9c87ae7c1b5.jpg"></a><br>
...
<!-- Horizontal Bar End -->                                            
                                            ...
                                            <input type="checkbox" name="selected12" id="box_12" value="43022" /> <label for="box_7">&nbsp;&nbsp;&nbsp;<a href="https://landscapearchitect.com/vendor-pages/infinity/infinity.php?id=<? echo $_GET[id] ?>&coid=43022" target="_blank"><img width="15%" src="https://landscapearchitect.com/products/images/logo_2869caee4d711fddcd105b6ff9be657f.jpg"></a><br>
								...
								<script>
									...
									function myButtonFunction5() {
                                        ...
                                        <input  type="submit" value="Submit for Vendor Info" style="height:20px; width:200px; font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; color:#000; background-color:#b58e4f; padding-left:10px; box-shadow: 5px 5px 5px #888888">
