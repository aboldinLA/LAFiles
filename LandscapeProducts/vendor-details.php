											...
											while($row = mysqli_fetch_array($result)) {
												...
												$small = substr($productName, 0, 31);
												 ...
												 if (empty($row['pdff']) || $row['pdff'] == 'none') {
																	...
																	$cadPdf = '<div class="col-md-2 col-sm-2 col-xs-2 single-icon"><img src="/images/products/details/formats/3.png" style="width:100%;" /></div>';
															...
															if (empty($row['cadd']) || $row['cadd'] == 'none') {
																	...
																	$cadDwg = '<div class="col-md-2 col-sm-2 col-xs-2 single-icon"><img src="/images/products/details/formats/2.png" style="width:100%;" /></div>';
															...
															if (empty($row['cadd_2']) || $row['cadd_2'] == 'none') {
																	...
																	$cadDwf = '<div class="col-md-2 col-sm-2 col-xs-2 single-icon"><img src="/images/products/details/formats/dwf.jpg" style="width:100%;" /></div>';
															...
															if (empty($row['cadd_3']) || $row['cadd_3'] == 'none') {
																	...
																	$cadDxf = '<div class="col-md-2 col-sm-2 col-xs-2 single-icon"><img src="/images/products/details/formats/dxf.jpg" style="width:100%;" /></div>';
															...
															if (empty($row['skup']) || $row['skup'] == 'none') {
																	...
																	$cadSkp = '<div class="col-md-2 col-sm-2 col-xs-2 single-icon"><img src="/images/products/details/formats/skp.jpg" style="width:100%;" /></div>';
															...
															if (empty($row['vwxx']) || $row['vwxx'] == 'none') {
																	...
																	$cadVwx = '<div class="col-md-2 col-sm-2 col-xs-2 single-icon"><img src="/images/products/details/formats/vwx.jpg" style="width:100%;" /></div>';
															...
															if (empty($row['mediap']) || $row['mediap'] == 'none') {
																	...
																	$cadMedia = '<div class="col-md-2 col-sm-2 col-xs-2 single-icon"><img src="/images/products/details/formats/1.png" style="width:100%;" /></div>';
															...
															if (empty($row['zipp']) || $row['zipp'] == 'none') {
																	...
																	$cadZipp = '<div class="col-md-2 col-sm-2 col-xs-2 single-icon"><img src="/images/products/details/formats/4.png" style="width:100%;" /></div>';
