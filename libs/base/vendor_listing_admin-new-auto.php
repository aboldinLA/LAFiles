...
class vendor_listing_admin extends vendor {
    ...
    function action($action = 'default', $vars = NULL) {
        ...
        switch($action) {
            ...
            case 'edit':
				$pass =  $_GET["pass"];
				$sql = ("SELECT id FROM new_vendor WHERE pass='$pass'");
				...
				$vars['passcode'] = $id;
                $this->adminDisplaySummary($vars['passcode']);
                break;
            case 'categories':
    ...
    function editRegionalContacts($id=NULL) {
        ...
        switch($_REQUEST['intent']) {
			...
			echo "<table cellpadding='5' cellspacing='10'>
				...
				$link_address = 'https://landscapearchitect.com/vendor/index-vendor-auto.php?action=edit';
				echo '<div class="tb5" style="width:250px; box-shadow: 5px 5px 5px #888888">
  				&nbsp;&nbsp;<a href="https://landscapearchitect.com/vendor/index-vendor-auto.php?action=manage&record='. $this->id .'">Click to Return to Proflie</a>&nbsp;&nbsp
				</div>';
                /*
                $c = new contact();
    ...
    function editCompany($id=NULL) {
        ...
        switch($_REQUEST['intent']) {
            case 'edit':
				...
				$link_address = 'https://landscapearchitect.com/vendor/index-vendor-auto.php?action=manage&pass='. $this->pass;
				echo '<div class="tb5" style="width:250px; box-shadow: 5px 5px 5px #888888">
  				&nbsp;&nbsp;<a href="https://landscapearchitect.com/vendor/index-vendor-auto.php?action=manage&pass='. $this->pass .'">Click to Return to Proflie</a>&nbsp;&nbsp
				</div>'; 
                break;
            default:
	...
	$result = mysql_query($sql);
			...
			echo "<tr><td colspan=\"2\" style=\"font-family:Arial, Helvetica, sans-serif; font-size:14px\"><a href=\"https://landscapearchitect.com/vendor/ex-test6.php?id=$id&small=$small&large=$large\"><strong>" . "Click Here Download This Lead Report in .xls Format" . "</strong></a></td></tr>";
			echo "<tr><td colspan=\"2\" style=\"font-family:Arial, Helvetica, sans-serif; font-size:14px\"><a href=\"javascript:window.print()\"><strong>" . "Click Here to Print This Lead Report " . "</strong></a></td></tr>";
			echo "<tr><td colspan=\"2\" style=\"font-family:Arial, Helvetica, sans-serif; font-size:14px\"><a href=\"https://landscapearchitect.com/vendor/index-vendor-auto?action=edit&pass=$pass \"><strong>" . "Return to Your Vendor Profile & Lead Center" . "</strong></a></td></tr>";
    ...
    function showCompanyEdit() {
        ...
        <form method='POST' name='RCompany' runat='vdaemon'>
        <vlsummary class='errSummary' displaymode='bulletlist' headertext='<h3>Error(s) found:</h3>' />
            <input type='hidden' name='id' value='<?= $this->id ?>' />
            <input type='hidden' name='intent' value='edit' />
            <input type='hidden' name='action' value='company' />
            <? $this->showView('company-main-auto.php', TRUE); ?>
        </form>
        <?
    ...
    function showCategoryEdit2() {
 	...
 	<a href="https://landscapearchitect.com/vendor/ex-test-week2.php?id=<?= $this->id ?>&week=<? echo $week ?>"><font size="3"><strong><span style="text-shadow:none">Click Here Download This Lead Report in .xls Format</strong></span></font></a></p>
	<p><font size="3">
	<a href="#" onclick="printTable('table0'); return false;"><span style="text-shadow:none"><strong>Click Here to Print This Lead Report</strong> <? echo $weekcsv ?></span></a></font></p>
    <p><font size="3">
	<a href="https://landscapearchitect.com/vendor/index-vendor-auto.php?action=edit&pass=<?= $this->pass ?>"><span style="text-shadow:none"><strong>Return to Your Vendor Profile & Lead Center</strong></a></span></font></p>
    <br /><hr />
...
<!-- 	<p><font size="3"> <br />
	...
	<p><font size="3">
	<a href="#" onclick="printTable('table0'); return false;"><span style="text-shadow:none">Click Here to Print This Lead Report <? echo $weekcsv ?></span></a></font></p>
    <p><font size="3">
	<a href="https://landscapearchitect.com/vendor/index-vendor-auto.php?action=edit&record=<?= $this->id ?>"><span style="text-shadow:none">Return to Your Vendor Profile & Lead Center</span></a></font></p> -->
...
?>
  ...
  &nbsp;&nbsp;Company Information [ <a href='<?= $_SERVER['PHP_SELF'] ?>?action=company&id=<? echo $nwl ?>&pass=<? echo $pass ?>'>edit</a> ]&nbsp;&nbsp
</div><br /><br />
 ...
 function validateForm() {
    ...
    if (x == null || x == "") {
        ...
        return false;
                    ...
                    <tr>
                        <td colspan="2" align="center">
							<form method="post" action="https://landscapearchitect.com/vendor/index-vendor-auto.php?action=categories2&id=<?= $this->id ?>" onsubmit="return validateForm()">
    ...
    {
    ?>
    <form method = "post" action="https://landscapearchitect.com/vendor/index-vendor-auto.php?action=categories3&id=<?= $this->id ?>&pass=<?= $this->pass ?>">
...
<!-- Test popup2 end -->
	...
	// To Photo Section html in this php      
