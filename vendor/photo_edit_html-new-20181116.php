...
<div id="London" class="tabcontent">
  <p>
      ...
      ?>
                              ...
                              <h3>Product View - <? echo $xChoice; ?></h3>
                                <p>Choose view from dropdown below</p>

                            <select onchange="if (this.value) window.location.href=this.value" id="fixed" style="width: 50%">
                                <option value="https://landscapearchitect.com/vendor/index-vendor-js.php?action=edit&tview=allp" selected ><?  if (($sName == "allp") || ($sName == "")) { echo "All Products"; } elseif ($sName == "other") { echo $xChoice; } ?></option>
                                            ...
                                            while($row = mysqli_fetch_array($result)) {
                                                ...
                                                if (($rowcount == 3) || ($rowcount == 6) || ($rowcount == 9) || ($rowcount == 12)) {
                                                    ...
                                                    if ($iCount == 1) {
                                                        ...
                                                        // took out ' display: -webkit-box;' to remove inactive scroll bars
                                                        echo '<div class="container"><div class="row"><div class="col-md-3" id="prodBox" style="width:30%; margin-right: 22px"><div align="center" style="margin:auto"><figure><div class="limage" style="background-image: url(\'https://landscapearchitect.com/products/images/' . $row['photo'] . '\'); background-size: cover; background-position: center;" title="' . $string . '"></div><br><figcaption><span style="font-family: Helvetica, Arial, sans-serif; font-size:18px; font-weight:bold; width: 100%; overflow: scroll; -webkit-line-clamp: 1; -webkit-box-orient: vertical;">' . iconv('CP1252', 'UTF-8//TRANSLIT', (stripslashes($row['product_name']))) . '</span><!-- <br><br><img width="35%" src="https://landscapearchitect.com/vendor/images/edit-button.jpg">&nbsp;' . $topButton . '&nbsp;<img width="35%" src="https://landscapearchitect.com/vendor/images/' . $actButton . '"> --></figcaption></figure></div><br></div></div></div></div></div>';
