...
$sql = "SELECT id FROM new_vendor WHERE  pass = 'lcipc09351'";
...
class vendor_listing_admin extends vendor {
    ...
    function editCompany($id=NULL) {
        ...
        switch($_REQUEST['intent']) {
            case 'edit':
				...
				$link_address = 'https://landscapearchitect.com/vendor/index-vendor-auto.php?action=manage&record='. $this->id;
				echo '<div class="tb5" style="width:250px; box-shadow: 5px 5px 5px #888888">
  				&nbsp;&nbsp;<a href="https://landscapearchitect.com/vendor/index-vendor-auto.php?action=manage&record='. $this->id .'">Click to Return to Proflie</a>&nbsp;&nbsp
				</div>';
                break;
    ...
    function showCategoryEdit2() {
        ...
        <? $week = $_POST['week']; ?>
        <p><font size="3"> <br />
 	<a href="https://landscapearchitect.com/vendor/ex-test3.php?id=<?= $this->id ?>&week=<? echo $week ?>"><font size="3"><strong><span style="text-shadow:none">Click Here Download This Lead Report</strong><font size="2">&nbsp;(Report Downloads in CSV (Comma-Separated Values) Format)</span></font></font></a></p>
	<p><font size="3">
    ...
    <p><font size="3">
	<a href="https://landscapearchitect.com/vendor/index-vendor-auto.php?action=edit&record=<?= $this->id ?>"><span style="text-shadow:none">Return to Your Vendor Profile & Lead Center</a></span></font></p>
    <br /><hr />
...
<script type="text/javascript">
	...
	<p><font size="3"> <br />
 	<a href="https://landscapearchitect.com/vendor/ex-test3.php?id=<?= $this->id ?>&week=<? echo $week ?>"><font size="3"><strong><span style="text-shadow:none">Click Here Download This Lead Report</strong><font size="2">&nbsp;(Report Downloads in CSV (Comma-Separated Values) Format)</span></font></a></p>
	<p><font size="3">
	<a href="#" onclick="printTable('table0'); return false;"><span style="text-shadow:none">Click Here to Print This Lead Report <? echo $weekcsv ?></span></a></font></p>
    <p><font size="3">
...
?>
  ...
  &nbsp;&nbsp;Company Information [ <a href='<?= $_SERVER['PHP_SELF'] ?>?action=company&id=<? echo $nwl ?>'>edit</a> ]&nbsp;&nbsp
</div><br /><br />
...
<div class="tb4" style="width:750px; box-shadow: 5px 5px 5px #888888">
  <a id="leads1">&nbsp;&nbsp;Lead Information&nbsp;&nbsp</a>
</div><br /><br />        
        <table width='750' class='searchOptions' cellpadding='0' cellspacing='0' border='0'>
            		<tr>
                    ...
                    <tr>
                    	<td colspan="2" align="center">
                        	<br /><span style="font-size:16px">All advertisers receive sales leads updated every Friday by 5:00 PM.<br />
                    ...
                    <tr>
                        <td width='15%'>&nbsp;</td>
                        <td>
							<form method="post" action="https://landscapearchitect.com/vendor/index-vendor-auto.php?action=categories2&id=<?= $this->id ?>">
								<strong><span style="font-size:18px; font-family:Arial, Helvetica, sans-serif; background-color:#FFF">Leads for the Week of:&nbsp;</span> </strong>
									<select multiple name="week" size="4" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; width:150px; height:70px; background-color:#CCC; box-shadow: 5px 5px 5px #888888">
										<? echo $dlist ?>
									</select>
								&nbsp;&nbsp;<input type="submit" value="View Leads" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; background-color:#a67d3b; width:100px; height:30px; box-shadow: 5px 5px 5px #888888">
							</form>
                       	</td>
                    </tr>
                    <tr>
...
<!-- Test popup2 end -->
    ...
    function photoSummary(){
        include '/home/land/public_html/vendor/photo_edit_html-auto.php';
    }
