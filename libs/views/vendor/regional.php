<div class='formInfo'>
<p>
    Regional listings allow you to list your company in the regional markets your clients are searching in.  Product searches are done on a National, State wide, and Area Code level.
</p>
<p>
        ...
        <table width='100%' border='0' align='center'>
            <tbody>
                <tr>
                    ...
                    <td class='formObject'>
                        <input type='text' id='city' name='city' size='16' value='' /> *
                ...
                <tr>
                    ...
                    <td class='formObject' valign='top'>
                        ...
                        <input tabindex=12 name='postal_code' id='postal_code' type='text' size='16' value="<?= $this->getCompanyPostalCode(); ?>" /> *
                        <vlvalidator
                            name='StateReq'
                            type='required'
                            control='state'
                        ...
                        <table width='100%' border='0'>
                            <tbody>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>
                                        <strong>Regional Area Code</strong> <input type='text' id='area_code' name='area_code' size='3' value='' /> *<br />
                                        <hr noshade size='-1' />
                                    </td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    <td>&nbsp;</td>
                                    <td>
                                        <strong>Full Phone Number</strong> (<input type='text' name='area_code2' id='area_code2' size='3' value='' />) 
                                        <input type='text' name='phone_number' size='10' value='' />
                                    </td>
                                </tr>
                            </tbody>
                        </table>
