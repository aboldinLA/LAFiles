    ...
    <div class="add_nn">
				...
				<?
					...
					while($row = mysqli_fetch_array($result)){
							echo '<a href="' .  $row['web'] . '"><img src="https://landscapearchitect.com/banner/'  . $row['picture'] . '" class=" hidden-xs hidden-sm" style="width:100%;" /></a> '; 
					}
                ...
                <form id="news_letter_form" novalidate>
                    ...
                    <button type="submit" class="newsletterSignUpBtn">Sign up</button>
						...
						<?
							...
							while($row = mysqli_fetch_array($result)){
									echo '<div class="add__ full_width"><a href="' .  $row['web'] . '"><img src="https://landscapearchitect.com/banner/'  . $row['picture'] . '" class=" hidden-xs hidden-sm" style="width:100%;" /></a></div> '; 
							}
