    ...
    <tr>
    	<td>
        	<table>
				...
				<tr>
					<td colspan=2 align=center><br><input name="" value="Submit" type=submit  style="height:20px; width:100px; font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; color:#000; background-color:#b58e4f; padding-left:10px; box-shadow: 5px 5px 5px #888888"></form></td>
				</tr>
...
<div class="banner2">
	...
	<div style="position:relative; left:0px; top:60px">
    	<?
		include $include_path . "banner-ads2-assoclist.inc";
		?>
	</div>        
