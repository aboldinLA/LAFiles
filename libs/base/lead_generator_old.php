     ...
     class lead_generator {
        ...
        function approvalForm($hash) {
            ...
            <form method="POST" action="<?= $this->appUrl(); ?>/saveApproval">
                ...
                <table cellpadding="5" cellspacing="0" border="0">
                    <tr>
                        <td><strong>PLEASE TYPE CHANGES:</strong></td> 
                        <td><input size="32" type="text" name="signature" value="<?= $_REQUEST["signature"] ?>" />
                            <input type="submit" value="I request changes to the Lead Generator" />
                        </td>
                    </tr>
                </table>
                <br />
                        ...
                        Phone: <strong><?= $this->current->phoneNumber(); ?></strong>
                            ...
                            <td valign="top">
                                <div id="promo">
                                    ...
                                    <strong>
                                       Interested in increasing your exposure in the guides, or getting an additional listing in another category?  <br /> <br /> <a href="mailto:editorial@landscapeonline.com?subject=LG Upgrade for <?= $this->current->companyName(); ?>&body=Please contact me about upgrading my lead generator!">Have one of our sales team contact you today!</a>
                                    </strong>
                                </div>
                            </td>
                    </table>
