...
$(document).ready(function() {
	...
	$('#results').load("https://landscapearchitect.com/products/load-more-results/fetch_pages2.php?keyword2=<? echo preg_replace('/\s+/', '+', $_POST[keyword]) ?>", {'page':track_click}, function() {track_click++;}); //initial data to load
	...
	$(".load_more").click(function (e) { //user clicks on button
		...
		if(track_click <= total_pages) //make sure user clicks are still less than total pages
		{
			...
			$.post('https://landscapearchitect.com/products/load-more-results/fetch_pages2.php?keyword2=<? echo $_POST[keyword]; ?>',{'page': track_click}, function(data) {
