...
include("lo_top-common-full.inc");
...
<div>
	...
	<table width="1024">
		...
		<?
		include("lo_left-side-common-old.inc");
...
<!-- Horizontal Bar End -->   			
	...
	<?
							...
							$sql="select * from subscribe where id='". $uid . "'";
							...
							?>							
									...
									<div id="divCheckboxList" style="position: relative; left: 50px">
										<table>
											...
											<tr>
												<td colspan="3" style="position: relative; left: 85px"><div><input type="checkbox" name="opt_inlc005" value="LC-W" checked />&nbsp;<img style="position: relative; left: 0px; top: 10px" width="50%" src="https://landscapearchitect.com/lol-logos/LOW-LCDBM-072018.jpg"><br><br><strong style="position: relative; left: 60px">Landscape Contractor Weekly</strong></div></td>
											</tr>											
								...
								<!--	<div id="divCheckboxList" style="position: relative; left: 50px">
										...
										<table>
											...
											<tr>
												<td colspan="3" style="position: relative; left: 85px"><div><input type="checkbox" name="opt_inlc005" id="lcdbm5" <? if ($opt_inlc[4] == "LC-W") echo "checked";?> value="LC-W" />&nbsp;<img width="50%" src="https://landscapearchitect.com/lol-logos/LOW-LCDBM-072018.jpg"><br><strong style="position: relative; left: 60px">Landscape Contractor Weekly</strong></div></td>
											</tr>											
...
<!-- Horizontal Bar Start -->
<div style="position:absolute; left:305px; top:1930px; padding:0px; width:700px; height:2px; background-color:#605b51;"> </div>
<!-- Horizontal Bar End --> 			
	
<?  } else {  ?>
		
<!-- Horizontal Bar Start -->
<div style="position:absolute; left:305px; top:1900px; padding:0px; width:700px; height:2px; background-color:#605b51;"> </div>
<!-- Horizontal Bar End --> 		
		
<?  }  ?>
			
			
<div style="position:absolute; left:250px; top:1950px; padding:0px; font-size:16px; width:800px">
