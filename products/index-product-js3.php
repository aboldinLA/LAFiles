...
function myFunction() {
    window.open("https://landscapearchitect.com/products/index-product-js3.php?localtype=manu_imp&vst=&keyword=&next=0&ca=no&areacodes=&state=&searchby=nl&searchtype=photo", "_parent");
}

function myFunction2() {
    window.open("https://landscapearchitect.com/products/index-product-js3.php?localtype=manu_imp&vst=&next=34&keyword=&next=34&ca=no&areacodes=&state=&searchby=nl&searchtype=company", "_parent");
}
</script>
