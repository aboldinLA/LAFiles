...
function photo_results_html($results){
    ...
    foreach($results as $r){
      ...
      continue;
        ...
        $html .= "<img src='images/$r[photo]' border='0'width='233px'></div><span style='color:#906'>$r[company_name]</span><br />" . iconv('CP1252', 'ASCII//TRANSLIT', htmlentities(($r[product_name]))) . "<br />";
