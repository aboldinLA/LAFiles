				...
				<div class="flexbox-container">  <!-- took 'colShift' class off -->
				  ...
				  <div class="main col-md-9" style="position: relative; top: -75px">
                      ...
                      <h1>Product Search</h1>
						...
						$sql = 	"SELECT * FROM new_vendor LEFT JOIN vendor_product ON new_vendor.id = vendor_product.vendor_id WHERE (`product_name` LIKE '%" . $keywordSE . "%' OR `description` LIKE '%" . $keywordSE . "%') AND new_vendor.status > '2' AND series_product = '0' ORDER BY Rand()";
                             
                         } else {
                             
						$sql = 	"SELECT * FROM new_vendor LEFT JOIN vendor_product ON new_vendor.id = vendor_product.vendor_id WHERE (`vendor_product`.`xlist` = '" . $keywordSE . "') AND new_vendor.status > '2' AND series_product = '0' ORDER BY Rand()";
