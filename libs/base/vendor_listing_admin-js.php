...
class vendor_listing_admin extends vendor {
    ...
    function passwordAssign($id=NULL) {
        ...
        switch($_REQUEST['intent']) {
            case 'set':
                break;
            default:
                $this->showView('header-js.php',TRUE);
    ...
    function editRegionalContacts($id=NULL) {
        ...
        switch($_REQUEST['intent']) {
            ...
            case 'editcontact':
                ...
                $c->fetch($_REQUEST['cid']);
                $this->showView('header-js.php', TRUE);
                $c->showView('regional_edit-js.php');
                $this->showView('footer-js.php', TRUE);
                $this->clear();
                break;
            case 'add':
			...
			echo "<table cellpadding='5' cellspacing='10'>
				...
				$link_address = 'https://landscapearchitect.com/vendor/index-test-vendor.php?action=edit';
				echo '<div class="tb5" style="width:250px; box-shadow: 5px 5px 5px #888888">
  				&nbsp;&nbsp;<a href="https://landscapearchitect.com/vendor/index-test-vendor.php?action=edit">Click to Return to Proflie</a>&nbsp;&nbsp
				</div>';
				$this->clear();
                break;
            case 'newcontact':
                ...
                ?><hr noshade size='-1' /><?
                $this->showView('regional-js.php', TRUE);
                $this->timeStamp();
                $this->showView('footer-js.php',TRUE);
                break;
            case 'list':
    ...
    function showCompanyEdit() {
        ...
        <vlsummary class='errSummary' displaymode='bulletlist' headertext='<h3>Error(s) found:</h3>' />
            ...
            <? $this->showView('company-js.php', TRUE); ?>
        </form>
        <?
        $this->showView('footer-js.php',TRUE);
    }
    ...
    function showCategoryEdit() {
        ...
        <?  $xl->displayXlistSelectionWidget($list,$this->vendor_type_id); ?>
            <!-- <vlvalidator type='required'name='xlistReq' control='xlist[]' errmsg='Please select at least one product interests.'; /> -->
        </form>
        <?
        //$this->bot();
        $this->showView('footer-js.php',TRUE);
...
/*
    ...
    */
    ...
    function adminDisplaySummary($id) {
        ...
        $this->showView('header-js.php',TRUE, array('pageTitle' => '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Vendor Profile Management Center'));
    ...
    function editNavigation() {
        ...
        <div class='formInfo' style="width:750px">
            ...
            <span style="font-size:16px"><center><br />Scroll down to edit your company information, add or delete search engine categories,<br />update regional outlets, manage product profiles, and retrieve sales leads. </center><br />
...
ENDH;
 ...
 <tr>
    ...
    <span style="font-size: 16px">
    <center>
    <a href="mailto:kongstad@landscapeonline.com?subject=Advertising Information Request&body=Please send me information about my LandscapeOnline vendor profile and any other Landscape Communications, Inc. products that would be relevant for my company.">Jason Seaberg  - (714) 979-5276 x126</a>
    </center>
    </span>
    </td>
 </tr>
 <tr>
    ...
    <span style="font-size: 16px">
    <center>
    <a href="mailto:vchavira@landscapeonline.com?subject=Advertising Information Request&body=Please send me information about my LandscapeOnline vendor profile and any other Landscape Communications, Inc. products that would be relevant for my company.">Clint Phipps  - (714) 979-5276 x111</a>
    </center>
    </span>
    </td>
 </tr>
                    ...
                    <tr>
                        ...
                        <td>
							<form method="post" action="https://landscapearchitect.com/vendor/profile.php?action=categories2&id=<?= $this->id ?>">
								<strong><span style="font-size:16px; font-family:Arial, Helvetica, sans-serif">Leads for the Week of:&nbsp;</span> </strong>
									<select multiple name="week" size="4" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; background-color:#CCC; box-shadow: 5px 5px 5px #888888">
										<? echo $dlist ?>
									</select>
								&nbsp;&nbsp;<input type="submit" value="View Leads" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; background-color:#a67d3b; width:100px; height:30px; box-shadow: 5px 5px 5px #888888">
							</form>
                       	</td>
                    </tr>
        </table>
