	...
	<div style="position:absolute; left: 560px; top:225px; z-index: 0">
		...
		<span style="font-size: 12px">(Then click submit or return)</span></h3></center>
				...
				<div style="position:absolute; left: 535px; top:275px; z-index: 0">
						...
						<form method="post" action="prod-seac-a.php">
...
?>
									...
									<p style="position: absolute; top: 3000px"><button onclick="printDiv('printableArea')"><span style="color:#0D57A2">Click Here to Print Confirmation.</span></button></a> <br><br>
									Your EXPRESS Registration Badge will be mailed to You.</p><br />
