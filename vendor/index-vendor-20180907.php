...
<div>
	...
	<div style="position:absolute; left: 100px; top: 0px; z-index: 0; width: 700px">
			...
			<!-- Position correction for vendor page, this is the whole middle section -->  
			...
			<?php
				...
				$requiredClasses[] = "base/vendor_listing_admin-new-js-js3.php";
