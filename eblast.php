...
$TARGET_EMAIL = array("^ebull@landscapeonline\.com$",
		"^webmaster@landscapeonline\.com$");

            /* Help: http://www.tectite.com/fmdoc/def_alert.php */
define("DEF_ALERT","webmaster@landscapeonline.com");
...
function LoadBuiltinLanguage()
{
    ...
    $aMessages[MSG_LOG_OK] = 'OK';
        ...
        // Parameters: none
    $aMessages[MSG_THANKS_PAGE] = '<img width ="325" src="https://landscapearchitect.com/lol-logos/eblast-logo.jpg">.<br />'.
							      'Thank You for your interest in an E-Blast campaign through LandscapeOnline.com.<br />'.
							      'Put your company logo and its products in front of thousands of targeted landscape professionals in a matter of minutes or at the exact time of your next big product introduction!<br />'.
								  'A representative will contact you to discuss this exciting Marketing Tool and to help you get immediate and direct response to your next promotional campaign. Thanks again . . .<br />'.
								  '<a href="https://landscapearchitect.com/index.php">Return to LandscapeOnline.com</a>';
