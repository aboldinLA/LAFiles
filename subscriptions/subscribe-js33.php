...
<div style="position:absolute; left:-45px; top:1550px; padding:0px; font-size:16px; width:800px">
			...
			<center>
				...
				<img  src="https://landscapearchitect.com/lol-logos/TLE-Mag-Logo-black.jpg" style="width:50%"><br/><br/>
		
		
				<table  width='650px' style="position: relative; left: -5px">
					<tr>
						<td colspan="2" align="center"><h3>I would like to subscribe / opt-in to receive <br>
										Landscape Expo Magazine (LEM)</h3></td>
					</tr>
						...
						<td>
							...
							?>							
									...
									<div id="divCheckboxList" style="position: relative; left: 50px">
										<table>
											<tr>
												<td><div><input type="checkbox" name="opt_inlc001" value="LC-MS" checked />&nbsp;LEM Magazine Subscription</div></td><td style="width: 10px">&nbsp;</td><td><div><input type="checkbox" name="opt_inlc002" value="LC-CE" checked />&nbsp;LEM Calls for Editorial</div></td>
											</tr>
											
											<tr><td style="line-height: 10px">&nbsp;</td></tr>
											
											<tr>
												<td><div><input type="checkbox" name="opt_inlc003" value="LC-DM" checked />&nbsp;LEM Digital Magazine</div></td><td style="width: 10px">&nbsp;</td><td><div><input type="checkbox" name="opt_inlc004" value="LC-ASP" checked />&nbsp;LEM Advertising Sales Promos</div></td>
											</tr>
									...
									<div id="divCheckboxList" style="position: relative; left: 50px">
										...
										<table>
											...
											<tr>
												<td colspan="3" style="position: relative; left: 85px"><div><input type="checkbox" name="opt_inlc005" id="lcdbm5" <? if ($opt_inlc[4] == "LC-W") echo "checked";?> value="LC-W" />&nbsp;<img width="50%" src="https://landscapearchitect.com/lol-logos/TLE-Weekly-Logo.jpg"><br><strong style="position: relative; left: 60px">The Landscape Expo Weekly</strong></div></td>
											</tr>											
