...
$results = mysqli_query($connecDB,"select * from editorial WHERE subject = '4' ORDER by id DESC");
...
?>
    ...
    <a href="https://landscapearchitect.com/research/article-econo.php" target="_blank">View Full List of Economic News</a>
    </div>