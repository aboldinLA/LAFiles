...
<table width='100%' border='0'>
    <tbody>
        ...
        <tr>
            <td class='formLabel' width='25%'>Photo (Read Only)</td>
            <td class='formObject'>
            <? if(isset($this->id)) { ?>
    ...
    <tfoot>
        <tr>
            <td align='left'><a href='https://landscapearchitect.com/vendor/photo_edit.php?company_id=<?= $record ?>'><img src='/imgz/vendor/exit.gif' border='0' /></a></td>
...
function delete_product_photo($product_id, $company_id){
    ...
    $to = 'lshield@landscapeonline.com';
