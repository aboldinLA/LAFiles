<?php
     ...
     */
     ...
     // require_once('lead_generator_product_focus.php');
     ...
     class lead_generator_approval_controller extends lead_generator {
        ...
        function action($verb, $args) {
            switch($verb) {
                ...
                case 'saveApproval':
                    ...
                    /*********** MARL 03/23/07 ************/
                    if($_POST['submit']=='Submit Change Request'){	                    
        ...
        function approved() {
			...
			<meta http-equiv="REFRESH" content="0;url=https://landscapearchitect.com/research/lg-response/lg-approval.php">
            ...
            <div id="content">
                ...
                <p>
                	Do you offer products in other BUYER'S GUIDE categories???
                </p>
                <p>
                	This is a <u>once per year opportunity</u> to make sure your brands are highlighted in any important categories. Add profiles starting at $295.
                </p>
                    <p>
                    For more information call your sales representative below.
                    </p>
                </p>
        ...
        function dis_approved() {
			...
			<meta http-equiv="REFRESH" content="0;url=https://landscapearchitect.com/research/lg-response/lg-disapproval.php">
            ...
            <div id="content">
                ...
                <p>If you would like to <b>Add Product Lines</b> or upgrade to a <b>Double Image Lead Generator</b> - call 714-979-5276 x113 or click below to send an email to your advertising representative as indicated below.</p>
             <hr width="100%" noshade>
                      <h1>What Will the Lead Generator Product Profile Look Like?</h1><br><br>
                      Below are examples of Single and Double Lead Generator Product Profiles.<br><br>
                      (Example: Single Lead Generator Product Profiles)<br>
                      <table align="center">
                      	<tr>
                        	<td><img width="200" src="/devel/lg/Kalamazoo-hz.jpg"></td>
                            <td><img width="200" src="/devel/lg/Kalamazoo-vrt.jpg"></td>
                        </tr>
                      </table><br><br>
        ...
        function approvalContent(&$lga) {
            ...
            ?>
                ...
                <div>
                    <p>
                        This lead generator will use the following short descriptions:
                    </p>
                    <div class="indent">
                        <strong><?= $this->current->content(); ?></strong><br>
                    </div>
                </div>
                <h1>Image(s)</h1>
                <div>
