...
// Write to vendor_product Start
		...
		$sql = "UPDATE vendor_product SET cadd_3='" . $pString2 . "' WHERE id='" . $prodNum3 . "'";
...
// Email Notification Start
    ...
    $subject = 'Details Uploaded - CAD DXF ' . $venNum3 . '';
    $message = 'Vendor Web ID: ' . $venNum3 . ' has uploaded a CAD DXF for product: ' . $prodNum3 . ' ';
