...
if($REQUEST_METHOD=="POST")
			  ...
			  {  
						...
						//to take check boxes array
						  ...
						  $input = strtotime("now");
                               ...
                               $M->lasn_input($uid, $lcm_biz_id, $biz_title, $biz_title_other, $assoc, $assoc_other, $reg,$type_biz_other,$auth,$input,2);
 ...
 if ($action == "edit" || $action == "renew")

  {
     ...
     header("location:pro_interest_icm.php?action=".$action."&media_id=$uid");
 ...
 if ($action == !"edit" || $action == !"renew")
	...
	header("location:pro_interest_icm.php");
...
<input type="hidden"  name="uid" value="<?echo $media_id?>" >
...
<TD COLSPAN="3" class="cellhead"><STRONG>Subscription Form
		...
		<TR bgcolor="FFFFFF"> 
    	  ...
    	  <TD COLSPAN="2" ALIGN="center">
			 ...
			 <IMG SRC="image/lcm_logo.jpg"  BORDER="0" WIDTH="210"
		...
		<TR VALIGN="MIDDLE">
		  ...
		  <TD COLSPAN="2" VALIGN="MIDDLE" ALIGN="CENTER"><FONT SIZE="-1">Fields in <B><FONT
		...
		<TR>
		  ...
		  <TD>
			 ...
			 <INPUT TYPE="RADIO" NAME="biz_title" <? if ($biz_title == "Forman"){echo "Checked"; } ?> value="Forman"> Forman<BR>

			 <INPUT TYPE="RADIO" NAME="biz_title" <? if ($biz_title ==  "Project Manager"){echo "Checked"; } ?> value="Project Manager"> Project Manager<BR>

			  <INPUT TYPE="RADIO" NAME="biz_title" <? if ($biz_title ==  "Estimator"){echo "Checked"; } ?> value="Estimator"> Estimator<BR>

			 <INPUT TYPE="RADIO" NAME="biz_title"  <? if ($biz_title == "Administrator/Supervisor"){echo "Checked"; } ?>value="Admininistrator/Supervisor">Administrator/Supervisor.<BR>
		...
		<TR  VALIGN="MIDDLE"> 
				...
				<TD VALIGN="top" ALIGN="right"><FONT COLOR="#ff0000"><B>Associations</B>:</FONT><BR><FONT 

				SIZE="-1">(Please select every assoc. that you belong to)</FONT></TD> 
...
?>  
		...
		<TR> 
			...
			<TD ALIGN="RIGHT" VALIGN="TOP"><B>More than 10% of my work<BR>is in the following

			area(s):</B><BR><FONT SIZE="-1">(Select all that apply)</FONT></TD> 
			...
			<input type=checkbox name=work_type value=residential_work >Residential Work<br>



			<input type=checkbox name=work_type value=commercial_work >Commercial Work<br>

			

			<input type=checkbox name=work_type value=municipal_work >Municipal Work<br>



			<input type=checkbox name=work_type value=statefederal_work>State/Federal Work<br>
...
?></TD>
		...
		<TR> 
		  ...
		  <TD COLSPAN="2">
			 ...
			 <CENTER><FONT  SIZE="-1">Step 2 of 4 </FONT><INPUT

				NAME="Subscribe" TYPE="SUBMIT" VALUE="Continue">

				<INPUT NAME="Button1" TYPE="submit" VALUE="Clear"></CENTER></TD> 
