																											...
																											<h1 style="margin:35px 0px;font-family:\'DM Serif Text\', serif; font-size: 36px; font-weight: normal; font-style: normal; font-stretch: normal; line-height: 1.17; letter-spacing: normal; color: #4c4c4c;">' . $productName . '</h1>
																												...
																												' . $row['website'] . '</p>
																												 <div style="padding:16px 0px; ">
																														<button onclick="(function(){window.location.href =\'https://landscapearchitect.com/landscape-design-products/' . $string . '/' . $vendorNum_get . '\'})();return false;" class="prodVenBtn">View Vendor Micro Site</button>
               ...
               <?
											...
											while($row = mysqli_fetch_array($result)) {
                                                ...
                                                if (empty($row['cadd_2']) || $row['cadd_2'] == 'none') {
                                                    ...
                                                    $cadDwf = '<a href="#"><img src="https://landscapearchitect.com/images/formats/dwf.jpg" style="width:60%;" /></a>';
                                                ...
                                                if (empty($row['cadd_3']) || $row['cadd_3'] == 'none') {
                                                    ...
                                                    $cadDxf = '<a href="#"><img src="https://landscapearchitect.com/images/formats/dxf.jpg" style="width:60%;" /></a>';
                                                ...
                                                if (empty($row['skup']) || $row['skup'] == 'none') {
                                                    ...
                                                    $cadSkp = '<a href="#"><img src="https://landscapearchitect.com/images/formats/skp.jpg" style="width:60%;" /></a>';
                                                ...
                                                if (empty($row['vwxx']) || $row['vwxx'] == 'none') {
                                                    ...
                                                    $cadVwx = '<a href="#"><img src="https://landscapearchitect.com/images/formats/vwx.jpg" style="width:60%;" /></a>';
                                                ...
                                                if (empty($row['zipp']) || $row['zipp'] == 'none') {
                                                    ...
                                                    $cadZipp = '<a href="#"><img src="https://landscapearchitect.com/images/formats/4.png" style="width:60%;" /></a>';
											...
											while($row = mysqli_fetch_array($result)) {
												...
												$small = substr($productName, 0, 31);
												 ...
												 if (empty($row['pdff']) || $row['pdff'] == 'none') {
																	...
																	$cadPdf = '<div class="col-md-2 col-sm-2 col-xs-2 single-icon"><a href="#"><img src="https://landscapearchitect.com/images/formats/3.png" style="width:100%;" /></a></div>';
															...
															if (empty($row['cadd']) || $row['cadd'] == 'none') {
																	...
																	$cadDwg = '<div class="col-md-2 col-sm-2 col-xs-2 single-icon"><a href="#"><img src="https://landscapearchitect.com/images/formats/2.png" style="width:100%;" /></a></div>';
															...
															if (empty($row['cadd_2']) || $row['cadd_2'] == 'none') {
																	...
																	$cadDwf = '<div class="col-md-2 col-sm-2 col-xs-2 single-icon"><a href="#"><img src="https://landscapearchitect.com/images/formats/dwf.jpg" style="width:100%;" /></a></div>';
															...
															if (empty($row['cadd_3']) || $row['cadd_3'] == 'none') {
																	...
																	$cadDxf = '<div class="col-md-2 col-sm-2 col-xs-2 single-icon"><a href="#"><img src="https://landscapearchitect.com/images/formats/dxf.jpg" style="width:100%;" /></a></div>';
															...
															if (empty($row['skup']) || $row['skup'] == 'none') {
																	...
																	$cadSkp = '<div class="col-md-2 col-sm-2 col-xs-2 single-icon"><a href="#"><img src="https://landscapearchitect.com/images/formats/skp.jpg" style="width:100%;" /></a></div>';
															...
															if (empty($row['vwxx']) || $row['vwxx'] == 'none') {
																	...
																	$cadVwx = '<div class="col-md-2 col-sm-2 col-xs-2 single-icon"><a href="#"><img src="https://landscapearchitect.com/images/formats/vwx.jpg" style="width:100%;" /></a></div>';
															...
															if (empty($row['mediap']) || $row['mediap'] == 'none') {
																	...
																	$cadMedia = '<div class="col-md-2 col-sm-2 col-xs-2 single-icon"><a href="#"><img src="https://landscapearchitect.com/images/formats/1.png" style="width:100%;" /></a></div>';
															...
															if (empty($row['zipp']) || $row['zipp'] == 'none') {
																	...
																	$cadZipp = '<div class="col-md-2 col-sm-2 col-xs-2 single-icon"><a href="#"><img src="https://landscapearchitect.com/images/formats/4.png" style="width:100%;" /></a></div>';
