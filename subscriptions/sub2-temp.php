...
<div style="position:absolute; left:10px; top:300px; padding:0px; width:763px">
  ...
  <TR>
    <td valign='top'>
        <table>
              ...
              <tr>
                  <td style="font-size:22px; color:#C60; font-weight:bold">Tell Us About Yourself<br /><hr align="left" width="95%" noshade="noshade" />
