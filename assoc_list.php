...
$results = mysqli_query($connecDB,"select * from editorial WHERE subject = '5' ORDER by id DESC");
...
?>
    ...
    <a href="https://landscapearchitect.com/research/article-assoc.php" target="_blank">View Full List of Association News</a>
    </div>