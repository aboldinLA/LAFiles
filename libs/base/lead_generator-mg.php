            ...
            <form method="POST" action="<?= $this->appUrl(); ?>/saveApproval">
                ...
                <table cellpadding="5" cellspacing="0" border="0" width="700">
                    ...
                    <tr>
                        ...
                        <input size="32" type="text" name="signature" value="<?= $_REQUEST["signature"] ?>" /><br><br>
                    ...
                    <tr>
                    	<td>
                    		...
                    		<label>If you do not approve please put comments here:</label><br>
                    		<textarea name="d_txtarea" cols="25" rows="5"></textarea> <br/>
							<input type="submit" name="submit"  value="Do Not Approve" />
        ...
        function approvalContent(&$lga) {
            ...
            ?>
				...
				<div style="position:absolute; left:300px; top:995px; padding:0px; font-size:12px; margin:auto; width:800px">
                     If you would like to change the format, add product lines, or upgrade to a double image Lead Generator - <strong><a href="mailto:all.sales@landscapeonline.com?subject=Send Me Specs and Costs for Lead Generator&body=I am interest in receiving the Specifications and costs for Lead Generators.">approval for specs and costs</a></strong><br>
				or call 714-979-5276 x113
                </div>
                ...
                <h1>Content</h1>
                    ...
                    <div class="indent">
                       Company Name: <strong><?= $this->current->companyName(); ?></strong><br />
                        ...
                        Profile Text: <strong><?= $this->current->content(); ?></strong>
                    </div>
                </div>
...
<html>
    ...
    <body>
        ...
        <p>Thank you for submitting your company profile and photo(s) for <strong>LASN's 2013 Specifier's Guide</strong> and/or <strong>LC/DBM's 2013 Buyer's Guide.</strong></p>
