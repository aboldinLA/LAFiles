...
<div>
	...
	<table width="1024">
		...
		<?
		include("lo_left-side-common-assoc.inc");
		?>	       
	...
	<div style="position:absolute; left: 25px; top: 0px; z-index: 0; width: 700px">
			...
			<div class="tb3" style="width:725px; box-shadow: 5px 5px 5px #888888">
			...
			<?php
				...
				$requiredClasses[] = "base/vendor_listing_admin-new-js-js5.php";
