...
//                                                       
                                                    ...
                                                    if ($iCount == 1) {
                                                        ...
                                                        if ($xCount == $rowcount) {
                                                            ...
                                                            echo '<div class="col-md-3" id="prodBox" style="width:30%; margin-right: 22px"><div align="center" style="margin:auto"><figure>' . $topButton . '<div class="limage" style="background-image: url(\'https://landscapearchitect.com/products/images/' . $row['photo'] . '\'); background-size: cover; background-position: center;" title="' . $string . '"></div><figcaption><p class="productViewProductName">' . iconv('CP1252', 'UTF-8//TRANSLIT', (stripslashes($row['product_name']))) . '</p> <a href="https://landscapearchitect.com/LandscapeProducts/index-vendor-detail-edit-js.php?number=' . $row['vendor_id'] . '&prodNum=' . $row['id'] . '" target="_blank"><img width="40%" src="https://landscapearchitect.com/vendor/images/edit-button-new.jpg"></a>&nbsp;<a href="https://landscapearchitect.com/vendor/add-edit-construction.php" target="_blank" class="actBtnProductView"><img width="100%" src="https://landscapearchitect.com/vendor/images/' . $actButton . '"></a><br>  </figcaption></figure></div></div></div></div>';
                                                            $iCount = 1;
                                            ...
                                            while($row = mysqli_fetch_array($result)) {
                                                ...
                                                if (($rowcount == 3) || ($rowcount == 6) || ($rowcount == 9) || ($rowcount == 12)) {
                                                    ...
                                                    if ($iCount == 1) {
                                                        ...
                                                        echo '<div class="container"><div class="row"><div class="col-md-3" id="prodBox" style="width:30%"><div align="center" style="margin:auto"><figure>' . $topButton . '<div class="limage" style="background-image: url(\'https://landscapearchitect.com/products/images/' . $row['photo'] . '\'); background-size: cover; background-position: center;" title="' . $string . '"></div><figcaption><p class="productViewProductName">' . iconv('CP1252', 'UTF-8//TRANSLIT', (stripslashes($row['product_name']))) . '</p> <a href="https://landscapearchitect.com/LandscapeProducts/index-vendor-detail-edit-js.php?number=' . $row['vendor_id'] . '&prodNum=' . $row['id'] . '" target="_blank"><img width="40%" src="https://landscapearchitect.com/vendor/images/edit-button-new.jpg"></a>&nbsp;<a href="https://landscapearchitect.com/vendor/add-edit-construction.php" target="_blank" class="actBtnProductView"><img width="100%" src="https://landscapearchitect.com/vendor/images/' . $actButton . '"></a> <br> </figcaption></figure></div></div></div></div>';
...
<div id="Paris" class="tabcontent">
  ...
  <p>
      ...
      ?>
                                ...
                                <h2>This is the Top Product on your profile</h2>
                                <!--<h4>View Your Current Profile</h4>--><br>
                    ...
                    $sql = "select * from vendor_product where vendor_id='" . $key2 . "' AND top='top'";
                    $result = $conn->query($sql); 
                        ...
                        while($row = mysqli_fetch_array($result)) {
                                ...
                                if ($row['imported'] == '0') { $actButton = 'active-button.jpg'; } else { $actButton = 'inactive-button.jpg'; };
                                ...
                                if (($pdf === NULL || $pdf === 'none') && ($cad1 === NULL || $cad1 === 'none') && ($cad2 === NULL || $cad2 === 'none') && ($cad3 === NULL || $cad3 === 'none') && ($d3d1 === NULL || $d3d1 === 'none') && ($d3d2 === NULL || $d3d2 === 'none') && ($med1 === NULL ||$med1 === 'none')) {
                                ...
                                if ($row['imported'] == 1) {$pendingImg = '<center><strong>This product image is marked as Pending and is visable to vendor only.</strong></center>'; } else { $pendingImg = ''; };
                            
                                if ($row['imported'] == 1) {$pendingLoc = '275px'; } else { $pendingLoc = '220px'; };
								...
								echo '<div class="container"><div style="position:relative; width: 300px; left:-9px; top:' . $pendingLoc . '"><a href="https://landscapearchitect.com/LandscapeProducts/index-vendor-detail-edit-js.php?number=' . $row['vendor_id'] . '&prodNum=' . $row['id'] . '" target="_blank"><img width="25%" src="https://landscapearchitect.com/vendor/images/edit-button-new.jpg"></a>&nbsp;<a href="https://landscapearchitect.com/vendor/add-edit-construction.php" target="_blank"><img width="25%" src="https://landscapearchitect.com/vendor/images/' . $actButton . '"></a></div> <div class="row"><div class="col-md-2" id="prodBox" style="width:30%; margin-bottom: 40px;"><figure>' . $topButton . '' . $pendingImg . '<div class="limage" style="background-image: url(\'https://landscapearchitect.com/products/images/' . $row['photo'] . '\'); background-size: cover; background-position: center;" title="' . $string . '"></div></div><div class="col-md-2" style="width:70%"><span style="font-family: Helvetica, Arial, sans-serif; font-size:18px; font-weight:bold; padding-top: 10px">' . iconv('CP1252', 'UTF-8//TRANSLIT', (stripslashes($row['product_name']))) . '</span><br><span style="padding-left:10px; font-weight: bold">Make this the first product on your profile: &nbsp;<img width="18%" src="https://landscapearchitect.com/vendor/images/top-button.jpg"></span><br><span style="font-family: Helvetica, Arial, sans-serif; font-size:16px; font-weight:bold">Product Description:</span><br>' . iconv('CP1252', 'UTF-8//TRANSLIT', (stripslashes($row['description']))) . '<br><span style="font-family: Helvetica, Arial, sans-serif; font-size:16px; font-weight:bold">Product Link: </span>' . $row['web_photo'] . '</span><br><span style="font-family: Helvetica, Arial, sans-serif; font-size:16px; font-weight:bold">Available Detail Files:</span><br>' . $pdfImg . $dwgImg . $dwgImg2 . $dwgImg3 . $dwgImg4 . $dwgImg5 . $dwgImg6 . $dwgImg7 . $noDwg . '</figure><br></div></div></div> <br>';
                   ...
                   $key2 = $this->id;
                    ...
                    $result = $conn->query($sql); 
                        ...
                        while($row = mysqli_fetch_array($result)) {
                                ...
                                if ($row['top'] == 'top') { $buttonTop = 'top-button.jpg'; } else { $buttonTop = 'top-button-off.jpg'; }
                            
                                if ($row['product_act'] == 'yes') { $activeLink = 'index-active2.php'; } else { $activeLink = 'index-deactive.php'; }


								
								
								echo '<div class="container"><div style="position:relative; width: 300px; left:-9px; top:' . $pendingLoc . '"><a href="https://landscapearchitect.com/LandscapeProducts/index-vendor-detail-edit-js.php?number=' . $row['vendor_id'] . '&prodNum=' . $row['id'] . '" target="_blank"><img width="25%" src="https://landscapearchitect.com/vendor/images/edit-button-new.jpg"></a>&nbsp;<a href="https://landscapearchitect.com/LandscapeProducts/uploader-master/demo/' . $activeLink . '?prodNum=' . $key222 . '" target="_blank"><img width="25%" style="; cursor: pointer" src="https://landscapearchitect.com/vendor/images/' . $actButton . '"></a></div> <div class="row"><div class="col-md-2" id="prodBox" style="width:30%; margin-bottom: 40px;"><figure>' . $topButton . '' . $pendingImg . '<div class="limage" style="background-image: url(\'https://landscapearchitect.com/products/images/' . $row['photo'] . '\'); background-size: cover; background-position: center;" title="' . $string . '"></div></div><div class="col-md-2" style="width:70%"><span style="font-family: Helvetica, Arial, sans-serif; font-size:18px; font-weight:bold; padding-top: 10px">' . iconv('CP1252', 'UTF-8//TRANSLIT', (stripslashes($row['product_name']))) . '</span><br><span style="padding-left:10px; font-weight: bold">Make this the first product on your profile: &nbsp;<a href="https://landscapearchitect.com/LandscapeProducts/uploader-master/demo/index-maketop2.php?prodNum=' . $key222 . '&venNum=' . $key2 . '" target="_blank"><img width="18%" src="https://landscapearchitect.com/vendor/images/' . $buttonTop . '"></a></span><br><span style="font-family: Helvetica, Arial, sans-serif; font-size:16px; font-weight:bold">Product Description: </span><br>' . iconv('CP1252', 'UTF-8//TRANSLIT', (stripslashes($row['description']))) . '<br><span style="font-family: Helvetica, Arial, sans-serif; font-size:16px; font-weight:bold">Product Link: </span>' . $row['web_photo'] . '</span><br><span style="font-family: Helvetica, Arial, sans-serif; font-size:16px; font-weight:bold">Available Detail Files:</span><br>' . $pdfImg . $dwgImg . $dwgImg2 . $dwgImg3 . $dwgImg4 . $dwgImg5 . $dwgImg6 . $dwgImg7 . $noDwg . '</figure><br></div></div></div> <br>';
      ...
      ?>
	                                ...
	                                <script>
													...
													function myFunction51() {
														 ...
														 var val = "<? echo $key222 ?>" + "&venNum=" + "<? echo $key2 ?>";
													...
													function myFunction52() {
														...
														window.open("https://landscapearchitect.com/LandscapeProducts/uploader-master/demo/index-active2.php?prodNum="+val, "toolbar=yes,scrollbars=yes,resizable=yes,top=200,left=500,width=800,height=700");
													}                                          
