...
$results = mysqli_query($connecDB,"select * from editorial WHERE subject = '3' ORDER by id DESC");
...
?>
    ...
    <a href="https://landscapearchitect.com/research/article-department.php" target="_blank">View Full List of Departments</a>
    </div>