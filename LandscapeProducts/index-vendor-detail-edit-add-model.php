				...
				<div style="width: 125%">
				 <center><h1>Add a Product for this Vendor</h1></center>
                    ...
                    <?
										...
										// banner rotating section
											...
											while($row = mysqli_fetch_array($result)) {
                                                ...
                                                $xlistNum =  $_GET['xlistNum'];
                                                $webAdd = $row['web_photo'];
                    ...
                    ?>
									...
									<form name="form_detail"  method="post" action="uploader-master/demo/index-words-add-model.php" > 
										<input type="hidden" name="id" value="<? echo $idVen; ?>" >
										<input type="hidden" name="coName" value="<? echo $coName; ?>" >
										<input type="hidden" name="prodId" value="<? echo $key22; ?>" >
										<input type="hidden" name="xlist" value="<? echo $_GET['xlistNum']; ?>" >
										<input type="hidden" name="web_photo" value="<? echo $webAdd; ?>" >
                                        
                                        
										<center><p>Enter the name for the model of this product you wish to enter.<br>
                                           <em>You can change the name later if needed</em></p>
                                        
										<p><strong>Model Name: </strong><br><input type="text" name="product_name" value="" style="width: 255px" required></p>
