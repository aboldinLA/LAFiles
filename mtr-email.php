...
$TARGET_EMAIL = array("^mtr-info@landscapeonline\.com$",
...
function LoadBuiltinLanguage()
{
    ...
    $aMessages[MSG_LOG_OK] = 'OK';
        ...
        // Parameters: none
    $aMessages[MSG_THANKS_PAGE] = '<img width ="325" src="https://landscapearchitect.com/lol-logos/MRT-logo-325.jpg">.<br />'.
							      'Thank you for your interest in the Market Trends Report.<br />'.
								  'A representative will contact you within two (2) business days. Thanks again . . .<br />'.
