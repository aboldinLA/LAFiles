...
<table width='100%' cellpadding='0' cellspacing='0'>
    <tr>
        <td colspan="2">
            <div style="text-align: left; width:763px">
                <? 
                    if($is_html == 0) { 
                        print( iconv('CP1252', 'UTF-8//TRANSLIT',(autoParagraph(cleanmeta($ed_text)))));
                        //print(preg_replace("/\n/", "<p>" , $ed_text));
                    } else {
                        print(iconv('CP1252', 'UTF-8//TRANSLIT',(cleanmeta($ed_text))));
                    }
                ?>
            </div>
        </td>
    ...
    <tr align='center'>
        <td colspan='2'>
			...
			echo "<div style=\"position:relative; left:-150px\" id=\"table0\"><table width=\"675\">";
