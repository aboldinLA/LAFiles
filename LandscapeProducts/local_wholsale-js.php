...
<div class="row">
	<div class="col-lg-9 col-lg-offset-3 col-md-8 col-md-offset-4 col-sm-12 col-xs-12">
    	<div class="full_width relative">
    		<input type="text" placeholder="Enter ZIP CODE to find local vendors" />
							...
							$zCodesB = substr($zCodesA, 3);
									...
									while($row = mysqli_fetch_array($result2)) {
										...
										echo '<div class="row align-items-center">
											<div class="col-3">
												<a href="#" class="img_fit"><img src="https://landscapearchitect.com/products/images/' . $row['logo'] . '" alt="img" /></a>
											</div><!-- .col-3 -->
											<div class="col-4">
