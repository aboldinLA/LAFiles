            	...
            	<tr>
                	<td colspan="2">
                        <div align="left">
                            ...
                            <input type="text" id="ven-req10" name="comment" style="width:450px; height:150px; display: inline-block; padding-bottom: 110px; padding-left: 10px" placeholder="Enter Text Here ..." />
                        </div><br>
                    </td>
                </tr>
            </table> </center>  
