...
<fieldset>
    ...
    <table cellspacing='5' border='0' width="750">
        ...
        <tbody>
            ...
            <tr>
                <td class='formLabel' valign='top' style="font-size:16px; font-family:Arial, Helvetica, sans-serif; font-weight:bold">
                    <vllabel errclass='errLabel' validators='websiteReq'>Contact Page</vllabel>
                               
                </td>
                <td valign='top' class='formObject'>
                    <input tabindex=2 type='text' name='contact_us' id='contact_us' size='32' maxlength='255' style="font-size:16px; background-color:#dcdcdc" value="<?= $this->getConsite(); ?>" /> * 
