						  ...
						  <div class="searchBarRow col-md-9">
							...
							<div style="display: flex;justify-content: space-between;"><!--removed class="row" -->
								...
								<div style="padding-left: 40px; margin-top: 20px;">
									...
									<span style="font-size: 24px;"><? echo $_GET['catMain'] ?></span>&nbsp;&nbsp;&nbsp;&nbsp;			
									<!-- Refine Search Start -->
					  	<select onchange="if (this.value) window.location.href=this.value" style="font-size: 20px;" id="catSelectBox">
										<option value="">Product Categories w/ Number of Companies&nbsp;</option>
							...
							<!-- Refine Search End -->	
									<div style="font-size: 28px; font-weight: bold; margin-top: 10px; margin-left: 30px;">&nbsp;</div> 
									<!-- Placeholder, on other pages it will have sub category -->
										...
										// start for the banner add counting and getting from table
											...
											$sql99 = "SELECT * FROM vendor_product WHERE (xlist='175' OR xlist='179' OR xlist='181' OR xlist='189' OR xlist='424' OR xlist='425' OR xlist='435' OR xlist='440' OR xlist='442' OR xlist='443' OR xlist='449' OR xlist='971' OR xlist='978' OR xlist='979' OR xlist='994' OR xlist='1201') AND vendor_id='" .$value. "'";	
																...
																if (($index == 1) || ($index == 4) || ($index == 7) || ($index == 10) || ($index == 13) || ($index == 16) || ($index == 19) || ($index == 22) || ($index == 25) || ($index == 28)) {
																   ...
																   echo "<div class='flex-grid-thirds'><div class='col'><a href='https://landscapearchitect.com/LandscapeProducts/index-vendor.php?number=" .$row['id']. "' target='_blank'><figure><div class='limagelad'><img class='limagelad3' src='https://landscapearchitect.com/products/images/".$row['logo']."' alt='product image'></div></a><figcaption style='margin-top:40px;'><span class='wordWrap2'>" .htmlentities($row['profile']). "</span><br><p>Matching Products: " . $rowcount99 . "<br>Total Products: " . $rowcount199 . "<br></p><hr><p class='text-center'>" . $deLogo . "<a href='https://landscapearchitect.com/LandscapeProducts/index-vendor.php?number=" .$row['id']. "' class='btn btn-success' role='button' target='_blank'>View Profile</a></p></figcaption></figure></div>";
																	
																	
																} elseif (($index == 2) || ($index == 5) || ($index == 8) || ($index == 11) || ($index == 14) || ($index == 17) || ($index == 20) || ($index == 23) || ($index == 26) || ($index == 29)) {
																	
																   echo "<div class='col'><a href='https://landscapearchitect.com/LandscapeProducts/index-vendor.php?number=" .$row['id']. "' target='_blank'><figure><div class='limagelad'><img class='limagelad3' src='https://landscapearchitect.com/products/images/".$row['logo']."' alt='product image'></div></a><figcaption style='margin-top:40px;'><span class='wordWrap2'>" .htmlentities($row['profile']). "</span><br><p>Matching Products: " . $rowcount99 . "<br>Total Products: " . $rowcount199 . "<br></p><hr><p class='text-center'>" . $deLogo . "<a href='https://landscapearchitect.com/LandscapeProducts/index-vendor.php?number=" .$row['id']. "' class='btn btn-success' role='button' target='_blank'>View Profile</a></p></figcaption></figure></div>";
										...
										// start for the banner add counting and getting from table
											...
											$sql99 = "SELECT * FROM vendor_product WHERE (xlist='175' OR xlist='179' OR xlist='181' OR xlist='189' OR xlist='424' OR xlist='425' OR xlist='435' OR xlist='440' OR xlist='442' OR xlist='443' OR xlist='449' OR xlist='971' OR xlist='978' OR xlist='979' OR xlist='994' OR xlist='1201') AND vendor_id='" .$value. "'";	
																...
																if (($index == 1) || ($index == 4) || ($index == 7) || ($index == 10) || ($index == 13) || ($index == 16) || ($index == 19) || ($index == 22) || ($index == 25) || ($index == 28)) {
																   ...
																   echo "<div class='col'><a href='https://landscapearchitect.com/LandscapeProducts/index-vendor.php?number=" .$row['id']. "' target='_blank'><figure><div class='limagelad'><img class='limagelad3' src='https://landscapearchitect.com/products/images/".$row['logo']."' alt='product image'></div></a><br><br><figcaption><span class='wordWrap2'>" .htmlentities($row['profile']). "</span><br><p>Matching Products: " . $rowcount99 . "<br>Total Products: " . $rowcount199 . "<br></p><hr><p class='text-center'>" . $deLogo . "<a href='https://landscapearchitect.com/LandscapeProducts/index-vendor.php?number=" .$row['id']. "' class='btn btn-success' role='button' target='_blank'>View Profile</a></p></figcaption></figure></div></div>";
										...
										// start for the banner add counting and getting from table
											...
											$sql99 = "SELECT * FROM vendor_product WHERE (xlist='175' OR xlist='179' OR xlist='181' OR xlist='189' OR xlist='424' OR xlist='425' OR xlist='435' OR xlist='440' OR xlist='442' OR xlist='443' OR xlist='449' OR xlist='971' OR xlist='978' OR xlist='979' OR xlist='994' OR xlist='1201') AND vendor_id='" .$value. "'";	
																...
																if (($index == 1) || ($index == 4) || ($index == 7) || ($index == 10) || ($index == 13) || ($index == 16) || ($index == 19) || ($index == 22) || ($index == 25) || ($index == 28)) {
																   ...
																   echo "<div class='flex-grid-thirds'><div class='col'><a href='https://landscapearchitect.com/LandscapeProducts/index-vendor.php?number=" .$row['id']. "' target='_blank'><figure><div class='limagelad'><img class='limagelad3' src='https://landscapearchitect.com/products/images/".$row['logo']."' alt='product image'></div></a><br><br><figcaption><span class='wordWrap'>" .htmlentities($row['profile']). "</span><br><p>Matching Products: " . $rowcount99 . "<br>Total Products: " . $rowcount199 . "<br></p><hr><p class='text-center'>" . $deLogo . "<a href='https://landscapearchitect.com/LandscapeProducts/index-vendor.php?number=" .$row['id']. "' class='btn btn-success' role='button' target='_blank'>View Profile</a></p></figcaption></figure></div>";
																	
																	
																} elseif (($index == 2) || ($index == 5) || ($index == 8) || ($index == 11) || ($index == 14) || ($index == 17) || ($index == 20) || ($index == 23) || ($index == 26) || ($index == 29)) {
																	
																   echo "<div class='col'><a href='https://landscapearchitect.com/LandscapeProducts/index-vendor.php?number=" .$row['id']. "' target='_blank'><figure><div class='limagelad'><img class='limagelad3' src='https://landscapearchitect.com/products/images/".$row['logo']."' alt='product image'></div></a><br><br><figcaption><span  class='wordWrap'>" .htmlentities($row['profile']). "</span><br><p>Matching Products: " . $rowcount99 . "<br>Total Products: " . $rowcount199 . "<br></p><hr><p class='text-center'>" . $deLogo . "<a href='https://landscapearchitect.com/LandscapeProducts/index-vendor.php?number=" .$row['id']. "' class='btn btn-success' role='button' target='_blank'>View Profile</a></p></figcaption></figure></div>";
										...
										// start for the banner add counting and getting from table
											...
											$sql99 = "SELECT * FROM vendor_product WHERE (xlist='175' OR xlist='179' OR xlist='181' OR xlist='189' OR xlist='424' OR xlist='425' OR xlist='435' OR xlist='440' OR xlist='442' OR xlist='443' OR xlist='449' OR xlist='971' OR xlist='978' OR xlist='979' OR xlist='994' OR xlist='1201') AND vendor_id='" .$value. "'";	
																...
																if (($index == 1) || ($index == 4) || ($index == 7) || ($index == 10) || ($index == 13) || ($index == 16) || ($index == 19) || ($index == 22) || ($index == 25) || ($index == 28)) {
																   ...
																   echo "<div class='flex-grid-thirds'><div class='col'><a href='https://landscapearchitect.com/LandscapeProducts/index-vendor.php?number=" .$row['id']. "' target='_blank'><figure><div class='limagelad'><img class='limagelad3' src='https://landscapearchitect.com/products/images/".$row['logo']."' alt='product image'></div></a><figcaption style='margin-top:40px;'><span class='wordWrap'>" .htmlentities($row['profile']). "</span><br><p>Matching Products: " . $rowcount99 . "<br>Total Products: " . $rowcount199 . "<br></p><hr><p class='text-center'>" . $deLogo . "<a href='https://landscapearchitect.com/LandscapeProducts/index-vendor.php?number=" .$row['id']. "' class='btn btn-success' role='button' target='_blank'>View Profile</a></p></figcaption></figure></div>";
																	
																	
																} elseif (($index == 2) || ($index == 5) || ($index == 8) || ($index == 11) || ($index == 14) || ($index == 17) || ($index == 20) || ($index == 23) || ($index == 26) || ($index == 29)) {
																	
																   echo "<div class='col'><a href='https://landscapearchitect.com/LandscapeProducts/index-vendor.php?number=" .$row['id']. "' target='_blank'><figure><div class='limagelad'><img class='limagelad3' src='https://landscapearchitect.com/products/images/".$row['logo']."' alt='product image'></div></a><figcaption style='margin-top:40px;'><span  class='wordWrap'>" .htmlentities($row['profile']). "</span><br><p>Matching Products: " . $rowcount99 . "<br>Total Products: " . $rowcount199 . "<br></p><hr><p class='text-center'>" . $deLogo . "<a href='https://landscapearchitect.com/LandscapeProducts/index-vendor.php?number=" .$row['id']. "' class='btn btn-success' role='button' target='_blank'>View Profile</a></p></figcaption></figure></div>";
