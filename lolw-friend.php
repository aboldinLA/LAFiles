...
$TARGET_EMAIL = array("^send-lolw@landscapeonline\.com$",
...
function LoadBuiltinLanguage()
{
    ...
    $aMessages[MSG_LOG_OK] = 'OK';
        ...
        // Parameters: none
    $aMessages[MSG_THANKS_PAGE] = '<img width ="325" src="https://landscapearchitect.com/lol-logos/lol-logo-weekly.jpg">.<br />'.
							      'Thank You for sending LandscapeOnline Weekly to a friend.<br />'.
								  'A copy will be sent to the email recieved within two (2) working days.<br />'.
