...
// from seminarpost start
	...
	$subject = 'Association Information Request';
		...
		<div style="position:relative; top:0px">
			<header>
				...
				<center><h2>Email Sent</h2></center>
					<center><h3>For Association Information from: <? echo $mainco5 ?></h3></center>
			</header> 
                                    
			<section>
			<!-- Main2 -->
				<center><h1 id="headh1">Association Information Request Confirmation</h1></center>
				...
				Please contact<br>
				714-979-5276 x132</h4></center><br><br> 
