...
$coem2=$_GET[mainem];
$coid2=$_GET[mainph];
$cofun2=$_GET[fname] AND $_GET[lname];
...
?>
		...
		<div style="position:relative; top:0px">
			<header>
				...
				<center><h2>Media Request Form</h2></center>
            	...
            	<tr>
                	<td>
                        <div align="left">
                            ...
                            <input type="text" name="fullname" id="ven-req01"  placeholder="Full Name" value="<? echo $cofun2 ?>" style="font-size:16px; width:200px; height:30px" />
                        </div><br>
                    </td>
            ...
            <table width="763">
            	<tr>
                	<td colspan="2">
                        <div align="left">
                              <label for="ven-req10">Type of Media (*Required Field)</label><br>
                            <input type="text" id="ven-req10" name="comment" style="width:450px; height:150px; vertical-align:top" placeholder="Enter Text Here ..." />
                        </div><br>
                    </td>
                </tr>
