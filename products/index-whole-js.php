...
function myFunction() {
    window.open("https://landscapearchitect.com/products/index-product2-js.php?localtype=manu_imp&vst=&keyword=&next=1214&ca=no&areacodes=&state=&searchby=nl&searchtype=photo");
}

function myFunction2() {
    window.open("https://landscapearchitect.com/products/index-whole-js.php?localtype=manu_imp&vst=&keyword=&next=34&ca=no&areacodes=&state=&searchby=nl&searchtype=photo");
}
</script>
<!-- Tab redirect End -->
...
<body style="background:#F6F9FC; font-family:Arial;">
    <div style="width: 763px; margin: 0 auto; padding: 120px 0 40px;">
        <ul class="tabs" data-persist="true">
            ...
            <li><a href="#view3"><button onclick="myFunction()">Product Category</button></a></li>
            <li><a href="#view4"><button onclick="myFunction2()">Local Plants & Supply</button></a></li>
        </ul>
...
<h2 style="font-family:Arial, Helvetica, sans-serif"><span style="color:#000">Product Search</span></h2>(For best results, Search with a minimum of 3 letters)
</div>
...
<div style="position:relative; top:0px">
<h2 style="font-family:Arial, Helvetica, sans-serif"><span style="color:#000">Company Search</span></h2>(For best results, Search with a minimum of 3 letters)
</div>
...
<h2 style="font-family:Arial, Helvetica, sans-serif; color:#aa7f43"><span style="color:#000">Product Category Search</span></h2>
</div>
...
<div style="position:absolute; left:6px; top:161px">
<h2 style="font-family:Arial, Helvetica, sans-serif; color:#aa7f43"><span style="color:#000">Local Plants & Supply</span></h2>
</div>
