    ...
    <fieldset>
        ...
        <table width='750' border='0' align='center' style="font-size:16px">
            <tbody>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="font-family:'Times New Roman', Times, serif; font-size:16px"> 
                                        List my area in this area code, but display the primary company<br />
                ...
                <tr>
                    <td align='left'><a href='<?= $_SERVER['PHP_SELF'] ?>?action=regional&record=<?= $this->id ?>'><img src='/imgz2/back-button.jpg' style="box-shadow: 5px 5px 5px #888888" border='0' /></a></td>
                    <td align='center'><input type='image' src="/imgz2/save-button2.jpg" style="box-shadow: 5px 5px 5px #888888" border='0' /></td>
                </tr>
               					<tr>
