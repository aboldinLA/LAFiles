...
<div>
	...
	<div style="position:relative; left: 100px; top: -150px; z-index: 0">
										...
										// banner rotating section
											...
											$result55 = $conn->query($sql55);												   
											   ...
											   while($row = mysqli_fetch_assoc($result55)) {
												   ...
												   echo "<td><div class='limage'><a href='https://landscapearchitect.com/landscapedesign/" . $string . "/" . $row["id"] . "' target='_blank'><img  class='limage2' src='https://landscapearchitect.com/products/images/".$row['logo']."'></a></div></td>";
												   $xx++;
												   $zCount++;
													$coName = $coName2;   
