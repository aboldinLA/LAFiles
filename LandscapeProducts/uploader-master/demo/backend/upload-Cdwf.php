...
// Write to vendor_product Start
		...
		$sql = "UPDATE vendor_product SET cadd_2='" . $pString2 . "' WHERE id='" . $prodNum3 . "'";
...
// Email Notification Start
    ...
    $subject = 'Details Uploaded - CAD DWF ' . $venNum3 . '';
    $message = 'Vendor Web ID: ' . $venNum3 . ' has uploaded a CAD DWF for product: ' . $prodNum3 . ' ';

    mail($email, $subject, $message);


    $email='jvictor@landscapeonline.com - CAD DWF ' . $venNum3 . '';
