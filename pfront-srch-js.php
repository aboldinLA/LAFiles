...
<?
									...
									// Category Name Start
										...
										// Check connection
											...
											$sql = "SELECT * FROM new_vendor LEFT JOIN vendor_product ON new_vendor.id=vendor_product.vendor_id WHERE (new_vendor.status='14' OR new_vendor.status='16' OR new_vendor.status='18') AND imported='0' ORDER BY RAND() LIMIT 177 OFFSET 30
";
