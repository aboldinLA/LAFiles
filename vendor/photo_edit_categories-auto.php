<?php
    ...
    require_once ('photo_edit_categories_do-auto.php');
...
function checkCount(field){
    ...
    <table width='100%' cellpadding='0' cellspacing='0' border='0'>
        ...
        <form method="POST" name="RContact" action="photo_edit_categories_do-auto.php">
        ...
        <tr>
            ...
            <tr><td><a href='photo_edit-auto.php?company_id=<?php echo $company_id ?>&pass=<? echo $pass; ?>'><img src='/imgz2/back-button.jpg' style="box-shadow: 5px 5px 5px #888888" border='0' /></a></td><td align='right'><input type="image" src="/imgz2/save-button2.jpg" style="box-shadow: 5px 5px 5px #888888" border="0" /></td></tr>
            ...
            <tr><td><a href='photo_edit-auto.php?company_id=<?php echo $company_id ?>&pass=<? echo $pass; ?>'><img src='/imgz2/back-button.jpg' style="box-shadow: 5px 5px 5px #888888" border='0' /></a></td><td align='right'><input type="image" src="/imgz2/save-button2.jpg" style="box-shadow: 5px 5px 5px #888888" border="0" /></td></tr></table>
        </form>
                        </td>
            </tr>
