...
<script type="text/javascript">
	...
	<p><font size="3"> Download Lead Report:</font> <font size="2">Report Downloads in CSV (Comma-Separated Values) Format</font><br />
 	<a href="https://landscapearchitect.com/vendor/ex-test3.php?id=<?= $this->id ?>&week=<? echo $week ?>"><font size="3"><strong>Click Here Download Lead Report</strong></font></a></p>
	<p><font size="3"> Print Lead Report:<br />
	<a href="#" onclick="printTable('table0'); return false;">Click Here to Print Lead Report</a></font></p>
    <p><font size="3"> Print Lead Report:<br />
	<a href="https://landscapearchitect.com/vendor/profile.php">Return to Vendor Profile</a></font></p>
...
ENDH;
    ...
    function companySummary() {
        ...
        ?>
        <br />
        <center><a href="https://landscapearchitect.com/subscriptions/subscribe-EXPRESS.php?action=new"><strong>Click Here</strong></a> to Sign-Up for your free subscription to<br />
Landscape Architect and Specifier News or Landscape Contractor Design • Build • Maintain</center><br />
        <table width='100%' class='searchOptions' cellpadding='0' cellspacing='0' border='0'>
            <tr class='cellhead'>
            ...
            <tr>
               ...
               <tr>
                    <td height='15' width='15%' valign='top' align='right'><strong>Company Logo</strong></td>
                    <td width='2%'>&nbsp;</td>
                    <td>
                        <?
                            if(isset($this->logo) && strlen($this->logo) > 0) {
                                ?>
                                <img src='/products/images/<?= $this->logo ?>' width='125' border='0' />
                                <?
        ...
        <table width='100%' class='searchOptions' cellpadding='0' cellspacing='0' border='0'>
            <tr class='cellhead'>
                <td colspan='3' class='cellhead'>Lead Information</td>
            		...
            		<tr>
                    	<td colspan="2" align="center">
                        	<br />To view your leads.<br />
							Choose the desired week to view the current or past lead reports.<br />
							Click the <strong>View Leads Button</strong> to view leads.<br /><br />
                        </td>
                    </tr>
                    <tr>
                        <td width='15%'>&nbsp;</td>
                        <td>
							<form method="post" action="https://landscapearchitect.com/vendor/profile.php?action=categories2&id=<?= $this->id ?>">
								<strong>Leads for the Week of: </strong>
