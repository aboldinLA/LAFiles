...
try {
    ...
    $filepath = sprintf('../../../../products/images/%s-%s-%s', $venNum3, $prodNum3, $_FILES['file']['name']);
...
// Write to vendor_product Start
		...
		$sql = "UPDATE vendor_product SET photo='" . $pString2 . "', imported='0' WHERE id='" . $prodNum3 . "'";

		if(mysqli_query($link, $sql)){
			echo "<br><center><h3>Product image is being uploaded.</h3><br></center>";
		} else{
...
// Email Notification Start
    ...
    $subject = 'Details Uploaded - Product Image ' . $venNum3 . '';
    $message = 'Vendor Web ID: ' . $venNum3 . ' has uploaded new product image for product: ' . $prodNum3 . ' ';
