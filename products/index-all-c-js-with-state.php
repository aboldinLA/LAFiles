		...
		.limage2 {
			...
			vertical-align: middle;
		  	...
		  	transform: translateY(-50%);			
				...
				<div style="position:relative; left: 50px; top:60px; z-index: 0; padding-bottom: 50px">
									...
									<?
										...
										// Logo Sort Section
											...
											$sql = "SELECT * FROM `new_vendor` WHERE (`status` = 10 OR `status` = 12 OR `status` = 14 OR `status` = 16 OR `status` = 18) AND `xlist` LIKE '%" . $key4 . "%' AND state LIKE '" . $sta . "' AND (vendor_type_id LIKE '6' || vendor_type_id LIKE '4') ORDER BY `company_name` ASC";
											...
											$result = $conn->query($sql);									
												...
												while($row = mysqli_fetch_assoc($result)) {
													...
													if ($row['state'] == $sta ) {
														...
														echo  "<tr><td><div class='limage'><a href='https://landscapearchitect.com/products/index-all-c-js.php?number=". $key4 ."&ad=34&state=CA#". $row['logo'] ."'><img class='limage2' src='https://landscapearchitect.com/products/images/". $row['logo'] ."'></a></div></td>"; 
														$xz++;
															
														} elseif ($xz < 2) {
															
														echo  "<td><div class='limage'><a href='https://landscapearchitect.com/products/index-all-c-js.php?number=". $key4 ."&ad=34&state=CA#". $row['logo'] ."'><img class='limage2' src='https://landscapearchitect.com/products/images/". $row['logo'] ."'></a></div></td>"; 
														$xz++;
															
														} else {
															
														echo  "<td><div class='limage'><a href='https://landscapearchitect.com/products/index-all-c-js.php?number=". $key4 ."&ad=34&state=CA#". $row['logo'] ."'><img class='limage2' src='https://landscapearchitect.com/products/images/". $row['logo'] ."'></a></div></td></tr>"; 
														$xz = 0;
																	...
																	if (($row['id'] = $row['outlets']) && ($sx < 1)) {
																		...
																		$result67 = $conn->query($sql67);
																			...
																			while($row = mysqli_fetch_assoc($result67)) {
																				...
																				if ($xz < 1) {
																				echo  "<tr><td><div class='limage'><a href='https://landscapearchitect.com/products/index-all-c-js.php?number=1027&ad=34&state=CA#". $row['logo'] ."'><img class='limage2' src='https://landscapearchitect.com/products/images/". $row['logo'] ."'></a></div></td>";
																				$xz++;
																				} elseif ($xz < 2) {
															
																				echo  "<td><div class='limage'><a href='https://landscapearchitect.com/products/index-all-c-js.php?number=1027&ad=34&state=CA#". $row['logo'] ."'><img class='limage2' src='https://landscapearchitect.com/products/images/". $row['logo'] ."'></a></div></td>"; 
																				$xz++;

																				} else {

																				echo  "<td><div class='limage'><a href='https://landscapearchitect.com/products/index-all-c-js.php?number=1027&ad=34&state=CA#". $row['logo'] ."'><img class='limage2' src='https://landscapearchitect.com/products/images/". $row['logo'] ."'></a></div></td></tr>"; 
																				$xz = 0;
								...
								// start for the banner add counting and getting from table
										...
										// Logo Sort Section
											...
											$sql = "SELECT * FROM `new_vendor` WHERE (`status` = 10 OR `status` = 12 OR `status` = 14 OR `status` = 16 OR `status` = 18) AND `xlist` LIKE '%" . $key4 . "%' AND state LIKE '" . $sta . "' AND (vendor_type_id LIKE '6' || vendor_type_id LIKE '4') ORDER BY `status` ASC";
												...
												while($row = mysqli_fetch_assoc($result)) {
													...
													if ($row['state'] == $sta ) {
														...
														if ($xz < 1) {
															...
															echo "<tr><td style='position:relative;top:-50px'><a id='". $row['logo'] ."'>&nbsp;</a></td></tr><tr><td><a href='https://landscapearchitect.com/products/listing-a.php?number=". $row['id'] ."' target='_blank'><img style='width: 150px' src='https://landscapearchitect.com/products/images/". $row['logo'] . "'></a></td><td style='position:relative; left: 0px; width: 450px; overflow: scroll; display: -webkit-box; -webkit-line-clamp: 5; -webkit-box-orient: vertical;'>" . $row['profile'] . "</td></tr><tr><td style='line-height: 10px'>&nbsp;</td></tr><tr><td>&nbsp;</td><td style='text-align: left; font-weight: bold'><a href='http://" . $row['contact_us'] . "' target='_blank'>Visit Website</a><span style='padding-left: 60px'><a href='http://" . $row['contact_us'] . "' target='_blank'>Contact Us</a></span><span style='padding-left: 60px'><a href='https://landscapearchitect.com/products/listing-a.php?number=". $row['id'] ."' target='_blank'>View Vendor Profile</a></span></td></tr><tr><td style='line-height: 25px'>&nbsp;</td></tr></tr><tr><td colspan='2'><hr noshade style='width: 650px'><br></td></tr>";
													...
													if ($row['state'] != $sta ) {
														...
														while($row = mysqli_fetch_assoc($result25)) {
																	...
																	if (($row['id'] = $row['outlets']) && ($sxs < 1)) {
																		...
																		echo "<tr><td><a id='". $row['logo'] ."'>&nbsp;</a></td></tr><tr><td><a href='https://landscapearchitect.com/products/listing-a.php?number=". $row['id'] ."' target='_blank'><img style='width: 150px' src='https://landscapearchitect.com/products/images/". $row['logo'] . "'></a></td><td style='position:relative; left: 0px; width: 450px; overflow: scroll; display: -webkit-box; -webkit-line-clamp: 5; -webkit-box-orient: vertical;'>" . $row['profile'] . "</td></tr><tr><td style='line-height: 10px'>&nbsp;</td></tr><tr><td>&nbsp;</td><td style='text-align: left; font-weight: bold'><a href='http://" . $row['contact_us'] . "' target='_blank'>Visit Website</a><span style='padding-left: 60px'><a href='http://" . $row['contact_us'] . "' target='_blank'>Contact Us</a></span><span style='padding-left: 60px'><a href='https://landscapearchitect.com/products/listing-a.php?number=". $row['id'] ."' target='_blank'>View Vendor Profile</a></span></td></tr><tr><td style='line-height: 25px'>&nbsp;</td></tr></tr><tr><td colspan='2'><hr noshade style='width: 650px'><br></td></tr>";
