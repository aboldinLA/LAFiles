...
$TARGET_EMAIL = array("^subscription@landscapeonline\.com$",
...
function LoadBuiltinLanguage()
{
    ...
    $aMessages[MSG_LOG_OK] = 'OK';
        ...
        // Parameters: none
    $aMessages[MSG_THANKS_PAGE] = '<img width ="325" src="https://landscapearchitect.com/lol-logos/lol-logo-325.jpg">.<br />'.
							      'Thank You. Your Subscription is being processed.<br />'.
								  'A representative will contact you.<br />'.
