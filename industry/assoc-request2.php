...
?>
		...
		<div style="position:relative; top:0px">
			<header>
				...
				<center><h2>Association Information Request</h2></center>
					<center><h3>For Association Information from: <? echo $coname2 ?></h3></center><br><br>
			</header> 
            ...
            <table width="763">
            	<tr>
                	<td colspan="2">
                        <div align="left">
                              <label for="ven-req10">Comments</label><br>
