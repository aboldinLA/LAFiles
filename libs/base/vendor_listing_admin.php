    ...
    function manageProducts($id=NULL) {
        ...
        switch($_REQUEST['intent']) {
            ...
            case 'editproduct':
                ...
                $vp->web  = $_REQUEST['web'];
                $vp->photo_time  = $_REQUEST['photo_time'];
                if(!$_REQUEST['useold']) {
            ...
            case 'addproduct':
                ...
                $vp->description  = $_REQUEST['description'];
                $vp->web  = $_REQUEST['web'];
                $vp->handleUploadedImage2($_FILES['photo_upload']);
                if($vp->errors()) {
                    $this->showView('header.php', TRUE);
                    $vp->showView('edit-web.php', FALSE, array('intent' => 'addproduct', 'record' => $this->id));
                    $this->showView('footer.php', TRUE);
                    $vp->clearErrors();
                } else {
                    $vp->commit();
    ...
    */
    ...
    function editNavigation() {
        ...
        <div class='formInfo'>
			...
			<h2 style="color:#F00"><center>Thousands of Product Searches Every Week!</center></h2>
            <center><b>As a current advertiser or exhibitor your company products are active<br>in thousands of product searches every week</b><br /><a href='javascript:open_window("https://landscapearchitect.com/products/listing.php?id=<?= $this->id ?>",1040,800);'><center><span style='font-size:28px; font-weight:bold'><b>View Your Current Profile</b></a>.</span></center><br />
...
ENDH;
 ...
 <tr>
    ...
    function categorySummary() {
        ...
        <table width='100%' class='searchOptions' cellpadding='0' cellspacing='0' border='0'>
            <tr class='cellhead'>
				<td colspan='3' class='cellhead'>Company Search Categories [ <a href='<?= $_SERVER['PHP_SELF'] ?>?action=categories&id=<?= $this->id ?>'><span style="font-size: 18px; font-weight: bold">Edit The Search Categories For Your Company</span></a> ]</td>
            </tr>
                    <tr>
                        <td width='15%'>&nbsp;</td>
                        <td>
