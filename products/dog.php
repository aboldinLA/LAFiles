...
function myFunction() {
    window.open("https://landscapearchitect.com/products/product_search_keyword.php?localtype=manu_imp&vst=&keyword=&next=1214&ca=no&areacodes=&state=&searchby=nl&searchtype=photo");
}

function myFunction2() {
    window.open("https://landscapearchitect.com/products/index-product-js3.php?localtype=manu_imp&vst=&next=1214&ca=no&searchby=nl&state=&searchtype=photo");
}
</script>
<!-- Tab redirect End -->
