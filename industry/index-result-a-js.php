...
<?
		...
		<span style='font-size:18px; font-family:Arial, Helvetica, sans-serif; font-weight:bold; color:#484848'>Profile: </span><span style='font-size:16px; font-family:Times, serif; font-weight: 400'>" . $row['profile'] . "</span><br><br>
...
<?
									...
									$linksSub = substr('' . iconv('CP1252', 'UTF-8//TRANSLIT', (stripslashes($row['subtitle']))) . '', 0, 60);
									$linkstext = substr('' . iconv('CP1252', 'UTF-8//TRANSLIT', (stripslashes($row['ed_text']))) . '', 0, 60);
                                          ...
                                          $picA =  $row['id'] . '.jpg';                                             
									        ...
									        echo '<table>';
									        echo "<tr><td><strong><a href='https://landscapearchitect.com/research/article-a.php?number=" .  $row['id'] . "' target='_blank'>" . $linksTitle . "</a></strong><br /><strong>Author:</strong>" .  $linksAuthor . "<br><span style='width: 275px'>" . $links2 . "...</span><strong><br>Issue:</strong> " .  date('m-d-y', $row['issue']) . $row['id'] . "</td></tr>";
									        echo '</table>';
