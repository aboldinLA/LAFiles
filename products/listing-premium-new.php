...
<span style="font-size:16px">Featured Vendors&nbsp;&nbsp;</span>
								...
								$('input[type="checkbox"]', $(this).parent('li')).attr('checked', status);
                                    	...
                                    	<div>
											<h3 id="numralh3">Featured Vendors for September &nbsp; &nbsp; <a href="https://landscapearchitect.com/products/listing-premium-lc-1610-new.php" target="_blank">View October Featured Vendors</a><br></h3><br />
