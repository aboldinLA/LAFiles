...
function get_products_list_html2($company_id){
    ...
    foreach($products_list as $product){
        ...
        $html .= "<td align='right'>";
        $html .= "<img width='225' src='/products/images/$product[photo]' style='box-shadow: 5px 5px 5px #888888; position: relative; left: -25px'><br><br><center><h3 style='font-family: Helvetica, Arial, sans-serif; color: darkgreen; padding-left: 125px'><a href='https://landscapearchitect.com/LADetails/index-vendor-detail-edit-js.php?number=" . $product['vendor_id'] . "&prodNum=" . $product['id'] . "' target='_blank'>Click To Edit This Product</a></h3></center>";
        $html .= "</td>";
