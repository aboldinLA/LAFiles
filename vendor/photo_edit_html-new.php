                                        ...
                                        $rowcount=mysqli_num_rows($result);
                                            ...
                                            while($row = mysqli_fetch_array($result)) {
                                                ...
                                                // Counts for sets start
                                                        ...
                                                        if ($row['product_act'] == 'yes') { $actButton = 'active-button-new.png'; } else { $actButton = 'inactive-button-new.jpg'; };
