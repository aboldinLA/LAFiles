...
//-->
	...
	<table cellpadding='0' cellspacing='0' border='0'>
		<tr> 
			...
			<br />
			<strong><a href='https://landscapearchitect.com/vendor/index-vendor-auto?action=edit&pass=<? echo $pass; ?>'><span class="tb6" style="width:100px; box-shadow: 5px 5px 5px #888888">Back to Profile</span></a> 
            </strong>
            ...
            <input type="hidden" name="action" value="true" />
            	<table border='0' width='750' cellpadding='0' cellspacing='0'>
					...
					<tr>
            			<td colspan="2" align='right'><a href='https://landscapearchitect.com/vendor/index-vendor-auto?action=edit&record=<?= $this->id ?>'><img src='/imgz2/save-button2.jpg' style="box-shadow: 5px 5px 5px #888888" border='0' /></a></td>
					</tr>
                </table>
			</form>
            </td>
