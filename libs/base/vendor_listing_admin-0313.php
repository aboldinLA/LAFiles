...
class vendor_listing_admin extends vendor {
	...
	<p><font size="3">
	<a href="#" onclick="printTable('table0'); return false;">Click Here to Print This Lead Report</a></font></p>
    <p><font size="3">
...
/*
    ...
    */
    ...
    function editNavigation() {
        ?>
        <div class='formInfo'>
        	<span style="font-size:14px; font-weight:bold"><a href='javascript:open_window("https://landscapearchitect.com/products/listing.php?id=<?= $this->id ?>",1040,800);'><center><br />View Your Actual Online Profile</center></a></span><br />
            <span style="font-size:12px"><center>Below, you can edit your company contact information, add or delete search engine categories,  list regional outlets, and advertisers can manage your product profiles, and retrieve your sales leads. </center>
			<h2 style="color:#F00"><center>Hundreds of Product Searches Every Month!</center></h2>
            <center>The average Vendor Profile is included in hundreds of product search results every month.</center><br /><br /></span>
             <span style="font-size:12px"><center>Below, you can edit your company listing information, create regional product search listings.</center></span><br /><br />
            </div>
        <div style='float: right;'>
            <a href='exit.php'><img src='/imgz/vendor/save.jpg' border='0' /></a>
        </div>
        <div class='formInfo'>
            <span style="font-size:12px"><center>When completed, you can return back to the <a href="http://www.landscapeonline.com"> LandscapeOnline.com</a> Home Page by using the save button on the right.</center></span>
                    </div>
...
ENDH;
    ...
    function companySummary() {
        ...
        ?>
        <br />
        <center><span style="font-size:12px">To request information on <br />adding product profiles or about Print, Digital or Event Advertising, <br />contact your advertising representitive:<br /><br />
        
        <strong><a href="mailto:kongstad@landscapeonline.com?subject=Information for LASN and LC/DBM&body=Please send me information about LandscapeOnline vendor profiles and other Landscape Communications, Inc. products that would be relevant for my company ">A-H: Kip Ongstad - (714) 979-5276 x 126</a><br /><br />
        <a href="mailto:vchavira@landscapeonline.com?subject=Information for LASN and LC/DBM&body=Please send me information about LandscapeOnline vendor profiles and other Landscape Communications, Inc. products that would be relevant for my company">I-P: Vince Chavira - (714) 979-5276 x 111</a><br /><br />
        <a href="mailto:mhenderson@landscapeonline.com?subject=Information for LASN and LC/DBM&body=Please send me information about LandscapeOnline vendor profiles and other Landscape Communications, Inc. products that would be relevant for my company ">Q-Z: Matt Henderson - (714) 979-5276 x 114</a></strong></span></center><br /><br />
        <table width='100%' class='searchOptions' cellpadding='0' cellspacing='0' border='0'>
            <tr class='cellhead'>
