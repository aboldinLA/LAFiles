		...
		<table>
				<tr>
					...
					<center><table cellspacing="10px" style="font-family: Helvetica, Arial, 'sans-serif'; font-size: 18px">
						<tr>
							<td colspan="2"><h2 style="font-family:Arial, Helvetica, sans-serif; color: #F60004"><center>Your Regional<br />Product Search Status is:</center></h2></td>
						</tr>
						
						<tr>
							<td style="border: 1px solid black; padding: 3px; <? if ($tier==12){ echo "background-color: chartreuse";} ?>"><center><div class='tooltip5'>Local Tier 01<span class='tooltiptext'>You are active in the LandscapeOnline Local Wholesale and Plant Material Search Engine, with your Logo at the top of all related searches in your chosen state(s), links to an expanded Vendor Profile, lists and locations of your outlets, and the logos of the major brands each outlet offers. Also includes premiere listing in the relevant vendor listings in both the Landscape Architect and Landscape Contractor magazines  (Requires Online purchase or booth space in the upcoming Landscape Expo.)</span></div></center></td>
					
							<td style="border: 1px solid black; padding: 3px; <? if ($tier==2){ echo "background-color: chartreuse";} ?>"><center><div class='tooltip5'>Local Tier 02<span class='tooltiptext'>Your location with your phone number and a link to Google maps will appear for each location in the state(s) with your outlets.</span></div></center></td>						
						</tr>
					...
					<td>
						...
						<tr>
							<td colspan="5"><h2 style="font-family:Arial, Helvetica, sans-serif; color: #F60004">Your Active States are:</h2></td>
						</tr>
						...
						<tr>
							...
							<tr>
								<td colspan="5"><div  style="position: relative;left: 0px; top: 0px; z-index: 10000"><a href="https://landscapearchitect.com/abante/index.php?rt=product/product&product_id=136" target="_blank"><h1 style="font-family:Arial, Helvetica, sans-serif; color:#1C3C04; text-decoration: underline"><center>Add A State!</center></h1><br /></a></div></td>
							</tr>
			...
			<!-- National Tiers Start -->	
				...
				<center>
					...
					<table cellspacing="10px" style="font-family: Helvetica, Arial, 'sans-serif'; font-size: 18px">
						<tr>
							<td style="border: 1px solid black; padding: 3px; <? if ($tier==18){ echo "background-color: chartreuse";} ?>"><center><div class='tooltip5'>Nat'l Tier 01<span class='tooltiptext'>Always in the Top Level Results, showing up to six (6) related products per result, features an expandable window to show more related products, complete with downloadable LADetails and BIM Files. Includes a link to an expanded Vendor Profile with more of your product lines* and links to your website and email. (Requires minimum of 8 pages of print over 12 month schedule)</span></div></center></td>
						
							<td style="border: 1px solid black; padding: 3px; <? if ($tier==16){ echo "background-color: chartreuse";} ?>"><center><div class='tooltip5'>Nat'l Tier 02<span class='tooltiptext'>Appearing in the search results immediately after Tier I, Tier II shows up to four (4) related products per result enjoys all of the other benefits of a Tier I program in months with an active print ad. (Requires Marketplace Double or minimum of 2.4 pages of print over 12 month schedule)</span></div></center></td>
						
							<td style="border: 1px solid black; padding: 3px; <? if ($tier==14){ echo "background-color: chartreuse";} ?>"><center><div class='tooltip5'>Nat'l Tier 03<span class='tooltiptext'>Located just below Tier II, showing two (2) related products per result, with all of the other benefits of a Tier I program. (Requires Marketplace Single, minimum of 1.2 pages of print or purchase of separate Vendor Profile )</span></div></center></td>
						
							<td style="border: 1px solid black; padding: 3px; <? if ($tier==12){ echo "background-color: chartreuse";} ?>"><center><div class='tooltip5'>Nat'l Tier 04<span class='tooltiptext'>Next in line, showing two (2) related products per result, with all of the other benefits of a Tier I program. (Requires Booth Space in the upcoming Landscape Expo)</span></div></center></td>
						
							<td style="border: 1px solid black; padding: 3px; <? if ($tier==10){ echo "background-color: chartreuse";} ?>"><center><div class='tooltip5'>Nat'l Tier 05<span class='tooltiptext'>Start your program with the LASN or LC/DBM Annual Directory and your product(s) will appear in related search results, with a link to an expanded Vendor Profile. (Requires Product Profile in Annual Specifier's or Buyer's Guide. Search results limited to products appearing in the most current Guide Issue.)</span></div></center></td>
						
							<td style="border: 1px solid black; padding: 3px; <? if ($tier==2){ echo "background-color: chartreuse";} ?>"><center><div class='tooltip5'>None<span class='tooltiptext'>You can have an active profile by<br>tomorrow if you contact us today!<br>Contact your sales rep below:</span></div></center></td>						
						</tr>
					</table>
...
ENDH;
    ...
    function companySummary() {
        ...
        ?>
  <div style="position:relative; left:125px; z-index: 5000">
 <table width="500" border="0" cellpadding="" cellspacing="3" style="font-size:12px" align="center">
  <tr>
    ...
    Begins With: </span></td>
    <td width="370"  align="center" valign="bottom">
    <span style="font-size: 14px; font-family:Arial, Helvetica, sans-serif; font-weight:bold">
 ...
 <tr>
    ...
    <span style="font-size: 16px">
    <center>
    <a href="mailto:mhenderson@landscapeonline.com?subject=Advertising Information Request&body=Please send me information about my LandscapeOnline vendor profile and any other Landscape Communications, Inc. products that would be relevant for my company.">Matt Henderson  - (714) 979-5276 x114</a>&nbsp;&nbsp;<a href="mailto:mhenderson@landscapeonline.com"><span style="font-family: Gotham, 'Helvetica Neue', Helvetica, Arial, 'sans-serif'; font-weight: bold">Email Matt</span></a>
    </center>
    </span>
    </td>
    </tr>
...
<div class="tb4" style="width:750px; box-shadow: 5px 5px 5px #888888">
  &nbsp;&nbsp;Company Information [ <a href='<?= $_SERVER['PHP_SELF'] ?>?action=company&id=<?= $this->id ?>'>edit</a> ]&nbsp;&nbsp
        ...
        <table width='750' class='searchOptions' cellpadding='0' cellspacing='0' border='0'>
            ...
            <tr>
                <td height='15' width='15%' valign='top' align='right'><span style="font-size:16p; font-family:Arial, Helvetica, sans-serifx; font-weight:bold">Company Info</span></td>
                <td width='2%'>&nbsp;</td>
...
<!-- Category Section -->        
<div class="tb4" style="width:750px; box-shadow: 5px 5px 5px #888888">
  &nbsp;&nbsp;Company Search Categories [ <a href='https://landscapearchitect.com/abante/index.php?rt=product/product&product_id=140' target="_blank"><span style="font-size: 18px; font-weight: bold">Add Search Categories For Your Company</span></a> ]&nbsp;&nbsp;
</div><br /><br />
		...
		<div class="tb4" style="width:750px; box-shadow: 5px 5px 5px #888888">
		  &nbsp;&nbsp;Brands &nbsp;&nbsp;
			...
			<a name="hardedit">&nbsp;</a>		
					...
					<table width="763px">
							<tr>
								<td colspan="6"><center><h2>Your Current Hardscape Brands Are: <span style="font-size: 14px; text-decoration: underline; color: blue"><a href='https://landscapearchitect.com/vendor/index-vendor-brands-hard.php?id=<?= $this->id ?>' >Edit Your Hardscape Brands</a></span></h2></center></td>
							</tr>
							<tr align="center">
								...
								<td style="border: 1px solid black; padding: 3px; <? if ($names[12] == "h0013"){ echo "background-color: chartreuse"; } ?>">Paveart</td>
							...
							<tr align="center">
								...
								<td style="border: 1px solid black; padding: 3px; <? if ($names[15] == "h0016"){ echo "background-color: chartreuse"; } ?>">Quickcrete</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[19] == "h0020"){ echo "background-color: chartreuse"; } ?>">Sureloc</td>
			...
			<a name="irriedit">&nbsp;</a>		
					...
					<table width="763px">
							<tr>
							<td colspan="5"><center><h2>Your Current Irrigation Brands Are: <span style="font-size: 14px; text-decoration: underline; color: blue"><a href='https://landscapearchitect.com/vendor/index-vendor-brands-irri.php?id=<?= $this->id ?>' >Edit Your Irrigation Brands</a></span></h2></center></td>
							</tr>
							<tr align="center">
								<td style="border: 1px solid black; padding: 3px; <? if ($names[0] == "i0001"){ echo "background-color: chartreuse"; } ?>">ANC Technology</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[4] == "i0005"){ echo "background-color: chartreuse"; } ?>">Flomec</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[8] == "i0009"){ echo "background-color: chartreuse"; } ?>">Hit Products</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[12] == "i0013"){ echo "background-color: chartreuse"; } ?>">Netafim</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[16] == "i0017"){ echo "background-color: chartreuse"; } ?>">Singnature Control Sys.</td>
							</tr>
							<tr align="center">
								<td style="border: 1px solid black; padding: 3px; <? if ($names[1] == 'i0002'){ echo "background-color: chartreuse"; } ?>">Dig Corp</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[5] == "i0006"){ echo "background-color: chartreuse"; } ?>">Griswold Controls</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[9] == "i0010"){ echo "background-color: chartreuse"; } ?>">Hydro Rain</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[13] == "i0014"){ echo "background-color: chartreuse"; } ?>">Rain Master/Irritrol</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[17] == "i0018"){ echo "background-color: chartreuse"; } ?>">Superthrive</td>
							</tr>				
							<tr align="center">
								<td style="border: 1px solid black; padding: 3px; <? if ($names[2] == "i0003"){ echo "background-color: chartreuse"; } ?>">Duraplastic</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[6] == "i0007"){ echo "background-color: chartreuse"; } ?>">Harwil</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[10] == "i0011"){ echo "background-color: chartreuse"; } ?>">Irrometer</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[14] == "i0015"){ echo "background-color: chartreuse"; } ?>">Rainbird</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[18] == "i0019"){ echo "background-color: chartreuse"; } ?>">Toro</td>
							</tr>				
							<tr align="center">
								<td style="border: 1px solid black; padding: 3px; <? if ($names[3] == "i0004"){ echo "background-color: chartreuse"; } ?>">ET Water</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[7] == "i0008"){ echo "background-color: chartreuse"; } ?>">Hendrickson</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[11] == "i0012"){ echo "background-color: chartreuse"; } ?>">K-Rain</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[15] == "i0016"){ echo "background-color: chartreuse"; } ?>">Senniger</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[19] == "i0020"){ echo "background-color: chartreuse"; } ?>">Tucor</td>
							</tr>				
			...
			<a name="lighedit">&nbsp;</a>		
					...
					<table width="763px">
							<tr>
							<td colspan="6"><center><h2>Your Current Lighting Brands Are: <span style="font-size: 14px; text-decoration: underline; color: blue"><a href='https://landscapearchitect.com/vendor/index-vendor-brands-ligh.php?id=<?= $this->id ?>' >Edit Your Lighting Brands</a></span></h2></center></td>
							</tr>
							<tr align="center">
								<td style="border: 1px solid black; padding: 3px; <? if ($names[0] == "l0001"){ echo "background-color: chartreuse"; } ?>">American Illumination</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[4] == "l0005"){ echo "background-color: chartreuse"; } ?>">Best Pro Lighting</td>
								...
								<td style="border: 1px solid black; padding: 3px; <? if ($names[16] == "l0017"){ echo "background-color: chartreuse"; } ?>">Sterling Lighting</td>
							</tr>
							<tr align="center">
								...
								<td style="border: 1px solid black; padding: 3px; <? if ($names[17] == "l0018"){ echo "background-color: chartreuse"; } ?>">Tekka Illumination</td>
							</tr>				
							<tr align="center">
								...
								<td style="border: 1px solid black; padding: 3px; <? if ($names[14] == "l0015"){ echo "background-color: chartreuse"; } ?>">Nitetime Decor</td>
							...
							<tr align="center">
								...
								<td style="border: 1px solid black; padding: 3px; <? if ($names[19] == "l0020"){ echo "background-color: chartreuse"; } ?>">Volt</td>
							</tr>				
			...
			<a name="chemedit">&nbsp;</a>		
					...
					<table width="763px">
							<tr>
							<td colspan="6"><center><h2>Your T &amp; O Chemicals &amp; Admendments Brands Are: <span style="font-size: 14px; text-decoration: underline; color: blue"><a href='https://landscapearchitect.com/vendor/index-vendor-brands-chem.php?id=<?= $this->id ?>' >Edit Your T &amp; O Brands</a></span></h2></center></td>
							</tr>
							<tr align="center">
								<td style="border: 1px solid black; padding: 3px; <? if ($names[0] == "c0001"){ echo "background-color: chartreuse"; } ?>">Agriserve</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[4] == "c0005"){ echo "background-color: chartreuse"; } ?>">GroPower</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[8] == "c0009"){ echo "background-color: chartreuse"; } ?>">Mauget</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[12] == "c0013"){ echo "background-color: chartreuse"; } ?>">SoilMoist</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[16] == "c0017"){ echo "background-color: chartreuse"; } ?>">TRI-C Organics</td>
							</tr>
							<tr align="center">
								...
								<td style="border: 1px solid black; padding: 3px; <? if ($names[9] == "c0010"){ echo "background-color: chartreuse"; } ?>">Recycled Wood Products</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[13] == "c0014"){ echo "background-color: chartreuse"; } ?>">SoilTech</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[17] == "c0018"){ echo "background-color: chartreuse"; } ?>">Twister</td>
							</tr>				
							<tr align="center">
								...
								<td style="border: 1px solid black; padding: 3px; <? if ($names[10] == "c0011"){ echo "background-color: chartreuse"; } ?>">Rootwell</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[14] == "c0015"){ echo "background-color: chartreuse"; } ?>">Superthrive</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[18] == "c0019"){ echo "background-color: chartreuse"; } ?>">Villa Root Barriers</td>
							</tr>				
							<tr align="center">
								<td style="border: 1px solid black; padding: 3px; <? if ($names[3] == "c0004"){ echo "background-color: chartreuse"; } ?>">GopherX</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[7] == "c0008"){ echo "background-color: chartreuse"; } ?>">LiveEarth</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[11] == "c0012"){ echo "background-color: chartreuse"; } ?>">Roundup</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[15] == "c0016"){ echo "background-color: chartreuse"; } ?>">Tree Staple</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[19] == "c0020"){ echo "background-color: chartreuse"; } ?>">Water Saving Granules</td>
							</tr>				
			...
			<a name="tooledit">&nbsp;</a>		
					...
					<table width="763px">
							<tr>
							<td colspan="6"><center><h2>Your Current Tools &amp; Equipment Brands Are: <span style="font-size: 14px; text-decoration: underline; color: blue"><a href='https://landscapearchitect.com/vendor/index-vendor-brands-tool.php?id=<?= $this->id ?>' >Edit Your Tools &amp; Equipment Brands</a></span></h2></center></td>
							</tr>
							<tr align="center">
		...
		<div class="tb4" style="width:750px; box-shadow: 5px 5px 5px #888888">
		  &nbsp;&nbsp;Plants/Trees&nbsp;&nbsp;
			...
			<a name="planedit">&nbsp;</a>		
					...
					<table width="763px">
							<tr>
							<td colspan="6"><center><h2>The Current Plants You Supply Are: <span style="font-size: 14px; text-decoration: underline; color: blue"><a href='https://landscapearchitect.com/vendor/index-vendor-brands-plan.php?id=<?= $this->id ?>' >Edit The Plants You Supply</a></span></h2></center></td>
							</tr>
							<tr align="center">
			...
			<a name="turfedit">&nbsp;</a>		
					...
					<table width="763px">
							<tr>
							<td colspan="6"><center><h2>The Current Turf Types You Supply Are: <span style="font-size: 14px; text-decoration: underline; color: blue"><a href='https://landscapearchitect.com/vendor/index-vendor-brands-turf.php?id=<?= $this->id ?>' >Edit The Turf You Supply</a></span></h2></center></td>
							</tr>
							<tr align="center">
								<td style="border: 1px solid black; padding: 3px; <? if ($names[0] == "t0001"){ echo "background-color: chartreuse"; } ?>">Bahia</td>
								<td style="border: 1px solid black; padding: 3px; <? if ($names[4] == "t0005"){ echo "background-color: chartreuse"; } ?>">Cenipede</td>
...
<div class="tb4" style="width:750px; box-shadow: 5px 5px 5px #888888">
  <a id="leads1">&nbsp;&nbsp;Sales Lead Retrieval&nbsp;&nbsp;</a>
</div><br /><br />        
        <table width='750' class='searchOptions' cellpadding='0' cellspacing='0' border='0'>
                    <tr>
...
<script>
 function validateForm() {
    ...
    <input type = "text" name = "large" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; width:100px; height:30px; background-color:#CCC; box-shadow: 5px 5px 5px #888888; text-align:center; position: relative; z-index: 5000"></td>
    </tr>
    <tr>
        <td style="height:10px"> </td>
    <tr>
...
<!-- Test popup2 end -->
    ...
    function photoSummary(){
        include '/home/land/public_html/vendor/photo_edit_html-js.php';
    }
