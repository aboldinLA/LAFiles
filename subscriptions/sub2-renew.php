...
?>
    ...
    <div style="box-shadow: 0 2px 30px 0 rgba(0, 0, 0, 0.28)">
    <img src="http://landscapearchitect.com/images/basic/logo.jpg" width="100%" style="max-width: 1200px; display: block; margin: 0 auto; padding-bottom: 20px; padding-top: 10px; padding-left: 25px; padding-right: 25px;">
    </div>
									...
									$rcount = 0;
									 ...
									 while ($row = mysqli_fetch_assoc($result)) {
											...
											if ($rcount == 0) {	
												 ...
												 echo '<div class="row"><div class="col-sm-3">
														<input type="checkbox" name="sites_id[]" class="webCheckbox" value="' . $row['name'] . '" id="sites_id" ' . $t . '>
									 ...
									 while ($row = mysqli_fetch_assoc($result)) {
										 	 ...
										 	 $dresult = substr($row['name'], 0, 3);
										 	  ...
										 	  if ($dresult == '---') {
												 ...
												 $newLine = '<input type="checkbox" name="does[]" class="webCheckbox" value="' . $newName . '" id="does" ' . $t . '>';
									...
									$rcount = 0;
									 ...
									 while ($row = mysqli_fetch_assoc($result)) {
											...
											if ($rcount == 0) {
												 ...
												 echo '<div class="row"><div class="col-sm-3">
														<input type="checkbox" name="assoc[]" class="webCheckbox" value="' . $row['name'] . '" id="assoc" ' . $t . '>
