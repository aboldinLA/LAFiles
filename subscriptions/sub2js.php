...
<input type="hidden" value="<?echo $protype?>" name="protype">
	...
	<div style="position:absolute; left:125px; top:95px; padding:0px; width:475px">
            <img src="https://landscapearchitect.com/subscriptions/images/sub2-back.jpg">
    </div>

<div style="position:absolute; left:150px; top:240px; padding:0px; width:500px; height:30px">
...
belong to)</small>:<br>
	...
	<TR>
		<TD colspan="2" align="center">Page 2 of 4 <INPUT  TYPE="SUBMIT"  VALUE="Continue"></TD> 
	</tr>
</TABLE>
</div>
	</form>
