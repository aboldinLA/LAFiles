...
// Write to vendor_product Start
		...
		$sql = "UPDATE vendor_product SET mediap='" . $pString2 . "' WHERE id='" . $prodNum3 . "'";
...
// Email Notification Start
    ...
    $subject = 'Details Uploaded - Media PDF ' . $venNum3 . '';
    $message = 'Vendor Web ID: ' . $venNum3 . ' has uploaded a Media PDF for product: ' . $prodNum3 . ' ';
