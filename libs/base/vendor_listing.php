            ...
            ?>
				<? $nextx = $_GET[next]; ?>
					...
					<? if ($nextx == '1139') { ?>
						 ...
						 <table><tr><td colspan="3"><a href="https://landscapearchitect.com/products/index-product.php?localtype=manu_imp&vst=&next=1213&ca=no&searchby=nl&state=&searchtype=photo">* Also See Mater Management</a></td></tr></table>
