    ...
    function editCompany($id=NULL) {
        ...
        switch($_REQUEST['intent']) {
            case 'edit':
                ...
                &nbsp;&nbsp;<a href="https://landscapearchitect.com/vendor/index-vendor.php?action=edit" onClick="window.location.reload();return false;">Return to Profile</a>
...
<div class="tb4" style="width:725px; box-shadow: 5px 5px 5px #888888">
  &nbsp;&nbsp;Company Information [ <a href='<?= $_SERVER['PHP_SELF'] ?>?action=company&id=<?= $this->id ?>'><span style="color: #FFFFFF">edit</span></a> ]&nbsp;&nbsp
</div><br /><br />
...
<div class="tb4" style="width:725px; box-shadow: 5px 5px 5px #888888">
  &nbsp;&nbsp;Company Search Categories<? if (($coDog == '4') || ($coDog == '6')) { ?> [ <a href='https://landscapearchitect.com/abante/index.php?rt=product/product&product_id=140' target="_blank"><span style="font-size: 18px; font-weight: bold; color: #FFFFFF">Add Search Categories For Your Company</span></a> ]<? } else {  ?>&nbsp;&nbsp;[ <a href='<?= $_SERVER['PHP_SELF'] ?>?action=categories&id=<?= $this->id ?>'><span style="font-size: 18px; font-weight: bold; color: #FFFFFF">Edit The Search Categories For Your Company</span></a> ]<? } ?>
	...
	<div style="text-align: center">
		<div style="position: relative; left: -25px"><img src="https://landscapearchitect.com/lol-logos/LA-LC-search-engines.jpg" width="50%"><img src="https://landscapearchitect.com/lol-logos/sidebar-search-engine/national-products-sidebar-logo.jpg" width="25%"><img src="https://landscapearchitect.com/lol-logos/sidebar-search-engine/local-wholesale-sidebar-logo.jpg" width="25%"></div><br><br>
		These categories are used by the Keyword Search Engine to help our 65,000+ monthly users to find you company.<br>
		  ...
		  &nbsp;&nbsp;Brands &nbsp;&nbsp;
			...
			<a name="irriedit">&nbsp;</a>		
					...
					<table width="763px">
							...
							<tr align="center">
								<td style="border: 1px solid black; padding: 3px; <? if ($names[20] == "i0021"){ echo "background-color: chartreuse"; } ?>">ADS</td>
								...
								<td style="border: 1px solid black; padding: 3px; <? if ($names[17] == "i0018"){ echo "background-color: chartreuse"; } ?>">Toro</td>
							</tr>
							<tr align="center">
								...
								<td style="border: 1px solid black; padding: 3px; <? if ($names[18] == "i0019"){ echo "background-color: chartreuse"; } ?>">Tucor</td>
							</tr>				
							<tr align="center">
							...
							<tr align="center">
								...
								<td style="border: 1px solid black; padding: 3px; <? if ($names[21] == "i0022"){ echo "background-color: chartreuse"; } ?>">NDS</td>
        ...
        <table width='750' class='searchOptions' cellpadding='0' cellspacing='0' border='0'>
                    ...
                    <tr>
                        ...
                        <span style="font-size:16px">All advertisers receive sales leads updated every Friday by 5:00 PM.<br />
                            To view your leads, by date, select the date range below and click on "<strong>Retrieve Leads for Selected Week</strong></span>"<br /><br />
...
<script>
 function validateForm() {
                        ...
                        <td colspan="2" align="center">
							...
							<form name="leadsform" method="POST" action="index-vendor-leads.php?action=categories2&id=<?= $this->id ?>&week2=week">
							  ...
							  <input type="submit"  value="Retrieve Leads for Selected Week" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; background-color:#7eff3b; width:250px; height:30px; box-shadow: 5px 5px 5px #888888"><br><br>
                                    ...
                                    <select multiple name="week" size="4" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; width:250px; height:75px; background-color:#CCC; box-shadow: 5px 5px 5px #888888; border: 2px inset; margin-left:auto; text-align: center">
                                        <? echo $dlist ?>
                                    </select><br /><br /><br />
							</form>
    ...
    <tr>
    <td align = "center">
    <input type = "submit" name = "find" value = "View Custom Leads" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; background-color:#7eff3b; width:150px; height:30px; box-shadow: 5px 5px 5px #888888; position: relative; left: 15px">
    &nbsp;&nbsp;&nbsp;
    <input type = "reset" value = "Reset Choice" style="font-family:Arial, Helvetica, sans-serif; font-size:14px; font-weight:bold; background-color:#7eff3b; width:130px; height:30px; box-shadow: 5px 5px 5px #888888; position: relative; left: 15px">
    </td>   
    </tr>
    </table>
    </form> 
...
<!-- Test popup2 end -->
    ...
    function photoSummary(){
        include '/home/land/public_html/vendor/photo_edit_html-js2.php';
    }
