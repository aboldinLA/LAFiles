...
<div>
	<table width="1024">
		...
		<?
		include("lo_top-main2-side2-sub-wholesale.inc");
		?>	       
	...
	<div style="position:relative; left: 0px; top: 0px; z-index: 0">
		   ...
		   <center><h3 style="font-family: Helvetica, Arial,' sans-serif'; font-size: 18px">Category: <? echo $catName1 ?> - <? echo $catName2 ?></h3></center><br>
	</div>					
				...
				<div style="position:absolute; left: 300px; top:275px; z-index: 0">
									...
									<?
										...
										// start for the banner add counting and getting from table
											...
											$sql = "SELECT * FROM new_vendor LEFT JOIN vendor_product ON new_vendor.id=vendor_product.vendor_id WHERE vendor_product.xlist='". $key4 ."' AND (new_vendor.status='2' OR new_vendor.status='12' OR new_vendor.status='14' OR new_vendor.status='16' OR new_vendor.status='18') ORDER BY new_vendor.company_name ASC";
								...
								<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion<? echo $morProd; ?>" href="#collapseOne<? echo $morProd; ?>"><span style="text-align: left; font-size: 12px"><strong>View All  <? echo $catName2 ?> From This Vendor</strong></span></a><a data-toggle="collapse" data-parent="#accordion<? echo $morProd; ?>" href="#collapseTwo1<? echo $morProd; ?>"><span style="padding-left: 250px; font-size: 12px">Close Window</span></a></h4>
										...
										// start produt row count from table
											...
											$sql25 = "SELECT * FROM new_vendor LEFT JOIN vendor_product ON new_vendor.id=vendor_product.vendor_id WHERE vendor_product.xlist='". $key4 ."' AND new_vendor.status='2' ORDER BY vendor_product.vendor_id DESC";
											$result25 = $conn->query($sql25);
                   ...
                   echo '<center><h3 style="font-family: Helvetica, Arial; font-size: ; font-weight:400">Additional Suppliers</h3></center>';
										...
										// start for the banner add counting and getting from table
											...
											$sql2333 = "SELECT * FROM new_vendor WHERE xlist LIKE '%" . $key4 . "%' AND (new_vendor.status='2' OR new_vendor.status='12' OR new_vendor.status='14' OR new_vendor.status='16' OR new_vendor.status='18') ORDER BY company_name ASC";
