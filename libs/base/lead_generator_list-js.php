<?php
    ...
    require_once('base/lead_generator-js.php');
...
/*}}}*/
        ...
        function assignEditor($email) {
            ...
            $editors = array(
                'bfordyce@landscapeonline.com' => array(
                    'firstName' => 'Bruce',
                    'lastName'  => 'Fordyce',
                    'email'     => 'bfordyce@landscapeonline.com',
                    'phoneAC'   => 714,
                    'phone'     => '979-5276 x124',
                    'faxAC'     => 714,
                    'fax'       => '434-3862'
                ...
                'kcavaness@landscapeonline.com' => array(
                    'firstName' => 'Kyle',
                    'lastName'  => 'Cavaness',
                    'email'     => 'kcavaness@landscapeonline.com',
                    'phoneAC'   => 714,
                    'phone'     => '979-5276 x116',
                    'faxAC'     => 714,
                    'fax'       => '979-3543'
