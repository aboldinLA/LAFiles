...
<div>
	<table width="1024">
		...
		<?
		include("lo_top-main2-side-sub.inc");
		?>	       
...
<div style="position:absolute; left: 425px; top:195px; z-index: 0; padding-bottom: 50px">
	...
	<center><h3 style="font-family: Helvetica, Arial,' sans-serif'; font-size: 18px">Category: <? echo $catName1 ?> - <? echo $catName2 ?> <br>Featured Advertisers <span style="font-size: 12px">(Click on Advertiser Logo to Jump to Products)</span></h3></center>
	</div>
				...
				<div style="position:relative; left: 55px; top:100px; z-index: 0; padding-bottom: 50px">
									...
									<?
										...
										// start for the banner add counting and getting from table
											...
											$sql = "SELECT * FROM new_vendor LEFT JOIN vendor_product ON new_vendor.id=vendor_product.vendor_id WHERE vendor_product.xlist='". $key4 ."' AND (new_vendor.status='12' OR new_vendor.status='14' OR new_vendor.status='16' OR new_vendor.status='18') ORDER BY new_vendor.company_name ASC";
											$result = $conn->query($sql);									
									
										// banner rotating section
												
											   echo "<table style='padding-bottom: 50px'><tr>";
											   $xx = 0;
												$zCount = 0;
											   while($row = mysqli_fetch_assoc($result)) {
												   ...
												   echo "<td><a href='#".$row['logo']."'><img style='width: 80%' src='https://landscapearchitect.com/products/images/".$row['logo']."'></a></td>";
												   $xx++;
												   $zCount++;
												...
												if ($zCount == 0){
												echo "<div style='width:750px; height:2px; background-color:#605b51; position:relative; left: 55px; top: -400px'> </div>";
												}else{
												echo "<div style='width:750px; height:2px; background-color:#605b51; position:relative; left: 55px; top: 0px; padding-top 35px'> </div>";
												}				
                   ...
                   echo '<center><h3 style="font-family: Helvetica, Arial; font-size: ; font-weight:400">Additional Suppliers</h3></center>';
										...
										// start for the banner add counting and getting from table
											...
											$sql2333 = "SELECT * FROM new_vendor WHERE xlist LIKE '%" . $key4 . "%' AND (new_vendor.status='12' OR new_vendor.status='14' OR new_vendor.status='16' OR new_vendor.status='18') ORDER BY company_name ASC";
										...
										// banner rotating section
											...
											while($row = mysqli_fetch_array($result2333)) {
																if ($xxx == 0 && $zzz < 50) {														
																	echo "<td align='left'><div><a href='https://landscapearchitect.com/products/listing-a.php?number=" . $row['id'] . "' target='_blank'><img style='max-height: 169px; max-width: 250px; overflow-x: hidden; overflow-y: hidden' src='https://landscapearchitect.com/products/images/" . $row['logo'] . "'></a><br><table><tr><td style='line-height: 5px'>&nbsp;</td></tr></table></div></td><td style='width: 5px'>&nbsp;</td>";																	
																	$xxx++;
																} elseif ($xxx < 3 && $zzz < 50){
																	echo "<td align='left'><div><a href='https://landscapearchitect.com/products/listing-a.php?number=" . $row['id'] . "' target='_blank'><img style='max-height: 169px; max-width: 250px; overflow-x: hidden; overflow-y: hidden' src='https://landscapearchitect.com/products/images/" . $row['logo'] . "'></a><br><table><tr><td style='line-height: 5px'>&nbsp;</td></tr></table></div></td><td style='width: 5px'>&nbsp;</td>";																	
																	$zzz++;
																	...
																	echo "</tr><tr><td style='line-height: 10px'>&nbsp;</td></tr><tr><td align='left'><div><a href='https://landscapearchitect.com/products/listing-a.php?number=" . $row['id'] . "' target='_blank'><img style='max-height: 169px; max-width: 250px; overflow-x: hidden; overflow-y: hidden' src='https://landscapearchitect.com/products/images/" . $row['logo'] . "'></a><br><table><tr><td style='line-height: 5px'>&nbsp;</td></tr></table></div></td><td style='width: 5px'>&nbsp;</td>";
																	$zzz++;
																	$xxx = 1;																	
