        ...
        <tbody>
            ...
            <tr>
                ...
                <td valign='top' class='formObject' style="font-size:16px">
                    <input tabindex=1 type='text' name='company_name' id='company_name' size='58' value="<?= $this->getCompanyName(); ?>" maxlength='255' style="font-size:16px; background-color:#f1f1f1" /> 
                    <div class='formInfo' style="font-size:16px; font-style:italic; font-family:Arial, Helvetica, sans-serif;">As you want it to appear.</div><br />
                    <vlvalidator 
                        name='CompanyNameReq' 
                        type='required' 
                        minlength='3' 
            ...
            <tr>
            	<td> </td>
            	<td width="500"><div class='formInfo' style="font-size:16px; font-style:italic">To change from a Manufacturer to a Wholesale Facility or Grower, Click Here, or call your advertising sales representive.</div>
                </td>
            </tr>
            ...
            <tr>
                ...
                <td valign='top' class='formObject'>
                    <input tabindex=2 type='text' name='website' id='website' size='58' maxlength='255' style="font-size:16px; background-color:#b8e0bd" value="<?= $this->getWebsite(); ?>" /> 
            ...
            <tr>
                <td class='formLabel' valign='top' style="font-size:16px; font-family:Arial, Helvetica, sans-serif; font-weight:bold">
                    <vllabel errclass='errLabel' validators='websiteReq'>Contact Page<span style="color: red;"><sup> *</sup></span></vllabel>
                               
                </td>
                <td valign='top' class='formObject'>
                    <input tabindex=2 type='text' name='contact_us' id='contact_us' size='58' maxlength='255' style="font-size:16px; background-color:#b8e0bd" value="<?= $this->getConsite(); ?>" /> 
                    <div class='formInfo' style="font-size:16px; font-style:italic">The contact page entered here will be used in hotlinks (if you sign up for one) and will appear in your company listing page.</div>
                </td>
            </tr>
            <tr><td style="height:10px"></td></tr>			
            ...
            <tr>
                ...
                <td valign='top' class='formObject'>
                    <input tabindex=3 type='text' name='email' id='email' size='58' maxlength='255' style="font-size:16px; background-color:#b8e0bd" value="<?= $this->getCompanyEmail(); ?>" /> 
            ...
            <tr>
                ...
                <td valign='top' class='formObject'>
                    <input tabindex=6 type='text' name='phone' id='phone' size='58' style="font-size:16px; background-color:#b8e0bd" value="<?= $this->getCompanyPhone(); ?>" />
                     <vlvalidator 
                        name='PhoneReq'
                        type='required' 
                        control='phone'
            ...
            <tr>
                ...
                <td valign='top' class='formObject'>
                    <input tabindex=8 type='text' name='fax_phone' id='fax_phone' size='58' style="font-size:16px; background-color:#b8e0bd" value="<?= $this->getCompanyFax(); ?>" />
                </td>
            </tr>
            <tr><td style="height:10px"></td></tr>
            <tr>
                ...
                <td valign='top' class='formObject'>
                    <input tabindex=9 name='address1' id='address1' type='text' size='58' style="font-size:16px; background-color:#b8e0bd" value="<?= $this->getCompanyAddress();  ?>" /> <br />
                    <vlvalidator
                        name='Address1Req'
                        type='required'
                        control='address1'
            ...
            <tr>
                ...
                <td valign='top' class='formObject'>
                    <input tabindex=11 name='city' id='city' type='text' size='58' style="font-size:16px; background-color:#b8e0bd" value="<?= $this->getCompanyCity(); ?>" />
                    <vlvalidator
                        name='CityReq'
                        type='required'
                        control='city'
            ...
            <tr>
                ...
                <td valign='top' class='formObject'>
                    <span style="font-size:16px; background-color:#b8e0bd"><?= $this->stateSelectionWidget($this->getCompanyState()); ?> &nbsp;</span>
                    <input tabindex=12 name='postal' id='postal' type='text' size='16' style="font-size:16px; background-color:#b8e0bd" value="<?= $this->getCompanyPostalCode(); ?>" />
                    <vlvalidator
                        name='StateReq'
                        type='required'
                        control='state'
            ...
            <tr>
                ...
                <td valign='top' class='formObject'>
                    <textarea tabindex=13 cols='57' rows='10' id='profile' name='profile' style="font-size:16px; background-color:#b8e0bd"><?= $this->getProfile(); ?></textarea><div class='formInfo' style="font-size:16px; font-style:italic">Your vendor profile should be less than 200 words.</div>
                    <vlvalidator
                        name='ProfileReq'
                        type='required'
                        control='profile'
