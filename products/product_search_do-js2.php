...
function company_results_html($results){
    $html .="<div id='pageBody'>
			<div style='position:absolute; left:25px; top:350px'>
...
function photo_results_html($results){
    $html .="<div id='pageBody'>
			<div style='position:absolute; left:5px; top:350px'>
...
<p>&nbsp;</p>
<div style="position:absolute; left:5px; top:275px; padding:0px; width:665px; font-size:14px; color:#000">
<br />
