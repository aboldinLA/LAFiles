						...
						<td>
							...
							?>							
									...
									<div id="divCheckboxList" style="position: relative; left: 50px">
										...
										<table>
											<tr>
												<td><div><input type="checkbox" name="opt_inlc001" id="lcdbm1" <? if ($opt_inlc[0] == "LC-MS") echo "checked"; ?> value="LC-MS" />&nbsp;LC-TLE Magazine Subscription</div></td><td style="width: 10px">&nbsp;</td><td><div><input type="checkbox" name="opt_inlc002" id="lcdbm2" <? if ($opt_inlc[1] == "LC-CE") echo "checked";?> value="LC-CE" />&nbsp;LC-TLE Calls for Editorial</div></td>
											</tr>
											
											<tr><td style="line-height: 10px">&nbsp;</td></tr>
											
											<tr>
												<td><div><input type="checkbox" name="opt_inlc003" id="lcdbm3" <? if ($opt_inlc[2] == "LC-DM") echo "checked";?> value="LC-DM" />&nbsp;LC-TLE Digital Magazine</div></td><td style="width: 10px">&nbsp;</td><td><div><input type="checkbox" name="opt_inlc004" id="lcdbm4" <? if ($opt_inlc[3] == "LC-ASP") echo "checked";?> value="LC-ASP" />&nbsp;LC-TLE Advertising Sales Promos</div></td>
											</tr>
