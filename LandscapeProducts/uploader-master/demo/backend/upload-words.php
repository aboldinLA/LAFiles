...
// Write to vendor_product Start
		...
		$sql = "UPDATE vendor_product SET description='dog' WHERE id='" . $prodNum3 . "'";
...
// Email Notification Start
    ...
    $message = 'Vendor Web ID: ' . $venNum3 . ' has uploaded a text PDF for product: ' . $prodNum3 . ' ';
    ...
    $subject = 'Details Uploaded';
    $message = 'Vendor Web ID: ' . $venNum3 . ' has uploaded a text for product: ' . $prodNum3 . ' ';
