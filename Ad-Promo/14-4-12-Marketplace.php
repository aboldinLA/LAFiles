...
<div style="max-width: 800px; margin: 0 auto; font-size: 18px; margin-bottom: 80px; font-family: Helvetica, Arial, sans-serif;">
	...
	<? } else { ?>
		<form action="<? echo $pageName ?>.php?success=true#success" method="post" onSubmit="return validate();" id="form">
			...
			<div style="width: 48%; float: right; clear; right; margin-top: 20px; margin-bottom: 20px;">
				<label for="phone">Phone Number: </label><br>
				<input type="text" name="phone" placeholder="Phone Number"  />
			</div>

			
			<div id="itemSelection" style="clear: both;">
				<div style="width: 49%; float: left; text-align: center;">
					<input type="radio" id="item1" name="itemSelection" placeholder="Phone Number" value="Single: $3,755"/><br>
					<label for="item1">Single: $3,755 </label>
				</div>
				<div style="width: 49%; float: left; clear: right; text-align: center;">
					<input type="radio" id="item2" name="itemSelection" placeholder="Phone Number" value="Double: $6,455" /><br>
					<label for="item2">Double: $6,455 </label>
				</div>
		...
		<div style="width: 600px; margin: 0 auto; margin-top: 60px;">
			<h2 style="text-align: center; font-size: 30px; margin-top: 30px; margin-bottom: 20px;">Contact Your Advertising Representative</h2>
