...
<html lang="en">
  ...
  <body>
    ...
    ?>
      ...
      <p class="lead mb-4">
       Existing product image.<br>
       To change this image, drag your new image to the window below and click on the Submit Button.<br>
       The maximum file size is 3 MB and a Max image width of 1600 pixels, Max image height 1300 pixels.
      </p>
...
<script>
    ...
    <script src="demo-config2-js.js"></script>
