...
<script>
                                        ...
                                        function myButtonFunction8() {
                                            ...
                                            window.open("https://landscapearchitect.com/subscriptions/subscribe-sac-2016-js2-mult.php?action=new&address5="+addr+"&comp_nam5="+cona+"&city5="+city+"&state5="+state+"&zip5="+zip+"&phone5="+phone+"&fax5="+fax, "_blank", "toolbar=no,scrollbars=no,resizable=yes,top=300,left=500,width=1100,height=900");
                                           }
										...
										function Jump()
										{
											...
											window.location.href = "https://landscapearchitect.com/subscriptions/subscribe-sac-2016-js2-mult.php?action=new&address5="+addr+"&comp_nam5="+cona+"&city5="+city+"&state5="+state+"&zip5="+zip+"&phone5="+phone+"&fax5="+fax;
										}										   
