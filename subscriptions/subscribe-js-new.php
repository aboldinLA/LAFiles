...
<div>
	...
	<div style="position: relative; left: 575px; top: 75px; z-index: 2000">
		
		<button id="myBtn" style="font-size: 16px; padding: 5px; font-weight: bold; background-color: darkgoldenrod; box-shadow: 2px 2px #888888" onClick="window.location.href='https://landscapearchitect.com/subscriptions/sub3.php?action=edit&media_id=<? echo $_SESSION['uid']; ?>'" />Information Correct?<br>
...
<? if ($action == "edit" || $action == "renew") { ?>
	...
	<? } ?>
 <div style="position:absolute; left: 280px; top:435px">   
...
<!-- Horizontal Bar End -->
 ...
 <div style="position:absolute; left: 280px; top:120px">   
