...
class research_class extends template_class {
    ...
    function getSearchOptions($vars = NULL) {
        ...
        $whereString = " WHERE " . implode(' AND ',$queryItems);
    ...
    function printSearchRow($rowVal, $class, $prime) {
        extract($rowVal);
        $cite = $this->highlightCitations($this->findCitation($rowVal['ed_text'], $prime), $prime);
        ...
        print("<a href='/research/article.php/$id' class='srch_t'>" . $this->strShorten(ucwords(htmlfriendly($title)), 120) . "</a><br />");
        print("&nbsp; &nbsp; &nbsp; $cite <br />");
