...
function photo_results_html($results){
    ...
    foreach($results as $r){
      ...
      continue;
        ...
        if($r['status'] >= 2) $html .= "<a href='listing.php?id=$r[vendor_id]' target='_blank'>";
        $html .= "<img src='images/$r[photo]' border='0'width='233px'></div><span style='color:#906'>$r[company_name]</span><br />" . iconv('CP1252', 'ASCII//TRANSLIT', (($r[product_name]))) . "<br />";
    
        if($r['status'] >= 2) $html .= "</a>";
