				...
				<center>
					...
					<table cellspacing="10px" style="font-family: Helvetica, Arial, 'sans-serif'; font-size: 18px">
						<tr>
							...
							<td style="border: 1px solid black; padding: 3px; <? if ($tier==10){ echo "background-color: chartreuse";} ?>"><center><div class='tooltip5'>Bronze<span class='tooltiptext'>Start your program with the LASN or LC/DBM Annual Directory and you can host up to 10 products, complete with pictures, descriptions and any related Cad Files or Spec Sheets.  (Requires Product Profile in Annual Specifier's or Buyer's Guide.) </span></div></center></td>
						
							<td style="border: 1px solid black; padding: 3px; <? if ($tier==12){ echo "background-color: chartreuse";} ?>"><center><div class='tooltip5'>Exhibitor<span class='tooltiptext'>Next in line, Trade Show Advertisers can upload up to 10 products per 100 sq ft of exhibit space, complete with pictures, descriptions and any related Cad Files or Spec Sheets.(Requires Booth Space in the upcoming Landscape Expo)</span></div></center></td>
						
						
							<td style="border: 1px solid black; padding: 3px; <? if ($tier==2){ echo "background-color: chartreuse";} ?>"><center><div class='tooltip5'>Not Yet<span class='tooltiptext'>You can view your profile through the link above, but it is not accessible through the "What Are You Shopping For?" search engines. GOOD NEWS . . . You can have an active profile by tomorrow if you contact us today! <br>Just contact your sales rep below:</span></div></center></td>						
						</tr>
					</table>
...
<div class="tb4" style="width:750px; box-shadow: 5px 5px 5px #888888">
  &nbsp;&nbsp;Company Search Categories<? if (($coDog == '4') || ($coDog == '6')) { ?> [ <a href='https://landscapearchitect.com/abante/index.php?rt=product/product&product_id=140' target="_blank"><span style="font-size: 18px; font-weight: bold">Add Search Categories For Your Company</span></a> ]<? } else {  ?>&nbsp;&nbsp;[ <a href='<?= $_SERVER['PHP_SELF'] ?>?action=categories&id=<?= $this->id ?>'><span style="font-size: 18px; font-weight: bold">Edit The Search Categories For Your Company</span></a> ]<? } ?>
	...
	<div style="text-align: center">
		<img src="https://landscapearchitect.com/lol-logos/LA-LC-search-engines.jpg" width="450"><br><br>
		These categories are used by the search engine to find your company.
	</div>
	<br>
    <div style="position:relative; left:268px; font-family:Arial, Helvetica, sans-serif; font-size:18px; font-weight:bold">
...
<!-- Test popup2 end -->
    ...
    function photoSummary(){
        include '/home/land/public_html/vendor/photo_edit_html-js-LAD.php';
    }
