...
ENDH;
 ...
 <tr>
    ...
    <span style="font-size: 16px">
    <center>
    <a href="mailto:gschmok@landscapeonline.com?subject=Advertising Information Request&body=Please send me information about my LandscapeOnline vendor profile and any other Landscape Communications, Inc. products that would be relevant for my company.">Clint Phipps  - (714) 979-5276 x111</a>
    </center>
    </span>
    </td>
 </tr>
        ...
        <table width='750' class='searchOptions' cellpadding='0' cellspacing='0' border='0'>
                    ...
                    <tr>
                        ...
                        <span style="font-size:16px">All advertisers receive sales leads updated every Friday by 5:00 PM.<br />
							...
							<span style="font-size:18px; font-family:Arial, Helvetica, sans-serif; font-weight:bold; background-color:#FFF">Leads for the Week of: <span style="font-size:14px; color:#F00">(Make sure to click on a week in the box below)</span><br>
<span style="font-size:14px; color:#F00">(For Mobile Devices, Click in Box)</span></span>
                        </td>
                    </tr>
                    ...
                    <tr>
                        <td colspan="2" align="center">
							<form name="leadsform" method="post" action="https://landscapearchitect.com/vendor/index-vendor.php?action=categories2&id=<?= $this->id ?>" onsubmit="return validateForm()">
									...
									<select name="week" size="4" style="font-family:Arial, Helvetica, sans-serif; font-size:16px; width:150px; height:75px; background-color:#CCC; box-shadow: 5px 5px 5px #888888; border: 2px inset; margin-left:auto">
