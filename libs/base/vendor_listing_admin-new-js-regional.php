...
class vendor_listing_admin extends vendor {
    ...
    function manageProducts($id=NULL) {
        ...
        switch($_REQUEST['intent']) {
            ...
            case 'editproduct':
                ...
                if($vp->errors()) {
                    // vendor_listing_admin-new-js-regional.php
    ...
    function showCompanyEdit() {
        ...
        <vlsummary class='errSummary' displaymode='bulletlist' headertext='<h3>Remember:</h3>' />
            ...
            <? $this->showView('company-main-regional.php', TRUE); ?>
        </form>
        <?
...
/*
    ...
    */
    ...
    function adminDisplaySummary($id) {
        ...
        print("<div style='width:750px'><center><span style='; font-family:Arial, Helvetica, sans-serif; font-size:28px; font-weight:bold'>Welcomes!</span><br><br><span style='font-size:24px; font-weight:bold'>" . $this->getCompanyName() . "</span></center></div>");
        if($this->admin) {
    ...
    function editNavigation() {
        ...
        <div class='formInfo' style="width:750px">
            ...
            <h2 style="; font-family:Arial, Helvetica, sans-serif; color:#F00"><center>Product Search Status is:</center></h2><br />
				
				
			
				
											<center><h1>Listed As An Outlet</h1></center><br />
