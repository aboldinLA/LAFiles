...
*/
    ...
    $vl->local_vendor_type($vst, $types);
    switch($searchby) {
        case 'ac':
            // local
            $vl->find_local_listings($vst, $categories, $acarray, $types, NULL);
            break;
        case 'st':
            // state
            $vl->find_local_listings($vst, $categories, NULL, $types, $state);
            break;
        default:
            // national
            $vl->find_local_listings($vst, $categories, NULL, $types, NULL);
            break;
    }
