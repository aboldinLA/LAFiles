	...
	<div style="position:relative; left: 10px; top: 0px; z-index: 0">
				...
				<div style="position:absolute; left: 525px; top:255px; z-index: 0">
						...
						<form method="post" action="prod-seac-all-prod.php">
							...
							<input type="text" name="keywrd" value="<? echo $_POST['keywrd'] ?>" style="width: 250px; height: 20px; box-shadow: 5px 5px 5px #888888; padding: 3px" placeholder="Please enter Keyword"><br><br>
