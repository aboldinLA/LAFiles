...
<html lang="en">
  ...
  <body>
			...
			die("Connection failed: " . $conn->connect_error);
										...
										// banner rotating section
											while($row = mysqli_fetch_array($result)) {  
                                                ...
                                                echo '<img width="20%" src="https://landscapearchitect.com/products/images/' . $row['photo'] . '"><br><br>';
    ...
    ?>
      ...
      <p class="lead mb-4">
       Choose the <strong>"Search Category"</strong> for this Product.<br>
    ...
    <div class="col-sm-4">
    <h5>Site Furnishings &amp; Receptacles</h5>
