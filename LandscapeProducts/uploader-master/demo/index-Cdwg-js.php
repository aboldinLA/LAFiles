...
<html lang="en">
  ...
  <body>
   ...
   <h3>Edit the CAD DWG File for this product</h3>
    ...
    ?>
      ...
      <p class="lead mb-4">
        ...
        <br>
       To change the CAD DWG File, drag your new image to the window below and click on the Submit Button.
      </p>
...
<script>
    ...
    <script src="demo-config4-js.js"></script>
