...
// Write to vendor_product Start
		...
		$sql = "UPDATE vendor_product SET vwxx='" . $pString2 . "' WHERE id='" . $prodNum3 . "'";
...
// Email Notification Start
    ...
    $subject = 'Details Uploaded - CAD VWX ' . $venNum3 . '';
    $message = 'Vendor Web ID: ' . $venNum3 . ' has uploaded a CAD VWX for product: ' . $prodNum3 . ' ';
