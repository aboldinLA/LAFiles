		...
		<table WIDTH="100%" align=center cellpadding="0" cellspacing="0"> 
			<tr>
				<td colspan="3">
					...
					<center><img src="https://landscapearchitect.com/lol-logos/LASN_BLUE_500.jpg" width="280" />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<img src="https://landscapearchitect.com/lol-logos/la-details-weekly.jpg" width="317" /></center>
					<br />
...
<table>
  ...
  <tr>
    <TD VALIGN="top">
      ...
      <center>
        <font size="2">With 90,000 Monthly Readers LASN Reaches Virtually<br /> Every Registered Landscape Architect Nationwide</font>
      </center><br>
      <center>
    ...
    <TD VALIGN="top">
      <center>
        <IMG SRC="/lol-logos/lcdbms-logo-NEW-BIG-2.jpg" width="310" BORDER="0">
      </center><br />
      <center>
        <font size="2">Reaching 40,000 Landscape Installation and <br />Maintenance Business Owners & Superintendents</font>
      </center><br />
      <center>
        <INPUT TYPE="CHECKBOX" style="width:16px;height:16px" name="request2" VALUE="LC Media Kit/Rates Package">
        <font size="3"><b>&nbsp;Yes!</b></font> <br />
        <font size="2">Send me the Landscape Contractor Media Kit and Rates Packet!</font>
      </center>
  </tr>
  ...
  <TR>
    <TD VALIGN="top">
      <br></br>
      <center>
        <IMG SRC="/lol-logos/lo-DBMS-logo-800.jpg" width="310" ALT="Landscape Online" BORDER="0">
      </center><br>
      <center>
        <font size="2">The Largest Landscape Database on the Internet</font>
      </center><br />
      <center>
        <INPUT TYPE="CHECKBOX" style="width:16px;height:16px" name="request4" VALUE="LO Media Kit/Rates Package">
        <font size="3
                  "><b>&nbsp;Yes!</b> <br />
          <font size="2">Send me the LandscapeOnine Media Kit <br />and Rates Packet!</font>
      </center>
    </TD>
    <td>
      <br></br>
      <center>
        <IMG SRC="/lol-logos/lolw-logo.jpg" width="310" ALT="LandscapeOnline Weekly" BORDER="0" />
      </center><br />
      <center>
        <font size="2">Reaching 65,000 Commercial Landscape <br />Professionals Every Week</font>
      </center><br /><br />
      <center>
        <INPUT TYPE="CHECKBOX" style="width:16px;height:16px" name="request6" VALUE="LOW Media Kit/Rates Package">
        <font size="3"><b>&nbsp;Yes!</b></font> <br />
        <font size="2">Send me the LandscapeOnline Weekly Media Kit <br />and Rates Packet!</font>
      </center>
    </td>
  </TR>
...
-->
    ...
    <td>
      <br></br>
      <center>
        <IMG SRC="https://landscapearchitect.com/lol-logos/tool-and-equipment-logo.jpg" width="240" ALT="Tools and Equipment" BORDER="0" />
      </center><br />
<!--
      <center>
        <font size="2">Reaching 65,000 Commercial Landscape <br />Professionals Every Week</font>
...
-->
      <center>
        <INPUT TYPE="CHECKBOX" style="width:16px;height:16px" name="request10" VALUE="Tools and Equipment Media Kit/Rates Package">
        <font size="3"><b>&nbsp;Yes!</b></font> <br />
        <font size="2">Send me the Tools &amp; Equipment Search Engine <br />Media Kit and Rates Packet!</font>
      </center>
    </td>
  </TR>
  ...
  <TR>
    <TD VALIGN="top">
      <br /><br />
      <center>
          <IMG SRC="https://landscapearchitect.com/lol-logos/wholesaleplant2.jpg" width="270" ALT="TLE" BORDER="0">
      </center><br><br />
<!--
      <center>
...
-->
      <center>
        <INPUT TYPE="CHECKBOX" style="width:16px;height:16px" name="request11" VALUE="Local Wholesale Media Kit">
        <font size="3"><b>&nbsp;Yes!</b> </font><br />
        <font size="2">Send me the Local Wholesale Media Kit <br />and Rates Packet!</font>
      </center>
    </TD>
    <td align="top">
      <br>
