    ...
    function action($action = 'default', $vars = NULL) {
        ...
        switch($action) {
            ...
            case 'find':
                ...
                ?>
                <div id='pageBody' style="position:relative; left:300px; top:-255px; width:763px">
                <h1 id='pageTitle'>Editorial &amp; Article Search Resultss</h1><br>
                <?
                if($this->errors()) { ?>
                    ...
                    switch($vars['searchType']) {
                        ...
                        case 'advanced':
                            echo "<a href='index.php'><div style='position:relative; left:0px'><font size='2'><strong>Begin New Search</strong></font></a><div style='position:relative; left:0px; top:-50px'>";					
                            break;
                    }
                    print("</form>");
    ...
    function action($action = 'default', $vars = NULL) {
        ...
        switch($action) {
            ...
            case 'find':
                ...
                $this->top('Editorial &amp; Article Search');
                ?>
                <div id='pageBody' style="position:relative; left:365px; top:-255px; width:763px">
