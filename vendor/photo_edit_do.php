...
function get_products_list_html($company_id){
    ...
    foreach($products_list as $product){
        ...
        $html .="<tr>";
        $html .="<td align='left' width='60%'><h3>".iconv('CP1252', 'ASCII//TRANSLIT', (stripslashes($product[product_name])))."</h3>";
    ...
    $demogs2 = iconv('CP1252', 'ASCII//TRANSLIT', (stripslashes(str_replace($pattern2, $repl2, $product[description]))));
        ...
        $html .="<br><br>$demogs2<br>".get_current_category_selected($product['id'],$company_id)."<br>";
 		...
 		$dog = $product[web];
		$html .='<br><strong>Web Link:</strong><br><a href="' . $dog . '">' .  $product[web] .  '</a>' .  '</td>';	
