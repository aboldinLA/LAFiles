     ...
     class lead_generator_approval_controller extends lead_generator {
        ...
        function approved() {
            ...
            <div id="content">
                <div id="warn">
                <p>
                    Your lead generator has been approved.  We thank you for being a part of the number one annual guide for the industry.
                </p>
                <p>
                    You can upgrade your presence in the guide by contacting your sales representative, either by phone (714-979-5276) or e-mail.
                </p>
                <table border="0" cellpadding="" cellspacing="3">
                    ...
                    <tr>
                        <td>A-H</td>
                        <td><a href="mailto:jfeeser@landscapeonline.com?subject=Lead Generator Upgrade">Joel Feeser</a></td>
                    </tr>
                    <tr>
                        <td>I-P</td>
                        <td><a href="mailto:tmolson@landscapeonline.com?subject=Lead Generator Upgrade">Tanisha Molson</a></td>
                    </tr>
                    <tr>
                        <td>Q-Z</td>
                        <td><a href="mailto:mhenderson@landscapeonline.com?subject=Lead Generator Upgrade">Matt Henderson</a></td>
                    </tr>
                </table>
                <p>
                    Again, thank you for being a part of this valuable industry resource.
                </p>
                </div>
            </div>
            <?php
        ...
        function approvalPage($hash) {
            ...
            <div id="content">
                ...
                <p>
                Please review the content of this lead generator below, then read the agreement and sign the form to approve.  If you have any questions or modifications that need to be made, contact the editor listed in the email in order to make the appropriate changes.
                </p>
                </div>
                <?php $this->listErrors(); ?>
        ...
        function approvalForm($hash) {
            ...
            Furthermores, by signing your full name and submitting this form, you certify that you are responsible for the content of this lead generator, and have the legal capacity to approve of the content.
            <p>
            </p>
            </div>
                        ...
                        Phone: <strong><?= $this->current->phoneNumber(); ?></strong>
                            ...
                            <td valign="top">
                                <div id="promo">
                                    ...
                                    <strong>
                                       This Lead Generator is a VALUE-ADDED Service and is provided at NO Additional Cost to you.<br /> <br /> 
