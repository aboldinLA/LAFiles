...
class xlist extends template_class {
    ...
    function fetchXlistWholesaleParentArray() {
        $query  = "select * from " . $this->dbTable . " where idParent=27 AND ";
    ...
    function displayManufactureXlistSelection2($xlist) {
        ...
        foreach($parents as $row => $obj) {
            ...
            <tr><td colspan='2'> </td></tr>
            <tr><td class='cellhead' colspan='1'><h3><?= $obj['name'] ?></h3></td>
            	<td align='right' class='cellhead' colspan='1'><h4><a href='#topList'>Back to Tops</a></h4></td></tr>
            <tr><td colspan='2'><hr noshade size='-1' /></td></tr>
