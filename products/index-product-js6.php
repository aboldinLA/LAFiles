...
<!-- New Keyword Section Start -->
	...
	<div style="position:relative; left:-327px; top:-50px">
	<? include("https://landscapearchitect.com/products/load-more-results/index2.php"); ?>
    </div>

<!-- New Keyword Section End -->
...
$(document).ready(function(){
	...
	$("#search-box2").keyup(function(){
		$.ajax({
		type: "POST",
		url: "https://landscapearchitect.com/products/jquery-ajax-autocomplete-country-example/searchconame3.php",
