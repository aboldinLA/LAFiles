<?php
     ...
     */
     ...
     require_once('lead_generator_categories-js.php');
     ...
     class lead_generator {
        ...
        function approvalForm($hash) {
            ...
            ?>
            <div style="position:absolute; left:300px; top:1510px; padding:0px; font-size:12px; font-weight:bold; margin:auto; width:800px">
                ...
                <table cellpadding="5" cellspacing="0" border="0">
                    <tr>
                        ...
                        <td><input size="32" type="text" name="signature" value="<?= $_REQUEST["signature"] ?>" />
                        	<br/>
                            <input type="submit" name="submit" value="I approve of this Lead Generator" />
                        </td>
                    </tr>
                    ...
                    <tr>
                    	...
                    	<td>
                    		...
                    		<label>If you do not approve please put comments here:</label>
                    		<textarea name="d_txtarea" cols="25" rows="5"></textarea> <br/> 
                    		<input type="submit" name="submit" value="Submit" />
                            <script type="text/javascript">
                            	function d_show(){
 									var mydiv = document.getElementById("mydiv");
 									mydiv.innerHTML = "<textarea name=\"d_txtarea\" cols=\"25\" rows=\"5\"></textarea> <br/> <input type=\"submit\" name=\"submit\" value=\"Submit\" />";
                            	}
							</script>
							<div id="mydiv"></div>
                    	</td>
        ...
        function approvalContent(&$lga) {
            ...
            ?>
                ...
                <h1>Listing Information</h1>
                     <p>This will appear in <strong><?= strtoupper(implode(',',$this->magazines())); ?></strong></p>
                </div>
                
				<div style="position:absolute; left:300px; top:905px; padding:0px; font-size:12px; margin:auto; width:800px">
                      <h2>Maximize Your Exposure! &nbsp;&nbsp;<font color="#FF0000" size="2">(Optional)</font></h2>
                </div>
				<div style="position:absolute; left:300px; top:940px; padding:0px; font-size:12px; margin:auto; width:800px">
                        Lead Generators are product profiles that will appear in the LC/DBM Buyers Guide and/or the LASN Specifier's Guide. They also appear on your vendor profile at LandscapeOnline.com
                </div>
                
				<div style="position:absolute; left:300px; top:995px; padding:0px; font-size:12px; margin:auto; width:800px">
                     If you would like to change the format, add product lines, or upgrade to a double image Lead Generator - <strong>Click here for specs and costs</strong> or call 714-979-5276 x113
                </div>
                                
				<div style="position:absolute; left:300px; top:1040px; padding:0px; font-size:12px; margin:auto; width:800px">
                     (Use a single image Lead Generator to put different product lines into the search engines)
                </div>
                                
                <div style="position:absolute; left:500px; top:1075px; padding:0px; font-size:12px; font-weight:bold; margin:auto; width:125px">
					<img width="250" src="/devel/lg/Kalamazoo-hz.jpg">              
 				</div>
                
                <div style="position:absolute; left:800px; top:1075px; padding:0px; font-size:12px; font-weight:bold; margin:auto; width:125px">
					<img width="250" src="/devel/lg/Kalamazoo-vrt.jpg">              
 				</div>
                
				<div style="position:absolute; left:300px; top:1270px; padding:0px; font-size:12px; margin:auto; width:800px">
                     (Use a <strong>Double Image Lead Generator</strong> to show multiple versions of the same product line. Double Image Lead Generators are placed before single-image Lead Generators in the print versions.)
                </div>                                
                <div style="position:absolute; left:520px; top:1320px; padding:0px; font-size:12px; font-weight:bold; margin:auto; width:125px">
					<img width="500" src="/devel/lg/Shade-Devices.jpg">              
 				</div>                
                                
				<div style="position:absolute; left:300px; top:215px; padding:0px; font-size:12px; font-weight:bold; margin:auto; width:800px">
                <h1>Content &nbsp;&nbsp;<font color="#FF0000" size="2">(Required)</font></h1>
                    <p>
                    ...
                    <div class="indent">
                       Company Name: <strong><?= $this->current->companyName(); ?></strong><br />
                        ...
                        Message: <strong><?= $this->current->content(); ?></strong>
                    </div>
                </div>
				<div style="position:absolute; left:300px; top:410px; padding:0px; font-size:12px; font-weight:bold; margin:auto; width:800px">
                <h1>Image(s) &nbsp;&nbsp;<font color="#FF0000" size="2">(Required)</font></h1>
                    <p>
...
<html>
    ...
    <body>
        ...
        <p>Thank you for submitting your company profile and photo(s) for <strong>LASN’s 2012 Specifier’s Guide</strong> and/or <strong>LC/DBM’s 2012 Buyer’s Guide.</strong></p>
        <p>As you know, these annual guides are used throughout the year as reference material by landscape architects, commercial specifiers, designers and contractors for a wide variety of landscape projects. The guides continue to grow in popularity and remain the <strong>most used</strong> product directories in the industry.</p>
        <p>
...
EOHTML1;
            ...
            if($size == 'single') {
                ...
                $text .= <<<EOHTML2
<p>Past advertisers have found the greater their exposure in the annual guide, the more sales leads they receive. For example:</p>

<ul>
        <li>The average advertiser with a <strong>“Brand Enhancer”</strong> Lead Generator containing two product-specific photos plus additional text, received 51% more product requests than those with Lead Generators.</li>

        <li>The average advertiser with a display ad and a Lead Generator received 22% more product requests than those with only Lead Generators.</li>
</ul>
EOHTML2;
...
EOHTML3;
            ...
            $text .=  <<<EOHTML4
            <p>You have been designated as the person responsible for approving the content of {$companyName}'s Lead Generator(s).  If you are not the proper recipient for approving this material, please notify us immediately so that we may contact the appropriate person.</p>

            <p>A proof of the material that was submitted for your Lead Generator has been created and is pending your approval. To review and approve the content, please visit the following link. (NOTE: If you can’t click the link, please copy and paste the address into your browser window.)</p>
...
<p>Please review the contents of your proof carefully. If you notice any problems, please contact:</p>
...
&nbsp;&nbsp;&nbsp;&nbsp;    Fax: {$editorFax}<br />
        ...
        <p>Thank you again for being part of the #1 product resource in the industry.</p>
