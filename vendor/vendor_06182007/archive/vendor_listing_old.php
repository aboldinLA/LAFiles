...
Option 1: Premium Position Listings</b>
...
For only $14.95 a month <i>(limited time only)</i> you can . . .
...
<table border=0 cellspacing=0 cellpadding=0>
	...
	<tr>
		...
		<td bgcolor=cccccc height=75 width=184 valign=top align=center>
		...
		<td bgcolor=cccccc height=75 width=184 valign=top>
	...
	<tr>
		...
		Click "<b>Get Listed Now!</b>" to List Your Company in the First Available Premium Positon

		for only $14.95 a month!</b></font>  
	...
	<form method="post" action="<?echo $PHP_SELF?>">
		...
		<a href="<?=$PHP_SELF?>?list=go"><img src="images/getlistedbutton.gif" border=0></a>
...
<a href="<?=$PHP_SELF?>?list=yes"><img src="images/op2.gif" border=0></a></td>

		<td valign=center align=left>

		<font style="font-size:11px;font-family:arial;color:808080">

		&nbsp;for the free listing, in

		random order, below my Premium Positioned Competitors.
