...
<div>
	...
	<div style="position:absolute; left: 350px; top:225px; z-index: 0; width: 700">
		...
		<center><h3 style="font-family: Helvetica, Arial, sans-serif; font-size: 18px">Featured Advertisers For The Category: <? echo $catName1 ?><br><span style="font-size: 14px; font-weight 200; font-family: Helvetica, Arial, sans-serif">Click on Advertiser Logo to View their Vendor Profile<br>Use Menu on the Left to View Specific Categories</span></h3></center>
	</div>
		  	...
		  	transform: translateY(-50%);			
									...
									<?
										...
										// start for the banner add counting and getting from table
											...
											$sql = "SELECT * FROM new_vendor LEFT JOIN vendor_product ON new_vendor.id=vendor_product.vendor_id WHERE (vendor_product.xlist='175' OR vendor_product.xlist='179' OR vendor_product.xlist='181' OR vendor_product.xlist='189' OR vendor_product.xlist='424' OR vendor_product.xlist='425' OR vendor_product.xlist='435' OR vendor_product.xlist='440' OR vendor_product.xlist='442' OR vendor_product.xlist='443' OR vendor_product.xlist='449' OR vendor_product.xlist='971' OR vendor_product.xlist='978' OR vendor_product.xlist='979' OR vendor_product.xlist='994' OR vendor_product.xlist='1201') AND (new_vendor.status='10' OR new_vendor.status='12' OR new_vendor.status='14' OR new_vendor.status='16' OR new_vendor.status='18') ORDER BY new_vendor.company_name ASC";
