    ...
    function action($action = 'default', $vars = NULL) {
        ...
        switch($action) {
            ...
            case 'find':
                ...
                ?>
                <div id='pageBody' style="position:relative; left:125px; top:-230px; width:763px">
                ...
                if($this->errors()) { ?>
                    ...
                    switch($vars['searchType']) {
                        ...
                        case 'advanced':
                            echo "<div style='position:relative; left:0px; z-index:5000'><font size='2'><strong><a href='https://landscapearchitect.com/research/index.php'>Begin New Search</a></strong></font><div style='position:relative; left:0px; top:-50px'>";					
                            break;
                    }
                    print("</form>");
    ...
    function action($action = 'default', $vars = NULL) {
        ...
        switch($action) {
            ...
            case 'find':
                ...
                $this->top('Editorial &amp; Article Search');
                ?>
                <div id='pageBody' style="position:relative; left:0px; top:-230px; width:763px">
                <h1 id='pageTitle'>Editorial &amp; Article Search Results</h1><br>
                <?
                if($this->errors()) { ?>
                    <form name='manage' method='get' action='<?= $this->baseLink(); ?>' style='padding: 0; margin: 0;'>
                    ...
                    switch($vars['searchType']) {
                        ...
                        case 'advanced':
                            echo "<div style='position:relative; left:0px; z-index:5000'><font size='2'><strong><a href='https://landscapearchitect.com/research/index.php'>Begin New Search</a></strong></font><div style='position:relative; left:0px; top:-53px'>";					
                            break;
                    }
                    print("</form>");
                    print("<div class='clearer'>&nbsp;</div>");
            ...
            default:
                ...
                $this->top('Editorial &amp; Article Search');
                ?>
                <div style="position:relative; left:-320px; top:-175px">
                    ...
                    <div style="position:absolute; left:323px; top:500px; font-size:16px; width:763px">
