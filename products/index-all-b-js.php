									...
									<?
										...
										// banner rotating section
											   ...
											   while($row = mysqli_fetch_assoc($result)) {
												...
												if ($zCount == 1){
												echo "<div style='position: relative; left: 0px; top: 0px; padding-top:25px'>";
												}else{
												echo "<div style='position: relative; left: 20px; top: 0px; padding-top:10px'>";
												}		
												...
												if ($row['vendor_id'] != $rowNum) {
													...
													$result6 = $conn->query($sql6);
														...
														while($row = mysqli_fetch_array($result6)) {
															...
															echo "<div style='position: relative; left:100px'><center><a href='http://" . $webNum2 . "' target='_blank'><h4>Visit Website</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='http://" . $webNum2 . "' target='_blank'>Contact Us </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='https://landscapearchitect.com/products/listing-a.php?number=" . $rowNum . "' target='_blank'>View Vendor Profile</a> </h4></center></div>";
								...
								<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion<? echo $morProd; ?>" href="#collapseOne<? echo $morProd; ?>"><span style="text-align: left; font-size: 12px"><strong>View All  <? echo $catName2 ?> From This Vendor</strong></span></a><a data-toggle="collapse" data-parent="#accordion<? echo $morProd; ?>" href="#collapseTwo1<? echo $morProd; ?>"><span style="padding-left: 250px; font-size: 12px">Close Window</span></a></h4>
													...
													$result16 = $conn->query($sql16);
														...
														while($row = mysqli_fetch_array($result16)) {
															...
															echo "<br><div style='position: relative; left:100px'><center><a href='http://" . $webNum2 . "' target='_blank'><h4>Visit Website</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href='http://" . $webNum2 . "' target='_blank'>Contact Us</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href='https://landscapearchitect.com/products/listing-a.php?number=" . $rowNum . "' target='_blank'>View Vendor Profile</a> </h4></center></div>";
...
// Start Here
		...
		echo '<div style="position:relative; left: -15px">';
											...
											while($row = mysqli_fetch_array($result25)) {
												...
												if ($row['vendor_id'] != $rowNum) {
													...
													$result6 = $conn->query($sql6);
															...
															$ii = 0;
															$ss = 1;
															echo "<div style='position:relative;left:50px'><table width='745px'><tr>";
															echo '<td rowspan="3" width="250px"><img width="60%" style="height: auto" src="https://landscapearchitect.com/products/images/' . $row['logo'] . '"></td>';
														while($row = mysqli_fetch_array($result6)) {
																if ($ii == 0 ) {														
																	echo "<td align='left'><div><center><figure><a href='" . $row['web_photo'] . "' target='_blank'><div class='limage3'><img class='limage4' src='https://landscapearchitect.com/products/images/" . $row['photo'] . "'></a></div><br><figcaption style='width:100%'>" . iconv('CP1252', 'UTF-8//TRANSLIT', (stripslashes($row['product_name']))) . "YYY</figcaption></figure></center></div></td><td style='width: 5px'>&nbsp;</td>";
																	$ss++;
																	$ii++;
																	
																	
																}elseif ($ii < 2 && $ss < 3){
																	echo "<td align='left'><div><center><figure><a href='" . $row['web_photo'] . "' target='_blank'><div class='limage3'><img class='limage4' src='https://landscapearchitect.com/products/images/" . $row['photo'] . "'></a></div><br><figcaption style='width:100%'>" . iconv('CP1252', 'UTF-8//TRANSLIT', (stripslashes($row['product_name']))) . "YYY</figcaption></figure></center></div></td><td style='width: 5px'>&nbsp;</td></tr><tr>";
																	$ss++;
																	$ii++;																	
															...
															echo "<div style='position: relative; left:150px'><center><a href='http://" . $webNum2 . "' target='_blank'><h4>Visit Website</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='http://" . $webNum2 . "' target='_blank'>Contact Us </a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href='https://landscapearchitect.com/products/listing-a.php?number=" . $rowNum . "' target='_blank'>View Vendor Profile</a> </h4></center></div>";
								...
								<h4 class="panel-title"><a data-toggle="collapse" data-parent="#accordion<? echo $morProd; ?>" href="#collapseOne<? echo $morProd; ?>"><span style="text-align: left; font-size: 12px"><strong>View All  <? echo $catName2 ?> From This Vendor</strong></span></a><a data-toggle="collapse" data-parent="#accordion<? echo $morProd; ?>" href="#collapseTwo1<? echo $morProd; ?>"><span style="padding-left: 250px; font-size: 12px">Close Window</span></a></h4>
																...
																<script src="https://landscapearchitect.com/js/bootstrap.js"></script>																
															<?
													echo "<div style='width:750px; height:2px; background-color:#605b51;'> </div><div style='position:relative; left:-25px'><!-- End Combo -->";																
													...
													$result16 = $conn->query($sql16);
															...
															$ii = 0;
															$ss = 1;
															echo "<div style='position:relative;left:-15px'><table width='745px' style='position:relative;left:50px'><tr>";
															echo '<td rowspan="3" width="250px"><img width="60%" style="height: auto" src="https://landscapearchitect.com/products/images/' . $row['logo'] . '"></td>';
														while($row = mysqli_fetch_array($result16)) {
																if ($ii == 0 ) {														
																	echo "<td align='left'><div><center><figure><a href='" . $row['web_photo'] . "' target='_blank'><div class='limage3'><img class='limage4' src='https://landscapearchitect.com/products/images/" . $row['photo'] . "'></a></div><br><figcaption style='width:100%'>" . iconv('CP1252', 'UTF-8//TRANSLIT', (stripslashes($row['product_name']))) . "XXX</figcaption></figure></center></div></td><td style='width: 5px'>&nbsp;</td>";
															...
															echo "<br><div style='position: relative; left:115px'><center><a href='http://" . $webNum2 . "' target='_blank'><h4>Visit Website</a> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href='http://" . $webNum2 . "' target='_blank'>Contact Us</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <a href='https://landscapearchitect.com/products/listing-a.php?number=" . $rowNum . "' target='_blank'>View Vendor Profile</a> </h4></center></div>";
													
													echo "<br><div style='width:750px; height:2px; background-color:#605b51; position: relative; left: 50px'>&nbsp;</div><!-- End Sgl -->";																												
