...
file_exists(__DIR__.DIRECTORY_SEPARATOR.'https://landscapearchitect.com/products/ajax-live-search-master/class'.DIRECTORY_SEPARATOR.'handler.php') ? require_once(__DIR__.DIRECTORY_SEPARATOR.'https://landscapearchitect.com/products/ajax-live-search-master/class'.DIRECTORY_SEPARATOR.'handler.php') : die('There is no such a file: handler.php');
file_exists(__DIR__.DIRECTORY_SEPARATOR.'https://landscapearchitect.com/products/ajax-live-search-master/class'.DIRECTORY_SEPARATOR.'config.php') ? require_once(__DIR__.DIRECTORY_SEPARATOR.'https://landscapearchitect.com/products/ajax-live-search-master/class'.DIRECTORY_SEPARATOR.'config.php') : die('There is no such a file: config.php');
...
<head>
    ...
    <!-- Live Search Styles -->
    <link rel="stylesheet" href="https://landscapearchitect.com/products/ajax-live-search-master/css/fontello.css">
    <link rel="stylesheet" href="https://landscapearchitect.com/products/ajax-live-search-master/css/animation.css">
    <!--[if IE 7]>
    <link rel="stylesheet" href="css/fontello-ie7.css">
    <![endif]-->
    <link rel="stylesheet" type="text/css" href="https://landscapearchitect.com/products/ajax-live-search-master/css/style.min.css">
</head>
<body>
